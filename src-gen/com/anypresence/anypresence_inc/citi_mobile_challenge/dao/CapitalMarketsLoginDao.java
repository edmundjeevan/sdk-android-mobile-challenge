...
/** 
 * DAO for table CAPITALMARKETSLOGINS.
 */
public class CapitalMarketsLoginDao
		extends
			AbstractDao<CapitalMarketsLogin, Long> {

	public static final String TABLENAME = "CAPITALMARKETSLOGINS";

	/**
	 * Properties of entity CapitalMarketsLogin.<br/>
	...
	public CapitalMarketsLoginDao(DaoConfig config) {
		super(config);
	}

	public CapitalMarketsLoginDao(DaoConfig config, DaoSession daoSession) {
	...
	public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
		...
		db.execSQL("CREATE TABLE " + constraint + "'CAPITALMARKETSLOGINS' (" + //
		...
		db.execSQL("CREATE UNIQUE INDEX " + constraint
				+ "IDX_CAPITALMARKETSLOGINS_OBJECT_ID ON CAPITALMARKETSLOGINS"
				+ " (OBJECT_ID);");
	}
	...
	public static void dropTable(SQLiteDatabase db, boolean ifExists) {
		String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "")
				+ "'CAPITALMARKETSLOGINS'";
		db.execSQL(sql);
	}

	/** @inheritdoc */
	@Override
	protected void bindValues(SQLiteStatement stmt, CapitalMarketsLogin entity) {
		stmt.clearBindings();
	...
	@Override
	protected void attachEntity(CapitalMarketsLogin entity) {
	...
	/** @inheritdoc */
	@Override
	public CapitalMarketsLogin readEntity(Cursor cursor, int offset) {
		CapitalMarketsLogin entity = new CapitalMarketsLogin(
				//
	...
	/** @inheritdoc */
	@Override
	public void readEntity(Cursor cursor, CapitalMarketsLogin entity, int offset) {
	...
	/** @inheritdoc */
	@Override
	protected Long updateKeyAfterInsert(CapitalMarketsLogin entity, long rowId) {
		entity.setId(rowId);
		return rowId;
	}
	...
	/** @inheritdoc */
	@Override
	public Long getKey(CapitalMarketsLogin entity) {
		if (entity != null) {
			return entity.getId();
		} else {
			return null;
	...
	protected String getSelectDeep() {
		if (selectDeep == null) {
			...
			builder.append(" FROM CAPITALMARKETSLOGINS T");
	...
	protected CapitalMarketsLogin loadCurrentDeep(Cursor cursor, boolean lock) {
		CapitalMarketsLogin entity = loadCurrent(cursor, 0, lock);
	...
	public CapitalMarketsLogin loadDeep(Long key) {
		assertSinglePk();
		if (key == null) {
			return null;
		}
	...
	public List<CapitalMarketsLogin> loadAllDeepFromCursor(Cursor cursor) {
		int count = cursor.getCount();
		List<CapitalMarketsLogin> list = new ArrayList<CapitalMarketsLogin>(
				count);
	...
	protected List<CapitalMarketsLogin> loadDeepAllAndCloseCursor(Cursor cursor) {
		try {
	...
	public List<CapitalMarketsLogin> queryDeep(String where,
			String... selectionArg) {
