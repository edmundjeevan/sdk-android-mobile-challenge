...
// KEEP INCLUDES END
/**
 * Entity mapped to table RETAILBANKINGACCOUNTTRANSACTIONS.
 */
public class RetailBankingAccountTransaction extends APObject {
	...
	private transient RetailBankingAccountTransactionDao myDao;
	...
	public RetailBankingAccountTransaction() {
	}

	public RetailBankingAccountTransaction(Long id) {
		this.id = id;
	}

	public RetailBankingAccountTransaction(Long id, String accountId,
			String activity, String checkImageEligible, String datePosted,
			String formattedAmount, String pendingDate,
			Float transactionAmount, String transactionDescription,
			String transactionIdentifier, String transactionIndex,
			String transactionType, String scope, String objectId,
