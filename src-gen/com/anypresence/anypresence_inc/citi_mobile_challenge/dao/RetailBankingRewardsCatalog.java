...
// KEEP INCLUDES END
/**
 * Entity mapped to table RETAILBANKINGREWARDSCATALOGS.
 */
public class RetailBankingRewardsCatalog extends APObject {
	...
	private transient RetailBankingRewardsCatalogDao myDao;
	...
	public RetailBankingRewardsCatalog() {
	}

	public RetailBankingRewardsCatalog(Long id) {
		this.id = id;
	}

	public RetailBankingRewardsCatalog(Long id, String itemCategory,
			String itemCode, String itemDescription, String itemName,
			Integer pointRequired, Integer pointsAvailable, String scope,
