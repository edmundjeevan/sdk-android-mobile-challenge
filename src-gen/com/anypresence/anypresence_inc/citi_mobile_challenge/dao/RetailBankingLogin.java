...
// KEEP INCLUDES END
/**
 * Entity mapped to table RETAILBANKINGLOGINS.
 */
public class RetailBankingLogin extends APObject {
	...
	private transient RetailBankingLoginDao myDao;
	...
	public RetailBankingLogin() {
	}

	public RetailBankingLogin(Long id) {
		this.id = id;
	}

	public RetailBankingLogin(Long id, String token,
			String isEligibleForOffers, String isPersonToPersonRequired,
			String password, String username, String scope, String objectId,
	...
	public void __setDaoSession(DaoSession daoSession) {
		...
		myDao = daoSession != null
				? daoSession.getRetailBankingLoginDao()
				: null;
	}
