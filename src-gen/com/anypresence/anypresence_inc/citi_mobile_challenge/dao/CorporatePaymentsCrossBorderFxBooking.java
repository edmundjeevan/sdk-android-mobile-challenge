...
// KEEP INCLUDES END
/**
 * Entity mapped to table CORPORATEPAYMENTSCROSSBORDERFXBOOKINGS.
 */
public class CorporatePaymentsCrossBorderFxBooking extends APObject {
	...
	private transient CorporatePaymentsCrossBorderFxBookingDao myDao;
	...
	public CorporatePaymentsCrossBorderFxBooking() {
	}

	public CorporatePaymentsCrossBorderFxBooking(Long id) {
		this.id = id;
	}

	public CorporatePaymentsCrossBorderFxBooking(Long id, String acceptedOn,
			String acceptedBy, String rateReference, String scope,
