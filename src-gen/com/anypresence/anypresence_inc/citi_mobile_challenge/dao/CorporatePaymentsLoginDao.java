...
/** 
 * DAO for table CORPORATEPAYMENTSLOGINS.
 */
public class CorporatePaymentsLoginDao
		extends
			AbstractDao<CorporatePaymentsLogin, Long> {

	public static final String TABLENAME = "CORPORATEPAYMENTSLOGINS";

	/**
	 * Properties of entity CorporatePaymentsLogin.<br/>
	...
	public static class Properties {
		...
		public final static Property Token = new Property(1, String.class,
				"token", false, "TOKEN");
		public final static Property Password = new Property(2, String.class,
				"password", false, "PASSWORD");
		public final static Property Username = new Property(3, String.class,
	...
	public CorporatePaymentsLoginDao(DaoConfig config) {
		super(config);
	}

	public CorporatePaymentsLoginDao(DaoConfig config, DaoSession daoSession) {
	...
	public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
		...
		db.execSQL("CREATE TABLE " + constraint + "'CORPORATEPAYMENTSLOGINS' ("
				+ //
		...
		db.execSQL("CREATE UNIQUE INDEX "
				+ constraint
				+ "IDX_CORPORATEPAYMENTSLOGINS_OBJECT_ID ON CORPORATEPAYMENTSLOGINS"
				+ " (OBJECT_ID);");
	}
	...
	@Override
	protected void attachEntity(CorporatePaymentsLogin entity) {
	...
	/** @inheritdoc */
	@Override
	public CorporatePaymentsLogin readEntity(Cursor cursor, int offset) {
		CorporatePaymentsLogin entity = new CorporatePaymentsLogin(
				//
	...
	/** @inheritdoc */
	@Override
	public void readEntity(Cursor cursor, CorporatePaymentsLogin entity,
			int offset) {
		entity.setId(cursor.isNull(offset + 0) ? null : cursor
				.getLong(offset + 0));
		entity.setToken(cursor.isNull(offset + 1) ? null : cursor
				.getString(offset + 1));
		entity.setPassword(cursor.isNull(offset + 2) ? null : cursor
				.getString(offset + 2));
		entity.setUsername(cursor.isNull(offset + 3) ? null : cursor
				.getString(offset + 3));
	...
	/** @inheritdoc */
	@Override
	protected Long updateKeyAfterInsert(CorporatePaymentsLogin entity,
			long rowId) {
		entity.setId(rowId);
		return rowId;
	}
	...
	/** @inheritdoc */
	@Override
	public Long getKey(CorporatePaymentsLogin entity) {
		if (entity != null) {
			return entity.getId();
		} else {
			return null;
	...
	protected String getSelectDeep() {
		if (selectDeep == null) {
			...
			builder.append(" FROM CORPORATEPAYMENTSLOGINS T");
	...
	protected CorporatePaymentsLogin loadCurrentDeep(Cursor cursor, boolean lock) {
		CorporatePaymentsLogin entity = loadCurrent(cursor, 0, lock);
	...
	public CorporatePaymentsLogin loadDeep(Long key) {
		assertSinglePk();
		if (key == null) {
			return null;
		}
	...
	public List<CorporatePaymentsLogin> loadAllDeepFromCursor(Cursor cursor) {
		int count = cursor.getCount();
		List<CorporatePaymentsLogin> list = new ArrayList<CorporatePaymentsLogin>(
				count);
	...
	protected List<CorporatePaymentsLogin> loadDeepAllAndCloseCursor(
			Cursor cursor) {
		try {
	...
	public List<CorporatePaymentsLogin> queryDeep(String where,
			String... selectionArg) {
