...
// KEEP INCLUDES END
/**
 * Entity mapped to table RETAILBANKINGPAYEETYPES.
 */
public class RetailBankingPayeeType extends APObject {
	...
	private transient RetailBankingPayeeTypeDao myDao;
	...
	public RetailBankingPayeeType() {
	}

	public RetailBankingPayeeType(Long id) {
		this.id = id;
	}

	public RetailBankingPayeeType(Long id, String value, String scope,
	...
	public void __setDaoSession(DaoSession daoSession) {
		...
		myDao = daoSession != null
				? daoSession.getRetailBankingPayeeTypeDao()
				: null;
	}
