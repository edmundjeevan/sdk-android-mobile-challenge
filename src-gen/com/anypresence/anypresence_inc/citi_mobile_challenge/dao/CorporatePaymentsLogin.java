...
// KEEP INCLUDES END
/**
 * Entity mapped to table CORPORATEPAYMENTSLOGINS.
 */
public class CorporatePaymentsLogin extends APObject {
	...
	private transient CorporatePaymentsLoginDao myDao;
	...
	public CorporatePaymentsLogin() {
	}

	public CorporatePaymentsLogin(Long id) {
		this.id = id;
	}

	public CorporatePaymentsLogin(Long id, String token, String password,
	...
	public void __setDaoSession(DaoSession daoSession) {
		...
		myDao = daoSession != null
				? daoSession.getCorporatePaymentsLoginDao()
				: null;
	}
