...
// KEEP INCLUDES END
/**
 * Entity mapped to table RETAILBANKINGFOREIGNCURRENCIES.
 */
public class RetailBankingForeignCurrency extends APObject {
	...
	private transient RetailBankingForeignCurrencyDao myDao;
	...
	public RetailBankingForeignCurrency() {
	}

	public RetailBankingForeignCurrency(Long id) {
		this.id = id;
	}

	public RetailBankingForeignCurrency(Long id, String fromCurrency,
			Float rate, String toCurrency, String scope, String objectId,
