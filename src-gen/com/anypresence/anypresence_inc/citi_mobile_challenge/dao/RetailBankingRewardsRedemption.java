...
// KEEP INCLUDES END
/**
 * Entity mapped to table RETAILBANKINGREWARDSREDEMPTIONS.
 */
public class RetailBankingRewardsRedemption extends APObject {
	...
	private transient RetailBankingRewardsRedemptionDao myDao;
	...
	public RetailBankingRewardsRedemption() {
	}

	public RetailBankingRewardsRedemption(Long id) {
		this.id = id;
	}

	public RetailBankingRewardsRedemption(Long id, Integer pointsAvailable,
			String redemptionDetails, String scope, String objectId,
