...
public class CorporatePaymentsCrossBorderFxQuoteBasicTest {
	private static RemoteRailsConfig config;
	private List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxQuote> createdObjects;
	...
	public static void init() throws InterruptedException,
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxQuote> objects = com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxQuote
				.query("all");
		if (!objects.isEmpty()) {
	...
	public void shouldBeAbletoQueryForAll() throws UnauthorizedException,
		...
		createdObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxQuote>();

		// Create some entities.
		for (int i = 0; i < MAX_ENTITIES; i++) {
			com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxQuote obj = new com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxQuote();
		...
		objects = com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxQuote
				.query("all", null, 0, 2);
	...
	public void cleanUp() throws RemoteRequestException {
		...
		for (com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxQuote category : createdObjects) {
			category.delete();
		}
