...
public class RetailBankingRewardsCatalogLocalSaveTest
		extends
	...
	public void shouldBeAbleSaveIntoCache()
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog> objectsInCache = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog
				.loadAllInCache();
		Assert.assertTrue(objectsInCache.size() == 2);

		com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog object0 = objectsInCache
				.get(0);
		object0.saveInCache();
		...
		com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog object1 = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog();
		object1.saveInCache();

		com.anypresence.sdk.APObject.deleteAllInCache();
		com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog object2 = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog();
		object2.updateInCache();
		objectsInCache = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog
				.loadAllInCache();
