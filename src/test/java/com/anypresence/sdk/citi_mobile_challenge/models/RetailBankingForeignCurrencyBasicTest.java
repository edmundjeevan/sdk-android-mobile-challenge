...
public class RetailBankingForeignCurrencyBasicTest {
	private static RemoteRailsConfig config;
	private List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency> createdObjects;
	...
	public static void init() throws InterruptedException,
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency> objects = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency
				.query("all");
		if (!objects.isEmpty()) {
			Assert.fail("Unable to run test as there are data for RetailBankingForeignCurrency.");
		}
	...
	public void shouldBeAbletoQueryForAll() throws UnauthorizedException,
		...
		createdObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency>();

		// Create some entities.
		for (int i = 0; i < MAX_ENTITIES; i++) {
			com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency obj = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency();
		...
		objects = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency
				.query("all", null, 0, 2);
	...
	public void cleanUp() throws RemoteRequestException {
		...
		for (com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency category : createdObjects) {
			category.delete();
		}
