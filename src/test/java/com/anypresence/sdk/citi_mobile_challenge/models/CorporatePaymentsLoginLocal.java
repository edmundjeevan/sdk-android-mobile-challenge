...
public class CorporatePaymentsLoginLocal {
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin> createdObjects;
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin> objects;
	...
	protected IRestClient getTestRestClient() {
		return new MockJSONRestClient() {
			...
			public List<String> get(URI uri) throws JSONException, IOException,
				...
				list.add("[{\"token\":\"0\",\"password\":\"fake\",\"username\":\"fake\"},{\"token\":\"1\",\"password\":\"fake\",\"username\":\"fake\"}]");
				return list;
			}
