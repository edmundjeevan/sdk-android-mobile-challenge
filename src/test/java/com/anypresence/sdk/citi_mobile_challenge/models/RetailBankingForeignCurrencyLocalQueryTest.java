...
public class RetailBankingForeignCurrencyLocalQueryTest
		extends
			RetailBankingForeignCurrencyLocal {
	@Before
	public void setup() {
		super.setup();
	}
	...
	public void shouldHaveScopes() {
		...
		Assert.assertEquals(
				"all",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency.Scopes.ALL);

		Assert.assertEquals(
				"exact_match",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency.Scopes.EXACT_MATCH);

		Assert.assertEquals(
				"count",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency.Scopes.COUNT);

		Assert.assertEquals(
				"count_exact_match",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency.Scopes.COUNT_EXACT_MATCH);

		Assert.assertEquals(
				"foreign_currency",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency.Scopes.FOREIGN_CURRENCY);
	...
	public void shouldBeAbleQueryFromCache()
		...
		com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency
				.queryInBackground(
						"all",
						null,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency>>() {
							@Override
							public void finished(
									List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency> arg0,
									Throwable ex) {
								objects = arg0;
								lock.countDown();
							}
		...
		Assert.assertTrue(com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency
		...
		lock = new CountDownLatch(1);
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency> cached = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency
				.queryInBackground(
						"all",
						params,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency>>() {
		...
		lock = new CountDownLatch(1);
		cached = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency
				.queryInBackground(
						"all",
						params,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency>>() {
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
						...
						list.add("[{\"id\":\"0\",\"from_currency\":\"fake\",\"rate\":0,\"to_currency\":\"fake\"}]");
						return list;
					}
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
							...
							RemoteRequestException {
						List<String> list = new ArrayList<String>();
						list.add("[{\"id\":\"1\",\"from_currency\":\"fake\",\"rate\":0,\"to_currency\":\"fake\"}]");
						return list;
					}
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency> cachedObjects = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
						...
						list.add("[{\"id\":\"0\",\"from_currency\":\"fakest_string\",\"rate\":0,\"to_currency\":\"fake\"},{\"id\":\"1\",\"from_currency\":\"fakest_string\",\"rate\":0,\"to_currency\":\"fake\"},{\"id\":\"2\",\"from_currency\":\"fakest_string\",\"rate\":0,\"to_currency\":\"fake\"}]");
						return list;
					}
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
						...
						list.add("[{\"id\":\"3\",\"from_currency\":\"fakest_string\",\"rate\":0,\"to_currency\":\"fake\"},{\"id\":\"4\",\"from_currency\":\"fakest_string\",\"rate\":0,\"to_currency\":\"fake\"},{\"id\":\"5\",\"from_currency\":\"fakest_string\",\"rate\":0,\"to_currency\":\"fake\"}]");
						return list;
					}
