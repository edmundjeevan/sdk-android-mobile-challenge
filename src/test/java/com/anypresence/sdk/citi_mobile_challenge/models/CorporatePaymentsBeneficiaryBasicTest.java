...
public class CorporatePaymentsBeneficiaryBasicTest {
	private static RemoteRailsConfig config;
	private List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsBeneficiary> createdObjects;
	...
	public static void init() throws InterruptedException,
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsBeneficiary> objects = com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsBeneficiary
				.query("all");
		if (!objects.isEmpty()) {
			Assert.fail("Unable to run test as there are data for CorporatePaymentsBeneficiary.");
		}
	...
	public void shouldBeAbletoQueryForAll() throws UnauthorizedException,
		...
		createdObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsBeneficiary>();

		// Create some entities.
		for (int i = 0; i < MAX_ENTITIES; i++) {
			com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsBeneficiary obj = new com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsBeneficiary();
		...
		objects = com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsBeneficiary
				.query("all", null, 0, 2);
	...
	public void cleanUp() throws RemoteRequestException {
		...
		for (com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsBeneficiary category : createdObjects) {
			category.delete();
		}
