...
public class CorporatePaymentsCrossBorderFxBookingLocal {
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking> createdObjects;
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking> objects;
	...
	protected IRestClient getTestRestClient() {
		return new MockJSONRestClient() {
			...
			public List<String> get(URI uri) throws JSONException, IOException,
				...
				list.add("[{\"accepted_on\":\"0\",\"accepted_by\":\"fake\",\"rate_reference\":\"fake\"},{\"accepted_on\":\"1\",\"accepted_by\":\"fake\",\"rate_reference\":\"fake\"}]");
				return list;
			}
