...
public class RetailBankingRewardsCatalogBasicTest {
	private static RemoteRailsConfig config;
	private List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog> createdObjects;
	...
	public static void init() throws InterruptedException,
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog> objects = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog
				.query("all");
		if (!objects.isEmpty()) {
			Assert.fail("Unable to run test as there are data for RetailBankingRewardsCatalog.");
		}
	...
	public void shouldBeAbletoQueryForAll() throws UnauthorizedException,
		...
		createdObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog>();

		// Create some entities.
		for (int i = 0; i < MAX_ENTITIES; i++) {
			com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog obj = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog();
		...
		objects = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog
				.query("all", null, 0, 2);
	...
	public void cleanUp() throws RemoteRequestException {
		...
		for (com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog category : createdObjects) {
			category.delete();
		}
