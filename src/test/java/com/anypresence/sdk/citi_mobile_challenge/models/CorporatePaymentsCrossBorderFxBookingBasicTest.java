...
public class CorporatePaymentsCrossBorderFxBookingBasicTest {
	private static RemoteRailsConfig config;
	private List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking> createdObjects;
	...
	public static void init() throws InterruptedException,
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking> objects = com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking
				.query("all");
		if (!objects.isEmpty()) {
			Assert.fail("Unable to run test as there are data for CorporatePaymentsCrossBorderFxBooking.");
		}
	...
	public void shouldBeAbletoQueryForAll() throws UnauthorizedException,
		...
		createdObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking>();

		// Create some entities.
		for (int i = 0; i < MAX_ENTITIES; i++) {
			com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking obj = new com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking();
		...
		objects = com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking
				.query("all", null, 0, 2);
	...
	public void shouldBeAbletoQueryForExactMatch()
		...
		params.put("accepted_on", obj.getAcceptedOn().toString());
	...
	public void cleanUp() throws RemoteRequestException {
		...
		for (com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking category : createdObjects) {
			category.delete();
		}
