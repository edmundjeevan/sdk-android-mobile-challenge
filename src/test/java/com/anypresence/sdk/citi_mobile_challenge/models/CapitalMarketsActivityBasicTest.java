...
public class CapitalMarketsActivityBasicTest {
	private static RemoteRailsConfig config;
	private List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity> createdObjects;
	...
	public static void init() throws InterruptedException,
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity> objects = com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity
				.query("all");
		if (!objects.isEmpty()) {
			Assert.fail("Unable to run test as there are data for CapitalMarketsActivity.");
		}
	...
	public void shouldBeAbletoQueryForAll() throws UnauthorizedException,
		...
		createdObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity>();

		// Create some entities.
		for (int i = 0; i < MAX_ENTITIES; i++) {
			com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity obj = new com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity();
		...
		objects = com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity
				.query("all", null, 0, 2);
	...
	public void cleanUp() throws RemoteRequestException {
		...
		for (com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity category : createdObjects) {
			category.delete();
		}
