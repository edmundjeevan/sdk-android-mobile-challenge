...
public class RetailBankingRewardsCatalogLocal {
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog> createdObjects;
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog> objects;
	...
	protected IRestClient getTestRestClient() {
		return new MockJSONRestClient() {
			...
			public List<String> get(URI uri) throws JSONException, IOException,
				...
				list.add("[{\"id\":\"0\",\"item_category\":\"fake\",\"item_code\":\"fake\",\"item_description\":\"fake\",\"item_name\":\"fake\",\"point_required\":0,\"points_available\":0},{\"id\":\"1\",\"item_category\":\"fake\",\"item_code\":\"fake\",\"item_description\":\"fake\",\"item_name\":\"fake\",\"point_required\":0,\"points_available\":0}]");
				return list;
			}
