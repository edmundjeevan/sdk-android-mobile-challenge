...
public class CorporatePaymentsPaymentBasicTest {
	private static RemoteRailsConfig config;
	private List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment> createdObjects;
	...
	public static void init() throws InterruptedException,
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment> objects = com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment
				.query("all");
		if (!objects.isEmpty()) {
			Assert.fail("Unable to run test as there are data for CorporatePaymentsPayment.");
		}
	...
	public void shouldBeAbletoQueryForAll() throws UnauthorizedException,
		...
		createdObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment>();

		// Create some entities.
		for (int i = 0; i < MAX_ENTITIES; i++) {
			com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment obj = new com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment();
		...
		objects = com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment
				.query("all", null, 0, 2);
	...
	public void cleanUp() throws RemoteRequestException {
		...
		for (com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment category : createdObjects) {
			category.delete();
		}
