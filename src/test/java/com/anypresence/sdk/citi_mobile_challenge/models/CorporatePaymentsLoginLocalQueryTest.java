...
public class CorporatePaymentsLoginLocalQueryTest
		extends
	...
	public void shouldHaveScopes() {
		...
		Assert.assertEquals(
				"all",
				com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin.Scopes.ALL);

		Assert.assertEquals(
				"exact_match",
				com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin.Scopes.EXACT_MATCH);

		Assert.assertEquals(
				"count",
				com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin.Scopes.COUNT);

		Assert.assertEquals(
				"count_exact_match",
				com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin.Scopes.COUNT_EXACT_MATCH);
	...
	public void shouldBeAbleQueryFromCache()
		...
		lock = new CountDownLatch(1);
		List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin> cached = com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin
				.queryInBackground(
						"all",
						params,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin>>() {
		...
		lock = new CountDownLatch(1);
		cached = com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin
				.queryInBackground(
						"all",
						params,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin>>() {
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin> cachedObjects = com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin
