...
public class RetailBankingRewardsCatalogLocalQueryTest
		extends
			RetailBankingRewardsCatalogLocal {
	@Before
	public void setup() {
		super.setup();
	}
	...
	public void shouldHaveScopes() {
		...
		Assert.assertEquals(
				"all",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog.Scopes.ALL);

		Assert.assertEquals(
				"exact_match",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog.Scopes.EXACT_MATCH);

		Assert.assertEquals(
				"count",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog.Scopes.COUNT);

		Assert.assertEquals(
				"count_exact_match",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog.Scopes.COUNT_EXACT_MATCH);

		Assert.assertEquals(
				"rewards_catalog",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog.Scopes.REWARDS_CATALOG);
	...
	public void shouldBeAbleQueryFromCache()
		...
		com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog
				.queryInBackground(
						"all",
						null,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog>>() {
							@Override
							public void finished(
									List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog> arg0,
									Throwable ex) {
								objects = arg0;
								lock.countDown();
							}
		...
		Assert.assertTrue(com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog
		...
		predicates.put("itemCategory", "not_fake");
		...
		params.put("item_category", "fake");

		lock = new CountDownLatch(1);
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog> cached = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog
				.queryInBackground(
						"all",
						params,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog>>() {
		...
		lock = new CountDownLatch(1);
		cached = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog
				.queryInBackground(
						"all",
						params,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog>>() {
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
						...
						list.add("[{\"id\":\"0\",\"item_category\":\"fake\",\"item_code\":\"fake\",\"item_description\":\"fake\",\"item_name\":\"fake\",\"point_required\":0,\"points_available\":0}]");
						return list;
					}
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
							...
							RemoteRequestException {
						List<String> list = new ArrayList<String>();
						list.add("[{\"id\":\"1\",\"item_category\":\"fake\",\"item_code\":\"fake\",\"item_description\":\"fake\",\"item_name\":\"fake\",\"point_required\":0,\"points_available\":0}]");
						return list;
					}
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog> cachedObjects = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog
				.fetchInCacheWithScopePredicate("all");
		Assert.assertTrue(cachedObjects.size() == 1);

		params.clear();
		params.put("item_category", "fakest_string");
		Assert.assertTrue(com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
						...
						list.add("[{\"id\":\"0\",\"item_category\":\"fakest_string\",\"item_code\":\"fake\",\"item_description\":\"fake\",\"item_name\":\"fake\",\"point_required\":0,\"points_available\":0},{\"id\":\"1\",\"item_category\":\"fakest_string\",\"item_code\":\"fake\",\"item_description\":\"fake\",\"item_name\":\"fake\",\"point_required\":0,\"points_available\":0},{\"id\":\"2\",\"item_category\":\"fakest_string\",\"item_code\":\"fake\",\"item_description\":\"fake\",\"item_name\":\"fake\",\"point_required\":0,\"points_available\":0}]");
						return list;
					}
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
						...
						list.add("[{\"id\":\"3\",\"item_category\":\"fakest_string\",\"item_code\":\"fake\",\"item_description\":\"fake\",\"item_name\":\"fake\",\"point_required\":0,\"points_available\":0},{\"id\":\"4\",\"item_category\":\"fakest_string\",\"item_code\":\"fake\",\"item_description\":\"fake\",\"item_name\":\"fake\",\"point_required\":0,\"points_available\":0},{\"id\":\"5\",\"item_category\":\"fakest_string\",\"item_code\":\"fake\",\"item_description\":\"fake\",\"item_name\":\"fake\",\"point_required\":0,\"points_available\":0}]");
						return list;
					}
		...
		exactMatchParams.put("item_category", "fakest_string");
