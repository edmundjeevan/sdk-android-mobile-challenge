...
public class RetailBankingAccountBalanceLocalSaveTest
		extends
	...
	public void shouldBeAbleSaveIntoCache()
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance> objectsInCache = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance
				.loadAllInCache();
		Assert.assertTrue(objectsInCache.size() == 2);

		com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance object0 = objectsInCache
				.get(0);
		object0.saveInCache();
		...
		com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance object1 = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance();
		object1.saveInCache();

		com.anypresence.sdk.APObject.deleteAllInCache();
		com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance object2 = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance();
		object2.updateInCache();
		objectsInCache = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance
				.loadAllInCache();
