...
public class CapitalMarketsContactBasicTest {
	private static RemoteRailsConfig config;
	private List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact> createdObjects;
	...
	public static void init() throws InterruptedException,
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact> objects = com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact
				.query("all");
		if (!objects.isEmpty()) {
			Assert.fail("Unable to run test as there are data for CapitalMarketsContact.");
		}
	...
	public void shouldBeAbletoQueryForAll() throws UnauthorizedException,
		...
		createdObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact>();

		// Create some entities.
		for (int i = 0; i < MAX_ENTITIES; i++) {
			com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact obj = new com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact();
		...
		objects = com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact
				.query("all", null, 0, 2);
	...
	public void cleanUp() throws RemoteRequestException {
		...
		for (com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact category : createdObjects) {
			category.delete();
		}
