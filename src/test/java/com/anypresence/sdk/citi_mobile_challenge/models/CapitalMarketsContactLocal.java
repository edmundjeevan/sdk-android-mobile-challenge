...
public class CapitalMarketsContactLocal {
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact> createdObjects;
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact> objects;
	...
	protected IRestClient getTestRestClient() {
		return new MockJSONRestClient() {
			...
			public List<String> get(URI uri) throws JSONException, IOException,
				...
				list.add("[{\"id\":\"0\",\"address\":\"fake\",\"city\":\"fake\",\"client_name\":\"fake\",\"country\":\"fake\",\"email\":\"fake\",\"job_role\":\"fake\",\"job_title\":\"fake\",\"name\":\"fake\",\"phone\":\"fake\",\"state\":\"fake\",\"year\":0},{\"id\":\"1\",\"address\":\"fake\",\"city\":\"fake\",\"client_name\":\"fake\",\"country\":\"fake\",\"email\":\"fake\",\"job_role\":\"fake\",\"job_title\":\"fake\",\"name\":\"fake\",\"phone\":\"fake\",\"state\":\"fake\",\"year\":0}]");
				return list;
			}
