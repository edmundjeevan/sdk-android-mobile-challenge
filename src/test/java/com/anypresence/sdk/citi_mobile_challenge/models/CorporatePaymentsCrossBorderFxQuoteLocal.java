...
public class CorporatePaymentsCrossBorderFxQuoteLocal {
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxQuote> createdObjects;
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxQuote> objects;
	...
	protected IRestClient getTestRestClient() {
		return new MockJSONRestClient() {
			...
			public List<String> get(URI uri) throws JSONException, IOException,
				...
				list.add("[{\"requested_on\":\"0\",\"from_amount\":0,\"from_currency\":\"fake\",\"rate_expiry\":\"fake\",\"rate_reference\":\"fake\",\"requested_by\":\"fake\",\"to_amount\":0,\"to_currency\":\"fake\",\"value_date\":\"fake\"},{\"requested_on\":\"1\",\"from_amount\":0,\"from_currency\":\"fake\",\"rate_expiry\":\"fake\",\"rate_reference\":\"fake\",\"requested_by\":\"fake\",\"to_amount\":0,\"to_currency\":\"fake\",\"value_date\":\"fake\"}]");
				return list;
			}
