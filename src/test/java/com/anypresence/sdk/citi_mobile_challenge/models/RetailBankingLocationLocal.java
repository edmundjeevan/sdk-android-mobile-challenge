...
public class RetailBankingLocationLocal {
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLocation> createdObjects;
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLocation> objects;
	...
	protected IRestClient getTestRestClient() {
		return new MockJSONRestClient() {
			...
			public List<String> get(URI uri) throws JSONException, IOException,
				...
				list.add("[{\"id\":\"0\",\"address_line_one\":\"fake\",\"address_line_two\":\"fake\",\"city\":\"fake\",\"comments\":\"fake\",\"country\":\"fake\",\"external_link\":\"fake\",\"latitude\":\"fake\",\"location_type\":\"fake\",\"longitude\":\"fake\",\"name\":\"fake\",\"phone\":\"fake\",\"postal_code\":\"fake\",\"state\":\"fake\"},{\"id\":\"1\",\"address_line_one\":\"fake\",\"address_line_two\":\"fake\",\"city\":\"fake\",\"comments\":\"fake\",\"country\":\"fake\",\"external_link\":\"fake\",\"latitude\":\"fake\",\"location_type\":\"fake\",\"longitude\":\"fake\",\"name\":\"fake\",\"phone\":\"fake\",\"postal_code\":\"fake\",\"state\":\"fake\"}]");
				return list;
			}
