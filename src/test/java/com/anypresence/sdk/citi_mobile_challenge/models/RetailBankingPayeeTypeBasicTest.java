...
public class RetailBankingPayeeTypeBasicTest {
	private static RemoteRailsConfig config;
	private List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType> createdObjects;
	...
	public static void init() throws InterruptedException,
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType> objects = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType
				.query("all");
		if (!objects.isEmpty()) {
			Assert.fail("Unable to run test as there are data for RetailBankingPayeeType.");
		}
	...
	public void shouldBeAbletoQueryForAll() throws UnauthorizedException,
		...
		createdObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType>();

		// Create some entities.
		for (int i = 0; i < MAX_ENTITIES; i++) {
			com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType obj = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType();
		...
		objects = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType
				.query("all", null, 0, 2);
	...
	public void cleanUp() throws RemoteRequestException {
		...
		for (com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType category : createdObjects) {
			category.delete();
		}
