...
public class CapitalMarketsRevenueLocal {
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue> createdObjects;
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue> objects;
	...
	protected IRestClient getTestRestClient() {
		return new MockJSONRestClient() {
			...
			public List<String> get(URI uri) throws JSONException, IOException,
				...
				list.add("[{\"id\":\"0\",\"client_id\":\"fake\",\"client_name\":\"fake\",\"client_tier\":\"fake\",\"gross_comm\":0,\"month\":\"fake\",\"product_id\":\"fake\",\"product_name\":\"fake\",\"profit_loss\":0,\"region\":\"fake\",\"year\":0},{\"id\":\"1\",\"client_id\":\"fake\",\"client_name\":\"fake\",\"client_tier\":\"fake\",\"gross_comm\":0,\"month\":\"fake\",\"product_id\":\"fake\",\"product_name\":\"fake\",\"profit_loss\":0,\"region\":\"fake\",\"year\":0}]");
				return list;
			}
