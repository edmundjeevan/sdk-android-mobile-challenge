...
public class CorporatePaymentsLoginBasicTest {
	private static RemoteRailsConfig config;
	private List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin> createdObjects;
	...
	public static void init() throws InterruptedException,
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin> objects = com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin
				.query("all");
		if (!objects.isEmpty()) {
			Assert.fail("Unable to run test as there are data for CorporatePaymentsLogin.");
		}
	...
	public void shouldBeAbletoQueryForAll() throws UnauthorizedException,
		...
		createdObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin>();

		// Create some entities.
		for (int i = 0; i < MAX_ENTITIES; i++) {
			com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin obj = new com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin();
		...
		objects = com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin
				.query("all", null, 0, 2);
	...
	public void shouldBeAbletoQueryForExactMatch()
		...
		params.put("token", obj.getToken().toString());
	...
	public void cleanUp() throws RemoteRequestException {
		...
		for (com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsLogin category : createdObjects) {
			category.delete();
		}
