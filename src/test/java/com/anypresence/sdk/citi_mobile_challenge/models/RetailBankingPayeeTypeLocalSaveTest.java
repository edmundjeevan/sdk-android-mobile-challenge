...
public class RetailBankingPayeeTypeLocalSaveTest
		extends
	...
	public void shouldBeAbleSaveIntoCache()
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType> objectsInCache = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType
				.loadAllInCache();
		Assert.assertTrue(objectsInCache.size() == 2);

		com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType object0 = objectsInCache
				.get(0);
		object0.saveInCache();
		...
		com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType object1 = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType();
		object1.saveInCache();

		com.anypresence.sdk.APObject.deleteAllInCache();
		com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType object2 = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType();
		object2.updateInCache();
		objectsInCache = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType
				.loadAllInCache();
