...
public class CapitalMarketsOrderLocalQueryTest extends CapitalMarketsOrderLocal {
	@Before
	public void setup() {
		super.setup();
	}
	...
	public void shouldHaveScopes() {
		...
		Assert.assertEquals(
				"all",
				com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsOrder.Scopes.ALL);

		Assert.assertEquals(
				"exact_match",
				com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsOrder.Scopes.EXACT_MATCH);

		Assert.assertEquals(
				"count",
				com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsOrder.Scopes.COUNT);

		Assert.assertEquals(
				"count_exact_match",
				com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsOrder.Scopes.COUNT_EXACT_MATCH);
	...
	public void shouldBeAbleQueryFromCache()
		...
		com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsOrder
				.queryInBackground(
						"all",
						null,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsOrder>>() {
							@Override
							public void finished(
									List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsOrder> arg0,
									Throwable ex) {
								objects = arg0;
								lock.countDown();
							}
		...
		Assert.assertTrue(com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsOrder
		...
		predicates.put("comments", "not_fake");
		...
		params.put("comments", "fake");

		lock = new CountDownLatch(1);
		List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsOrder> cached = com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsOrder
				.queryInBackground(
						"all",
						params,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsOrder>>() {
		...
		lock = new CountDownLatch(1);
		cached = com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsOrder
				.queryInBackground(
						"all",
						params,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsOrder>>() {
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
						...
						list.add("[{\"id\":\"0\",\"comments\":\"fake\",\"currency\":\"fake\",\"last_price\":0,\"last_qty\":0,\"price\":0,\"quantity\":0,\"side\":\"fake\",\"status\":\"fake\",\"symbol\":\"fake\",\"transact_time\":\"fake\"}]");
						return list;
					}
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
							...
							RemoteRequestException {
						List<String> list = new ArrayList<String>();
						list.add("[{\"id\":\"1\",\"comments\":\"fake\",\"currency\":\"fake\",\"last_price\":0,\"last_qty\":0,\"price\":0,\"quantity\":0,\"side\":\"fake\",\"status\":\"fake\",\"symbol\":\"fake\",\"transact_time\":\"fake\"}]");
						return list;
					}
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsOrder> cachedObjects = com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsOrder
				.fetchInCacheWithScopePredicate("all");
		Assert.assertTrue(cachedObjects.size() == 1);

		params.clear();
		params.put("comments", "fakest_string");
		Assert.assertTrue(com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsOrder
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
						...
						list.add("[{\"id\":\"0\",\"comments\":\"fakest_string\",\"currency\":\"fake\",\"last_price\":0,\"last_qty\":0,\"price\":0,\"quantity\":0,\"side\":\"fake\",\"status\":\"fake\",\"symbol\":\"fake\",\"transact_time\":\"fake\"},{\"id\":\"1\",\"comments\":\"fakest_string\",\"currency\":\"fake\",\"last_price\":0,\"last_qty\":0,\"price\":0,\"quantity\":0,\"side\":\"fake\",\"status\":\"fake\",\"symbol\":\"fake\",\"transact_time\":\"fake\"},{\"id\":\"2\",\"comments\":\"fakest_string\",\"currency\":\"fake\",\"last_price\":0,\"last_qty\":0,\"price\":0,\"quantity\":0,\"side\":\"fake\",\"status\":\"fake\",\"symbol\":\"fake\",\"transact_time\":\"fake\"}]");
						return list;
					}
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
						...
						list.add("[{\"id\":\"3\",\"comments\":\"fakest_string\",\"currency\":\"fake\",\"last_price\":0,\"last_qty\":0,\"price\":0,\"quantity\":0,\"side\":\"fake\",\"status\":\"fake\",\"symbol\":\"fake\",\"transact_time\":\"fake\"},{\"id\":\"4\",\"comments\":\"fakest_string\",\"currency\":\"fake\",\"last_price\":0,\"last_qty\":0,\"price\":0,\"quantity\":0,\"side\":\"fake\",\"status\":\"fake\",\"symbol\":\"fake\",\"transact_time\":\"fake\"},{\"id\":\"5\",\"comments\":\"fakest_string\",\"currency\":\"fake\",\"last_price\":0,\"last_qty\":0,\"price\":0,\"quantity\":0,\"side\":\"fake\",\"status\":\"fake\",\"symbol\":\"fake\",\"transact_time\":\"fake\"}]");
						return list;
					}
		...
		exactMatchParams.put("comments", "fakest_string");
