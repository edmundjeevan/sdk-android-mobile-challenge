...
public class RetailBankingAccountBalanceLocal {
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance> createdObjects;
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance> objects;
	...
	protected IRestClient getTestRestClient() {
		return new MockJSONRestClient() {
			...
			public List<String> get(URI uri) throws JSONException, IOException,
				...
				list.add("[{\"id\":\"0\",\"account_id\":\"fake\",\"balance_type\":\"fake\",\"value\":0},{\"id\":\"1\",\"account_id\":\"fake\",\"balance_type\":\"fake\",\"value\":0}]");
				return list;
			}
