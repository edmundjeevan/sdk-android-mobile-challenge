...
public class RetailBankingPayeeTypeLocalQueryTest
		extends
	...
	public void shouldHaveScopes() {
		...
		Assert.assertEquals(
				"all",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType.Scopes.ALL);

		Assert.assertEquals(
				"exact_match",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType.Scopes.EXACT_MATCH);

		Assert.assertEquals(
				"count",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType.Scopes.COUNT);

		Assert.assertEquals(
				"count_exact_match",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType.Scopes.COUNT_EXACT_MATCH);
	...
	public void shouldBeAbleQueryFromCache()
		...
		params.put("value", "fake");

		lock = new CountDownLatch(1);
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType> cached = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType
				.queryInBackground(
						"all",
						params,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType>>() {
		...
		lock = new CountDownLatch(1);
		cached = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType
				.queryInBackground(
						"all",
						params,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType>>() {
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType> cachedObjects = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType
				.fetchInCacheWithScopePredicate("all");
		Assert.assertTrue(cachedObjects.size() == 1);

		params.clear();
		params.put("value", "fakest_string");
		Assert.assertTrue(com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
						...
						list.add("[{\"id\":\"0\",\"value\":\"fakest_string\"},{\"id\":\"1\",\"value\":\"fakest_string\"},{\"id\":\"2\",\"value\":\"fakest_string\"}]");
						return list;
					}
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
						...
						list.add("[{\"id\":\"3\",\"value\":\"fakest_string\"},{\"id\":\"4\",\"value\":\"fakest_string\"},{\"id\":\"5\",\"value\":\"fakest_string\"}]");
						return list;
					}
		...
		exactMatchParams.put("value", "fakest_string");
