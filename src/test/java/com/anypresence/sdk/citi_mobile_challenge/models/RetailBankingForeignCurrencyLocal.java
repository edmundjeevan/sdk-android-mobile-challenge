...
public class RetailBankingForeignCurrencyLocal {
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency> createdObjects;
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency> objects;
	...
	protected IRestClient getTestRestClient() {
		return new MockJSONRestClient() {
			...
			public List<String> get(URI uri) throws JSONException, IOException,
				...
				list.add("[{\"id\":\"0\",\"from_currency\":\"fake\",\"rate\":0,\"to_currency\":\"fake\"},{\"id\":\"1\",\"from_currency\":\"fake\",\"rate\":0,\"to_currency\":\"fake\"}]");
				return list;
			}
