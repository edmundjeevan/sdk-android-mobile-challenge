...
public class RetailBankingRewardsRedemptionBasicTest {
	private static RemoteRailsConfig config;
	private List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsRedemption> createdObjects;
	...
	public static void init() throws InterruptedException,
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsRedemption> objects = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsRedemption
				.query("all");
		if (!objects.isEmpty()) {
			Assert.fail("Unable to run test as there are data for RetailBankingRewardsRedemption.");
		}
	...
	public void shouldBeAbletoQueryForAll() throws UnauthorizedException,
		...
		createdObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsRedemption>();

		// Create some entities.
		for (int i = 0; i < MAX_ENTITIES; i++) {
			com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsRedemption obj = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsRedemption();
		...
		objects = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsRedemption
				.query("all", null, 0, 2);
	...
	public void cleanUp() throws RemoteRequestException {
		...
		for (com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsRedemption category : createdObjects) {
			category.delete();
		}
