...
public class CorporatePaymentsAccountLocal {
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount> createdObjects;
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount> objects;
	...
	protected IRestClient getTestRestClient() {
		return new MockJSONRestClient() {
			...
			public List<String> get(URI uri) throws JSONException, IOException,
				...
				list.add("[{\"id\":\"0\",\"account_name\":\"fake\",\"base_currency_balances\":{\"data0\":\"fake0\",\"data1\":\"fake1\"},\"branch_name\":\"fake\",\"country_iso_code\":\"fake\",\"local_currency_iso_code\":\"fake\",\"name\":\"fake\",\"status\":\"fake\"},{\"id\":\"1\",\"account_name\":\"fake\",\"base_currency_balances\":{\"data0\":\"fake0\",\"data1\":\"fake1\"},\"branch_name\":\"fake\",\"country_iso_code\":\"fake\",\"local_currency_iso_code\":\"fake\",\"name\":\"fake\",\"status\":\"fake\"}]");
				return list;
			}
