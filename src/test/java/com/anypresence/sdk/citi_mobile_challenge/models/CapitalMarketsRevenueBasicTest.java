...
public class CapitalMarketsRevenueBasicTest {
	private static RemoteRailsConfig config;
	private List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue> createdObjects;
	...
	public static void init() throws InterruptedException,
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue> objects = com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue
				.query("all");
		if (!objects.isEmpty()) {
			Assert.fail("Unable to run test as there are data for CapitalMarketsRevenue.");
		}
	...
	public void shouldBeAbletoQueryForAll() throws UnauthorizedException,
		...
		createdObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue>();

		// Create some entities.
		for (int i = 0; i < MAX_ENTITIES; i++) {
			com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue obj = new com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue();
		...
		objects = com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue
				.query("all", null, 0, 2);
	...
	public void cleanUp() throws RemoteRequestException {
		...
		for (com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue category : createdObjects) {
			category.delete();
		}
