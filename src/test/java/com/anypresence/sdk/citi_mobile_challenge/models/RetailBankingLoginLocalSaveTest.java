...
public class RetailBankingLoginLocalSaveTest extends RetailBankingLoginLocal {
	@Before
	public void setup() {
		super.setup();
	}
	...
	public void shouldBeAbleSaveIntoCache()
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin> objectsInCache = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin
				.loadAllInCache();
		Assert.assertTrue(objectsInCache.size() == 2);

		com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin object0 = objectsInCache
				.get(0);
		object0.saveInCache();
		...
		com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin object1 = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin();
		object1.saveInCache();

		com.anypresence.sdk.APObject.deleteAllInCache();
		com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin object2 = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin();
		object2.updateInCache();
		objectsInCache = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin
				.loadAllInCache();
