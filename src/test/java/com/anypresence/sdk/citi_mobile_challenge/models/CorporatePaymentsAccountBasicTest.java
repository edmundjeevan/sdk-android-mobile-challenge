...
public class CorporatePaymentsAccountBasicTest {
	private static RemoteRailsConfig config;
	private List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount> createdObjects;
	...
	public static void init() throws InterruptedException,
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount> objects = com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount
				.query("all");
		if (!objects.isEmpty()) {
			Assert.fail("Unable to run test as there are data for CorporatePaymentsAccount.");
		}
	...
	public void shouldBeAbletoQueryForAll() throws UnauthorizedException,
		...
		createdObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount>();

		// Create some entities.
		for (int i = 0; i < MAX_ENTITIES; i++) {
			com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount obj = new com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount();
		...
		objects = com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount
				.query("all", null, 0, 2);
	...
	public void cleanUp() throws RemoteRequestException {
		...
		for (com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount category : createdObjects) {
			category.delete();
		}
