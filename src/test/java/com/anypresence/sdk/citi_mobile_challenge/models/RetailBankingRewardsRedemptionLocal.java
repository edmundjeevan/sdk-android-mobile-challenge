...
public class RetailBankingRewardsRedemptionLocal {
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsRedemption> createdObjects;
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsRedemption> objects;
	...
	protected IRestClient getTestRestClient() {
		return new MockJSONRestClient() {
			...
			public List<String> get(URI uri) throws JSONException, IOException,
				...
				list.add("[{\"id\":\"0\",\"points_available\":0,\"redemption_details\":[\"fake0\",\"fake1\"]},{\"id\":\"1\",\"points_available\":0,\"redemption_details\":[\"fake0\",\"fake1\"]}]");
				return list;
			}
