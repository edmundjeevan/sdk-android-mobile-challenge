...
public class CapitalMarketsContactLocalQueryTest
		extends
			CapitalMarketsContactLocal {
	@Before
	public void setup() {
		super.setup();
	}
	...
	public void shouldHaveScopes() {
		...
		Assert.assertEquals(
				"all",
				com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact.Scopes.ALL);

		Assert.assertEquals(
				"exact_match",
				com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact.Scopes.EXACT_MATCH);

		Assert.assertEquals(
				"count",
				com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact.Scopes.COUNT);

		Assert.assertEquals(
				"count_exact_match",
				com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact.Scopes.COUNT_EXACT_MATCH);

		Assert.assertEquals(
				"contacts",
				com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact.Scopes.CONTACTS);
	...
	public void shouldBeAbleQueryFromCache()
		...
		com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact
				.queryInBackground(
						"all",
						null,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact>>() {
							@Override
							public void finished(
									List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact> arg0,
									Throwable ex) {
								objects = arg0;
								lock.countDown();
							}
		...
		Assert.assertTrue(com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact
		...
		predicates.put("address", "not_fake");
		...
		params.put("address", "fake");

		lock = new CountDownLatch(1);
		List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact> cached = com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact
				.queryInBackground(
						"all",
						params,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact>>() {
		...
		lock = new CountDownLatch(1);
		cached = com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact
				.queryInBackground(
						"all",
						params,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact>>() {
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
						...
						list.add("[{\"id\":\"0\",\"address\":\"fake\",\"city\":\"fake\",\"client_name\":\"fake\",\"country\":\"fake\",\"email\":\"fake\",\"job_role\":\"fake\",\"job_title\":\"fake\",\"name\":\"fake\",\"phone\":\"fake\",\"state\":\"fake\",\"year\":0}]");
						return list;
					}
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
							...
							RemoteRequestException {
						List<String> list = new ArrayList<String>();
						list.add("[{\"id\":\"1\",\"address\":\"fake\",\"city\":\"fake\",\"client_name\":\"fake\",\"country\":\"fake\",\"email\":\"fake\",\"job_role\":\"fake\",\"job_title\":\"fake\",\"name\":\"fake\",\"phone\":\"fake\",\"state\":\"fake\",\"year\":0}]");
						return list;
					}
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact> cachedObjects = com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact
				.fetchInCacheWithScopePredicate("all");
		Assert.assertTrue(cachedObjects.size() == 1);

		params.clear();
		params.put("address", "fakest_string");
		Assert.assertTrue(com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContact
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
						...
						list.add("[{\"id\":\"0\",\"address\":\"fakest_string\",\"city\":\"fake\",\"client_name\":\"fake\",\"country\":\"fake\",\"email\":\"fake\",\"job_role\":\"fake\",\"job_title\":\"fake\",\"name\":\"fake\",\"phone\":\"fake\",\"state\":\"fake\",\"year\":0},{\"id\":\"1\",\"address\":\"fakest_string\",\"city\":\"fake\",\"client_name\":\"fake\",\"country\":\"fake\",\"email\":\"fake\",\"job_role\":\"fake\",\"job_title\":\"fake\",\"name\":\"fake\",\"phone\":\"fake\",\"state\":\"fake\",\"year\":0},{\"id\":\"2\",\"address\":\"fakest_string\",\"city\":\"fake\",\"client_name\":\"fake\",\"country\":\"fake\",\"email\":\"fake\",\"job_role\":\"fake\",\"job_title\":\"fake\",\"name\":\"fake\",\"phone\":\"fake\",\"state\":\"fake\",\"year\":0}]");
						return list;
					}
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
						...
						list.add("[{\"id\":\"3\",\"address\":\"fakest_string\",\"city\":\"fake\",\"client_name\":\"fake\",\"country\":\"fake\",\"email\":\"fake\",\"job_role\":\"fake\",\"job_title\":\"fake\",\"name\":\"fake\",\"phone\":\"fake\",\"state\":\"fake\",\"year\":0},{\"id\":\"4\",\"address\":\"fakest_string\",\"city\":\"fake\",\"client_name\":\"fake\",\"country\":\"fake\",\"email\":\"fake\",\"job_role\":\"fake\",\"job_title\":\"fake\",\"name\":\"fake\",\"phone\":\"fake\",\"state\":\"fake\",\"year\":0},{\"id\":\"5\",\"address\":\"fakest_string\",\"city\":\"fake\",\"client_name\":\"fake\",\"country\":\"fake\",\"email\":\"fake\",\"job_role\":\"fake\",\"job_title\":\"fake\",\"name\":\"fake\",\"phone\":\"fake\",\"state\":\"fake\",\"year\":0}]");
						return list;
					}
		...
		exactMatchParams.put("address", "fakest_string");
