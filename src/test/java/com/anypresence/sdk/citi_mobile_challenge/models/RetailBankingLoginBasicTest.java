...
public class RetailBankingLoginBasicTest {
	private static RemoteRailsConfig config;
	private List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin> createdObjects;
	...
	public static void init() throws InterruptedException,
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin> objects = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin
				.query("all");
		if (!objects.isEmpty()) {
			Assert.fail("Unable to run test as there are data for RetailBankingLogin.");
		}
	...
	public void shouldBeAbletoQueryForAll() throws UnauthorizedException,
		...
		createdObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin>();

		// Create some entities.
		for (int i = 0; i < MAX_ENTITIES; i++) {
			com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin obj = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin();
		...
		objects = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin
				.query("all", null, 0, 2);
	...
	public void cleanUp() throws RemoteRequestException {
		...
		for (com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin category : createdObjects) {
			category.delete();
		}
