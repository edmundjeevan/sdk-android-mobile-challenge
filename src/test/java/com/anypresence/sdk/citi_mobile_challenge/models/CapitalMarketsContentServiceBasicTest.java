...
public class CapitalMarketsContentServiceBasicTest {
	private static RemoteRailsConfig config;
	private List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContentService> createdObjects;
	...
	public static void init() throws InterruptedException,
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContentService> objects = com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContentService
				.query("all");
		if (!objects.isEmpty()) {
			Assert.fail("Unable to run test as there are data for CapitalMarketsContentService.");
		}
	...
	public void shouldBeAbletoQueryForAll() throws UnauthorizedException,
		...
		createdObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContentService>();

		// Create some entities.
		for (int i = 0; i < MAX_ENTITIES; i++) {
			com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContentService obj = new com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContentService();
		...
		objects = com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContentService
				.query("all", null, 0, 2);
	...
	public void cleanUp() throws RemoteRequestException {
		...
		for (com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsContentService category : createdObjects) {
			category.delete();
		}
