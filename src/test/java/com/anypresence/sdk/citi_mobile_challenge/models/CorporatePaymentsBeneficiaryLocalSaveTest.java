...
public class CorporatePaymentsBeneficiaryLocalSaveTest
		extends
	...
	public void shouldBeAbleSaveIntoCache()
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsBeneficiary> objectsInCache = com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsBeneficiary
				.loadAllInCache();
		Assert.assertTrue(objectsInCache.size() == 2);

		com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsBeneficiary object0 = objectsInCache
				.get(0);
		object0.saveInCache();
		...
		com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsBeneficiary object1 = new com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsBeneficiary();
		object1.saveInCache();

		com.anypresence.sdk.APObject.deleteAllInCache();
		com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsBeneficiary object2 = new com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsBeneficiary();
		object2.updateInCache();
		objectsInCache = com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsBeneficiary
				.loadAllInCache();
