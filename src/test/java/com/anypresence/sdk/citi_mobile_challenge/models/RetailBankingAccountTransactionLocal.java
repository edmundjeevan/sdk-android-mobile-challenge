...
public class RetailBankingAccountTransactionLocal {
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction> createdObjects;
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction> objects;
	...
	protected IRestClient getTestRestClient() {
		return new MockJSONRestClient() {
			...
			public List<String> get(URI uri) throws JSONException, IOException,
				...
				list.add("[{\"id\":\"0\",\"account_id\":\"fake\",\"activity\":\"fake\",\"check_image_eligible\":\"fake\",\"date_posted\":\"fake\",\"formatted_amount\":\"fake\",\"pending_date\":\"fake\",\"transaction_amount\":0,\"transaction_description\":\"fake\",\"transaction_identifier\":\"fake\",\"transaction_index\":\"fake\",\"transaction_type\":\"fake\"},{\"id\":\"1\",\"account_id\":\"fake\",\"activity\":\"fake\",\"check_image_eligible\":\"fake\",\"date_posted\":\"fake\",\"formatted_amount\":\"fake\",\"pending_date\":\"fake\",\"transaction_amount\":0,\"transaction_description\":\"fake\",\"transaction_identifier\":\"fake\",\"transaction_index\":\"fake\",\"transaction_type\":\"fake\"}]");
				return list;
			}
