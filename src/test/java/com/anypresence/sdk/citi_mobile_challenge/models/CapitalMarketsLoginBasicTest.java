...
public class CapitalMarketsLoginBasicTest {
	private static RemoteRailsConfig config;
	private List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin> createdObjects;
	...
	public static void init() throws InterruptedException,
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin> objects = com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin
				.query("all");
		if (!objects.isEmpty()) {
			Assert.fail("Unable to run test as there are data for CapitalMarketsLogin.");
		}
	...
	public void shouldBeAbletoQueryForAll() throws UnauthorizedException,
		...
		createdObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin>();

		// Create some entities.
		for (int i = 0; i < MAX_ENTITIES; i++) {
			com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin obj = new com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin();
		...
		objects = com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin
				.query("all", null, 0, 2);
	...
	public void cleanUp() throws RemoteRequestException {
		...
		for (com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin category : createdObjects) {
			category.delete();
		}
