...
public class RetailBankingLoginLocal {
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin> createdObjects;
	protected List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin> objects;
	...
	protected IRestClient getTestRestClient() {
		return new MockJSONRestClient() {
			...
			public List<String> get(URI uri) throws JSONException, IOException,
				...
				list.add("[{\"token\":\"0\",\"is_eligible_for_offers\":\"fake\",\"is_person_to_person_required\":\"fake\",\"password\":\"fake\",\"username\":\"fake\"},{\"token\":\"1\",\"is_eligible_for_offers\":\"fake\",\"is_person_to_person_required\":\"fake\",\"password\":\"fake\",\"username\":\"fake\"}]");
				return list;
			}
