...
public class RetailBankingLoginLocalQueryTest extends RetailBankingLoginLocal {
	@Before
	public void setup() {
		super.setup();
	}
	...
	public void shouldHaveScopes() {
		...
		Assert.assertEquals(
				"all",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin.Scopes.ALL);

		Assert.assertEquals(
				"exact_match",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin.Scopes.EXACT_MATCH);

		Assert.assertEquals(
				"count",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin.Scopes.COUNT);

		Assert.assertEquals(
				"count_exact_match",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin.Scopes.COUNT_EXACT_MATCH);
	...
	public void shouldBeAbleQueryFromCache()
		...
		com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin
				.queryInBackground(
						"all",
						null,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin>>() {
							@Override
		...
		Assert.assertTrue(com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin
		...
		predicates.put("isEligibleForOffers", "not_fake");
		...
		params.put("is_eligible_for_offers", "fake");

		lock = new CountDownLatch(1);
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin> cached = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin
				.queryInBackground(
						"all",
						params,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin>>() {
		...
		lock = new CountDownLatch(1);
		cached = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin
				.queryInBackground(
						"all",
						params,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin>>() {
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
						...
						list.add("[{\"token\":\"0\",\"is_eligible_for_offers\":\"fake\",\"is_person_to_person_required\":\"fake\",\"password\":\"fake\",\"username\":\"fake\"}]");
						return list;
					}
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
							...
							RemoteRequestException {
						List<String> list = new ArrayList<String>();
						list.add("[{\"token\":\"1\",\"is_eligible_for_offers\":\"fake\",\"is_person_to_person_required\":\"fake\",\"password\":\"fake\",\"username\":\"fake\"}]");
						return list;
					}
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin> cachedObjects = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin
				.fetchInCacheWithScopePredicate("all");
		Assert.assertTrue(cachedObjects.size() == 1);

		params.clear();
		params.put("is_eligible_for_offers", "fakest_string");
		Assert.assertTrue(com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
						...
						list.add("[{\"token\":\"0\",\"is_eligible_for_offers\":\"fakest_string\",\"is_person_to_person_required\":\"fake\",\"password\":\"fake\",\"username\":\"fake\"},{\"token\":\"1\",\"is_eligible_for_offers\":\"fakest_string\",\"is_person_to_person_required\":\"fake\",\"password\":\"fake\",\"username\":\"fake\"},{\"token\":\"2\",\"is_eligible_for_offers\":\"fakest_string\",\"is_person_to_person_required\":\"fake\",\"password\":\"fake\",\"username\":\"fake\"}]");
						return list;
					}
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
						...
						list.add("[{\"token\":\"3\",\"is_eligible_for_offers\":\"fakest_string\",\"is_person_to_person_required\":\"fake\",\"password\":\"fake\",\"username\":\"fake\"},{\"token\":\"4\",\"is_eligible_for_offers\":\"fakest_string\",\"is_person_to_person_required\":\"fake\",\"password\":\"fake\",\"username\":\"fake\"},{\"token\":\"5\",\"is_eligible_for_offers\":\"fakest_string\",\"is_person_to_person_required\":\"fake\",\"password\":\"fake\",\"username\":\"fake\"}]");
						return list;
					}
		...
		exactMatchParams.put("is_eligible_for_offers", "fakest_string");
