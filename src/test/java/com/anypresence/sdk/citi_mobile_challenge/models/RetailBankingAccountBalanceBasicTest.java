...
public class RetailBankingAccountBalanceBasicTest {
	private static RemoteRailsConfig config;
	private List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance> createdObjects;
	...
	public static void init() throws InterruptedException,
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance> objects = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance
				.query("all");
		if (!objects.isEmpty()) {
			Assert.fail("Unable to run test as there are data for RetailBankingAccountBalance.");
		}
	...
	public void shouldBeAbletoQueryForAll() throws UnauthorizedException,
		...
		createdObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance>();

		// Create some entities.
		for (int i = 0; i < MAX_ENTITIES; i++) {
			com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance obj = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance();
		...
		objects = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance
				.query("all", null, 0, 2);
	...
	public void cleanUp() throws RemoteRequestException {
		...
		for (com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance category : createdObjects) {
			category.delete();
		}
