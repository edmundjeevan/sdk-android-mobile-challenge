...
public class CorporatePaymentsCrossBorderFxPaymentBasicTest {
	private static RemoteRailsConfig config;
	private List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxPayment> createdObjects;
	...
	public static void init() throws InterruptedException,
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxPayment> objects = com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxPayment
				.query("all");
		if (!objects.isEmpty()) {
			Assert.fail("Unable to run test as there are data for CorporatePaymentsCrossBorderFxPayment.");
		}
	...
	public void shouldBeAbletoQueryForAll() throws UnauthorizedException,
		...
		createdObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxPayment>();

		// Create some entities.
		for (int i = 0; i < MAX_ENTITIES; i++) {
			com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxPayment obj = new com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxPayment();
		...
		objects = com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxPayment
				.query("all", null, 0, 2);
	...
	public void cleanUp() throws RemoteRequestException {
		...
		for (com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxPayment category : createdObjects) {
			category.delete();
		}
