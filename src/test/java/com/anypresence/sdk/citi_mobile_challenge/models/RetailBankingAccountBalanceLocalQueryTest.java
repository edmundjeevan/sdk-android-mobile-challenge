...
public class RetailBankingAccountBalanceLocalQueryTest
		extends
			RetailBankingAccountBalanceLocal {
	@Before
	public void setup() {
		super.setup();
	}
	...
	public void shouldHaveScopes() {
		...
		Assert.assertEquals(
				"all",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance.Scopes.ALL);

		Assert.assertEquals(
				"exact_match",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance.Scopes.EXACT_MATCH);

		Assert.assertEquals(
				"count",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance.Scopes.COUNT);

		Assert.assertEquals(
				"count_exact_match",
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance.Scopes.COUNT_EXACT_MATCH);
	...
	public void shouldBeAbleQueryFromCache()
		...
		com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance
				.queryInBackground(
						"all",
						null,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance>>() {
							@Override
							public void finished(
									List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance> arg0,
									Throwable ex) {
								objects = arg0;
								lock.countDown();
							}
		...
		Assert.assertTrue(com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance
		...
		lock = new CountDownLatch(1);
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance> cached = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance
				.queryInBackground(
						"all",
						params,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance>>() {
		...
		lock = new CountDownLatch(1);
		cached = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance
				.queryInBackground(
						"all",
						params,
						new APFutureCallback<List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance>>() {
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
						...
						list.add("[{\"id\":\"0\",\"account_id\":\"fake\",\"balance_type\":\"fake\",\"value\":0}]");
						return list;
					}
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
							...
							RemoteRequestException {
						List<String> list = new ArrayList<String>();
						list.add("[{\"id\":\"1\",\"account_id\":\"fake\",\"balance_type\":\"fake\",\"value\":0}]");
						return list;
					}
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance> cachedObjects = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
						...
						list.add("[{\"id\":\"0\",\"account_id\":\"fakest_string\",\"balance_type\":\"fake\",\"value\":0},{\"id\":\"1\",\"account_id\":\"fakest_string\",\"balance_type\":\"fake\",\"value\":0},{\"id\":\"2\",\"account_id\":\"fakest_string\",\"balance_type\":\"fake\",\"value\":0}]");
						return list;
					}
		...
		RestClientFactory
				.registerJSONRestClientImplementation(new MockJSONRestClient() {
					...
					public List<String> get(URI uri) throws JSONException,
						...
						list.add("[{\"id\":\"3\",\"account_id\":\"fakest_string\",\"balance_type\":\"fake\",\"value\":0},{\"id\":\"4\",\"account_id\":\"fakest_string\",\"balance_type\":\"fake\",\"value\":0},{\"id\":\"5\",\"account_id\":\"fakest_string\",\"balance_type\":\"fake\",\"value\":0}]");
						return list;
					}
