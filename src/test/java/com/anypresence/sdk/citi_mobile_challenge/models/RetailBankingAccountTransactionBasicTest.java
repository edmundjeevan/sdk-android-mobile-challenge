...
public class RetailBankingAccountTransactionBasicTest {
	private static RemoteRailsConfig config;
	private List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction> createdObjects;
	...
	public static void init() throws InterruptedException,
		...
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction> objects = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction
				.query("all");
		if (!objects.isEmpty()) {
			Assert.fail("Unable to run test as there are data for RetailBankingAccountTransaction.");
		}
	...
	public void shouldBeAbletoQueryForAll() throws UnauthorizedException,
		...
		createdObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction>();

		// Create some entities.
		for (int i = 0; i < MAX_ENTITIES; i++) {
			com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction obj = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction();
		...
		objects = com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction
				.query("all", null, 0, 2);
	...
	public void cleanUp() throws RemoteRequestException {
		...
		for (com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction category : createdObjects) {
			category.delete();
		}
