...
/**
 *
 * GreenDAO helper for <tt>RetailBankingLogin</tt>.
 *
 */
class RetailBankingLoginHelper implements IGreenDAOHelper {
	private static Log log = LogFactory.getLog(RetailBankingLoginHelper.class);
	...
	public com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject createObject(
		...
		com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLogin _object = RetailBankingLoginHelper
				.copyToDao((com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin) object);
	...
	/**
	 * <p>
	 * Gets the <tt>RetailBankingLogin</tt> objects from the cache by object id on the provided object.
	 * </p>
	 * 
	...
	public List<? extends com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject> getObjectsByObjectId(
		...
		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getRetailBankingLoginDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLoginDao.Properties.ObjectId
	...
	public Long insertObject(
		...
		if (Config.getInstance().getCacheStrategy() == Config.CacheStrategy.OVERWRITE) {
			return ((DaoSession) CacheManager.getInstance().getDAOSession()
					...
					.getRetailBankingLoginDao()
					.insertOrReplace(
							(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLogin) object);
		}

		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getRetailBankingLoginDao()
				.insert((com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLogin) object);
	}
	...
	public void updateObject(com.anypresence.sdk.IAPObject object) {
		...
		try {
			if ((objects != null) && !objects.isEmpty()) {
				com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLogin _object = (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLogin) objects
						.get(0);
	...
	public void updateEachObject(
		...
		for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLogin tobject : (List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLogin>) existingObjects) {
			try {
				...
				((DaoSession) CacheManager.getInstance().getDAOSession()
						.getRaw()).getRetailBankingLoginDao().update(tobject);
				CacheManager
						.getInstance()
	...
	public void deleteAllInCacheWithScopePredicate(String scope) {
		((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getRetailBankingLoginDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLoginDao.Properties.Scope
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithAPCachedRequestPredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLogin> cachedObjects = ((DaoSession) CacheManager
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithScopePredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequest> apCachedRequests = ((DaoSession) CacheManager
				...
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequestDao.Properties.Type
						.eq(com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin.class
			...
			if (apCachedRequests != null && !apCachedRequests.isEmpty()) {
				...
				if (scope != null) {
					...
					apObjectsApCachedRequests = ((DaoSession) CacheManager
							...
							.queryRawCreate(
									query,
									com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin.class
											.getSimpleName().toLowerCase(),
									scope).listLazy();
				} else {
				...
				try {
					...
					try {
						Query<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLogin> query = null;
						if (!hasInvalidParam
							...
							query = ((DaoSession) CacheManager.getInstance()
									...
									.getRetailBankingLoginDao().queryRawCreate(
											rawQuery,
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithIds(
			Set<Long> objectIds) {
		QueryBuilder<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLogin> queryBuilder = ((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getRetailBankingLoginDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLoginDao.Properties.Id
						.in(objectIds));
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> loadAllInCache() {
		...
		objects.addAll((List<T>) getCloneObjects(((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getRetailBankingLoginDao().queryBuilder().listLazy()));
		return objects;
	}
	 ...
	 */
	public static final com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin copyFromDao(
			com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLogin orig) {
		final com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin newObject = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin();

		if (orig.getToken() != null)
			newObject.setTokenAsString(orig.getToken().toString());

		if (orig.getIsEligibleForOffers() != null)
			newObject.setIsEligibleForOffers(orig.getIsEligibleForOffers()
					.toString());

		if (orig.getIsPersonToPersonRequired() != null)
			newObject.setIsPersonToPersonRequired(orig
					.getIsPersonToPersonRequired().toString());
	 ...
	 */
	public static final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLogin copyToDao(
			com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin orig) {
		final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLogin newObject = new com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLogin();
	...
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin> getCloneObjects(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLogin> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin> clonedObjects = null;
		try {
			clonedObjects = shallowCloneList(objects);
		} finally {
			if (clonedObjects == null) {
				clonedObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin>();
			}
		}
	...
	/**
	 * Perform a shallow clone of list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLogin</tt>.
	 *
	 * @param objects list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLogin</tt>.
	 * @return list of <tt>RetailBankingLogin</tt>.
	 */
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin> shallowCloneList(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLogin> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin> newObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin>();
		try {
			for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLogin object : objects) {
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin newObject = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLogin();
	...
	private static boolean processParamsIntoStringBuffer(StringBuilder sb,
		...
		for (Map.Entry<String, String> entry : params.entrySet()) {
			...
			try {
				...
				Field field = com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLoginDao.Properties.class
