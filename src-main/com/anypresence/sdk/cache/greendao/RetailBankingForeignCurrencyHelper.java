...
//
//  RetailBankingForeignCurrencyHelper.java
//  
//
...
/**
 *
 * GreenDAO helper for <tt>RetailBankingForeignCurrency</tt>.
 *
 */
class RetailBankingForeignCurrencyHelper implements IGreenDAOHelper {
	private static Log log = LogFactory
			.getLog(RetailBankingForeignCurrencyHelper.class);
	...
	public com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject createObject(
		...
		com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrency _object = RetailBankingForeignCurrencyHelper
				.copyToDao((com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency) object);
	...
	/**
	 * <p>
	 * Gets the <tt>RetailBankingForeignCurrency</tt> objects from the cache by object id on the provided object.
	 * </p>
	 * 
	...
	public List<? extends com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject> getObjectsByObjectId(
		...
		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getRetailBankingForeignCurrencyDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrencyDao.Properties.ObjectId
	...
	public Long insertObject(
		...
		if (Config.getInstance().getCacheStrategy() == Config.CacheStrategy.OVERWRITE) {
			return ((DaoSession) CacheManager.getInstance().getDAOSession()
					...
					.getRetailBankingForeignCurrencyDao()
					.insertOrReplace(
							(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrency) object);
		}

		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getRetailBankingForeignCurrencyDao()
				.insert((com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrency) object);
	}
	...
	public void updateObject(com.anypresence.sdk.IAPObject object) {
		...
		try {
			if ((objects != null) && !objects.isEmpty()) {
				com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrency _object = (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrency) objects
						.get(0);
	...
	public void updateEachObject(
		...
		for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrency tobject : (List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrency>) existingObjects) {
			try {
				...
				((DaoSession) CacheManager.getInstance().getDAOSession()
						.getRaw()).getRetailBankingForeignCurrencyDao().update(
						tobject);
				CacheManager
						.getInstance()
	...
	public void deleteAllInCacheWithScopePredicate(String scope) {
		((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getRetailBankingForeignCurrencyDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrencyDao.Properties.Scope
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithAPCachedRequestPredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrency> cachedObjects = ((DaoSession) CacheManager
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithScopePredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequest> apCachedRequests = ((DaoSession) CacheManager
				...
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequestDao.Properties.Type
						.eq(com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency.class
			...
			if (apCachedRequests != null && !apCachedRequests.isEmpty()) {
				...
				if (scope != null) {
					...
					apObjectsApCachedRequests = ((DaoSession) CacheManager
							...
							.queryRawCreate(
									query,
									com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency.class
											.getSimpleName().toLowerCase(),
									scope).listLazy();
				} else {
				...
				try {
					...
					try {
						Query<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrency> query = null;
						if (!hasInvalidParam
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithIds(
			Set<Long> objectIds) {
		QueryBuilder<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrency> queryBuilder = ((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getRetailBankingForeignCurrencyDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrencyDao.Properties.Id
						.in(objectIds));
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> loadAllInCache() {
		...
		objects.addAll((List<T>) getCloneObjects(((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getRetailBankingForeignCurrencyDao().queryBuilder().listLazy()));
		return objects;
	}
	 ...
	 */
	public static final com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency copyFromDao(
			com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrency orig) {
		final com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency newObject = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency();
		...
		if (orig.getRate() != null)
			newObject.setRate(new Float(orig.getRate().toString()));
	 ...
	 */
	public static final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrency copyToDao(
			com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency orig) {
		final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrency newObject = new com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrency();
	...
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency> getCloneObjects(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrency> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency> clonedObjects = null;
		try {
			clonedObjects = shallowCloneList(objects);
		} finally {
			if (clonedObjects == null) {
				clonedObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency>();
			}
		}
	...
	/**
	 * Perform a shallow clone of list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrency</tt>.
	 *
	 * @param objects list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrency</tt>.
	 * @return list of <tt>RetailBankingForeignCurrency</tt>.
	 */
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency> shallowCloneList(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrency> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency> newObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency>();
		try {
			for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrency object : objects) {
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency newObject = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingForeignCurrency();
	...
	private static boolean processParamsIntoStringBuffer(StringBuilder sb,
		...
		for (Map.Entry<String, String> entry : params.entrySet()) {
			...
			try {
				...
				Field field = com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingForeignCurrencyDao.Properties.class
	...
	private Boolean isDaoSetup() {
		if (((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getRetailBankingForeignCurrencyDao() == null) {
