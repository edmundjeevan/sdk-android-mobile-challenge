...
//
//  RetailBankingAccountFundTransferHelper.java
//  
//
...
/**
 *
 * GreenDAO helper for <tt>RetailBankingAccountFundTransfer</tt>.
 *
 */
class RetailBankingAccountFundTransferHelper implements IGreenDAOHelper {
	private static Log log = LogFactory
			.getLog(RetailBankingAccountFundTransferHelper.class);
	...
	public com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject createObject(
		...
		com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransfer _object = RetailBankingAccountFundTransferHelper
				.copyToDao((com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountFundTransfer) object);
	...
	/**
	 * <p>
	 * Gets the <tt>RetailBankingAccountFundTransfer</tt> objects from the cache by object id on the provided object.
	 * </p>
	 * 
	...
	public List<? extends com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject> getObjectsByObjectId(
		...
		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getRetailBankingAccountFundTransferDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransferDao.Properties.ObjectId
	...
	public Long insertObject(
		...
		if (Config.getInstance().getCacheStrategy() == Config.CacheStrategy.OVERWRITE) {
			return ((DaoSession) CacheManager.getInstance().getDAOSession()
					...
					.getRetailBankingAccountFundTransferDao()
					.insertOrReplace(
							(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransfer) object);
		}

		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getRetailBankingAccountFundTransferDao()
				.insert((com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransfer) object);
	}
	...
	public void updateObject(com.anypresence.sdk.IAPObject object) {
		...
		try {
			if ((objects != null) && !objects.isEmpty()) {
				com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransfer _object = (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransfer) objects
						.get(0);
	...
	public void updateEachObject(
		...
		for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransfer tobject : (List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransfer>) existingObjects) {
			try {
				...
				((DaoSession) CacheManager.getInstance().getDAOSession()
						.getRaw()).getRetailBankingAccountFundTransferDao()
						.update(tobject);
				CacheManager
						.getInstance()
	...
	public void deleteAllInCacheWithScopePredicate(String scope) {
		((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getRetailBankingAccountFundTransferDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransferDao.Properties.Scope
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithAPCachedRequestPredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransfer> cachedObjects = ((DaoSession) CacheManager
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithScopePredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequest> apCachedRequests = ((DaoSession) CacheManager
				...
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequestDao.Properties.Type
						.eq(com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountFundTransfer.class
			...
			if (apCachedRequests != null && !apCachedRequests.isEmpty()) {
				...
				if (scope != null) {
					...
					apObjectsApCachedRequests = ((DaoSession) CacheManager
							...
							.queryRawCreate(
									query,
									com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountFundTransfer.class
											.getSimpleName().toLowerCase(),
									scope).listLazy();
				} else {
				...
				try {
					...
					try {
						Query<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransfer> query = null;
						if (!hasInvalidParam
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithIds(
			Set<Long> objectIds) {
		QueryBuilder<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransfer> queryBuilder = ((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getRetailBankingAccountFundTransferDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransferDao.Properties.Id
						.in(objectIds));
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> loadAllInCache() {
		...
		objects.addAll((List<T>) getCloneObjects(((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getRetailBankingAccountFundTransferDao().queryBuilder()
				.listLazy()));
		return objects;
	}
	 ...
	 */
	public static final com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountFundTransfer copyFromDao(
			com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransfer orig) {
		final com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountFundTransfer newObject = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountFundTransfer();

		if (orig.getObjectId() != null)
			newObject.setObjectIdAsString(orig.getObjectId().toString());

		if (orig.getAmount() != null)
			newObject.setAmount(new Float(orig.getAmount().toString()));

		if (orig.getCurrency() != null)
			newObject.setCurrency(orig.getCurrency().toString());

		if (orig.getDestinationAccountId() != null)
			newObject.setDestinationAccountId(orig.getDestinationAccountId()
					.toString());

		if (orig.getDestinationId() != null)
			newObject.setDestinationId(orig.getDestinationId().toString());

		if (orig.getMemo() != null)
			newObject.setMemo(orig.getMemo().toString());

		if (orig.getPayeeDesc() != null)
			newObject.setPayeeDesc(orig.getPayeeDesc().toString());

		if (orig.getPayeeId() != null)
			newObject.setPayeeId(orig.getPayeeId().toString());

		if (orig.getPayeeType() != null)
			newObject.setPayeeType(orig.getPayeeType().toString());
		...
		if (orig.getReferenceNumber() != null)
			newObject.setReferenceNumber(orig.getReferenceNumber().toString());

		if (orig.getTransactionDate() != null)
			newObject.setTransactionDate(orig.getTransactionDate().toString());
	 ...
	 */
	public static final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransfer copyToDao(
			com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountFundTransfer orig) {
		final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransfer newObject = new com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransfer();
	...
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountFundTransfer> getCloneObjects(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransfer> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountFundTransfer> clonedObjects = null;
		try {
			clonedObjects = shallowCloneList(objects);
		} finally {
			if (clonedObjects == null) {
				clonedObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountFundTransfer>();
			}
		}
	...
	/**
	 * Perform a shallow clone of list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransfer</tt>.
	 *
	 * @param objects list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransfer</tt>.
	 * @return list of <tt>RetailBankingAccountFundTransfer</tt>.
	 */
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountFundTransfer> shallowCloneList(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransfer> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountFundTransfer> newObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountFundTransfer>();
		try {
			for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransfer object : objects) {
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountFundTransfer newObject = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountFundTransfer();
	...
	private static boolean processParamsIntoStringBuffer(StringBuilder sb,
		...
		for (Map.Entry<String, String> entry : params.entrySet()) {
			...
			try {
				...
				Field field = com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountFundTransferDao.Properties.class
