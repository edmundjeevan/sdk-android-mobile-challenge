...
//
//  RetailBankingAccountTransactionHelper.java
//  
//
...
/**
 *
 * GreenDAO helper for <tt>RetailBankingAccountTransaction</tt>.
 *
 */
class RetailBankingAccountTransactionHelper implements IGreenDAOHelper {
	private static Log log = LogFactory
			.getLog(RetailBankingAccountTransactionHelper.class);
	...
	public com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject createObject(
		...
		com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransaction _object = RetailBankingAccountTransactionHelper
				.copyToDao((com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction) object);
	...
	/**
	 * <p>
	 * Gets the <tt>RetailBankingAccountTransaction</tt> objects from the cache by object id on the provided object.
	 * </p>
	 * 
	...
	public List<? extends com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject> getObjectsByObjectId(
		...
		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getRetailBankingAccountTransactionDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransactionDao.Properties.ObjectId
	...
	public Long insertObject(
		...
		if (Config.getInstance().getCacheStrategy() == Config.CacheStrategy.OVERWRITE) {
			return ((DaoSession) CacheManager.getInstance().getDAOSession()
					...
					.getRetailBankingAccountTransactionDao()
					.insertOrReplace(
							(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransaction) object);
		}

		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getRetailBankingAccountTransactionDao()
				.insert((com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransaction) object);
	}
	...
	public void updateObject(com.anypresence.sdk.IAPObject object) {
		...
		try {
			if ((objects != null) && !objects.isEmpty()) {
				com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransaction _object = (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransaction) objects
						.get(0);
	...
	public void updateEachObject(
		...
		for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransaction tobject : (List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransaction>) existingObjects) {
			try {
				...
				((DaoSession) CacheManager.getInstance().getDAOSession()
						.getRaw()).getRetailBankingAccountTransactionDao()
						.update(tobject);
				CacheManager
						.getInstance()
	...
	public void deleteAllInCacheWithScopePredicate(String scope) {
		((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getRetailBankingAccountTransactionDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransactionDao.Properties.Scope
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithAPCachedRequestPredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransaction> cachedObjects = ((DaoSession) CacheManager
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithScopePredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequest> apCachedRequests = ((DaoSession) CacheManager
				...
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequestDao.Properties.Type
						.eq(com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction.class
		...
		try {
			if (apCachedRequests != null && !apCachedRequests.isEmpty()) {
				...
				try {
					...
					try {
						Query<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransaction> query = null;
						if (!hasInvalidParam
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithIds(
			Set<Long> objectIds) {
		QueryBuilder<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransaction> queryBuilder = ((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getRetailBankingAccountTransactionDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransactionDao.Properties.Id
						.in(objectIds));
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> loadAllInCache() {
		...
		objects.addAll((List<T>) getCloneObjects(((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getRetailBankingAccountTransactionDao().queryBuilder()
				.listLazy()));
		return objects;
	}
	 ...
	 */
	public static final com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction copyFromDao(
			com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransaction orig) {
		final com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction newObject = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction();

		if (orig.getObjectId() != null)
			newObject.setObjectIdAsString(orig.getObjectId().toString());

		if (orig.getAccountId() != null)
			newObject.setAccountId(orig.getAccountId().toString());

		if (orig.getActivity() != null)
			newObject.setActivity(orig.getActivity().toString());

		if (orig.getCheckImageEligible() != null)
			newObject.setCheckImageEligible(orig.getCheckImageEligible()
					.toString());

		if (orig.getDatePosted() != null)
			newObject.setDatePosted(orig.getDatePosted().toString());

		if (orig.getFormattedAmount() != null)
			newObject.setFormattedAmount(orig.getFormattedAmount().toString());

		if (orig.getPendingDate() != null)
			newObject.setPendingDate(orig.getPendingDate().toString());
		...
		if (orig.getTransactionDescription() != null)
			newObject.setTransactionDescription(orig
					.getTransactionDescription().toString());

		if (orig.getTransactionIdentifier() != null)
			newObject.setTransactionIdentifier(orig.getTransactionIdentifier()
					.toString());

		if (orig.getTransactionIndex() != null)
			newObject
					.setTransactionIndex(orig.getTransactionIndex().toString());

		if (orig.getTransactionType() != null)
			newObject.setTransactionType(orig.getTransactionType().toString());
	 ...
	 */
	public static final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransaction copyToDao(
			com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction orig) {
		final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransaction newObject = new com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransaction();
	...
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction> getCloneObjects(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransaction> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction> clonedObjects = null;
		try {
			clonedObjects = shallowCloneList(objects);
		} finally {
			if (clonedObjects == null) {
				clonedObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction>();
			}
		}
	...
	/**
	 * Perform a shallow clone of list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransaction</tt>.
	 *
	 * @param objects list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransaction</tt>.
	 * @return list of <tt>RetailBankingAccountTransaction</tt>.
	 */
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction> shallowCloneList(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransaction> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction> newObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction>();
		try {
			for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransaction object : objects) {
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction newObject = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountTransaction();
	...
	private static boolean processParamsIntoStringBuffer(StringBuilder sb,
		...
		for (Map.Entry<String, String> entry : params.entrySet()) {
			...
			try {
				...
				Field field = com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransactionDao.Properties.class
	...
	private Boolean isDaoSetup() {
		if (((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getRetailBankingAccountTransactionDao() == null) {
