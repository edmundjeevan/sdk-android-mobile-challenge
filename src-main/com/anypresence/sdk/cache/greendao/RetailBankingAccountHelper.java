...
//
//  RetailBankingAccountHelper.java
//  
//
...
/**
 *
 * GreenDAO helper for <tt>RetailBankingAccount</tt>.
 *
 */
class RetailBankingAccountHelper implements IGreenDAOHelper {
	private static Log log = LogFactory
			.getLog(RetailBankingAccountHelper.class);
	...
	public com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject createObject(
		...
		com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccount _object = RetailBankingAccountHelper
				.copyToDao((com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccount) object);
	...
	/**
	 * <p>
	 * Gets the <tt>RetailBankingAccount</tt> objects from the cache by object id on the provided object.
	 * </p>
	 * 
	...
	public List<? extends com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject> getObjectsByObjectId(
		...
		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getRetailBankingAccountDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountDao.Properties.ObjectId
	...
	public Long insertObject(
		...
		if (Config.getInstance().getCacheStrategy() == Config.CacheStrategy.OVERWRITE) {
			return ((DaoSession) CacheManager.getInstance().getDAOSession()
					...
					.getRetailBankingAccountDao()
					.insertOrReplace(
							(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccount) object);
		}

		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getRetailBankingAccountDao()
				.insert((com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccount) object);
	}
	...
	public void updateObject(com.anypresence.sdk.IAPObject object) {
		...
		try {
			if ((objects != null) && !objects.isEmpty()) {
				com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccount _object = (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccount) objects
						.get(0);
	...
	public void updateEachObject(
		...
		for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccount tobject : (List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccount>) existingObjects) {
			try {
				...
				((DaoSession) CacheManager.getInstance().getDAOSession()
						.getRaw()).getRetailBankingAccountDao().update(tobject);
				CacheManager
						.getInstance()
	...
	public void deleteAllInCacheWithScopePredicate(String scope) {
		((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getRetailBankingAccountDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountDao.Properties.Scope
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithAPCachedRequestPredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccount> cachedObjects = ((DaoSession) CacheManager
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithScopePredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequest> apCachedRequests = ((DaoSession) CacheManager
				...
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequestDao.Properties.Type
						.eq(com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccount.class
		...
		try {
			if (apCachedRequests != null && !apCachedRequests.isEmpty()) {
				...
				try {
					...
					try {
						Query<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccount> query = null;
						if (!hasInvalidParam
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithIds(
			Set<Long> objectIds) {
		QueryBuilder<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccount> queryBuilder = ((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getRetailBankingAccountDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountDao.Properties.Id
						.in(objectIds));
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> loadAllInCache() {
		...
		objects.addAll((List<T>) getCloneObjects(((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getRetailBankingAccountDao().queryBuilder().listLazy()));
		return objects;
	}
	 ...
	 */
	public static final com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccount copyFromDao(
			com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccount orig) {
		final com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccount newObject = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccount();
		...
		if (orig.getBalances() != null)
			newObject.setBalances(GreenDAOUtility.deserializeToHashMap(orig
					.getBalances().toString()));
		...
		if (orig.getCopsIndicator() != null)
			newObject.setCopsIndicator(orig.getCopsIndicator().toString());

		if (orig.getDetailsExist() != null)
			newObject.setDetailsExist(orig.getDetailsExist().toString());

		if (orig.getDisplayAcctNo() != null)
			newObject.setDisplayAcctNo(orig.getDisplayAcctNo().toString());

		if (orig.getIsDestinationAccount() != null)
			newObject.setIsDestinationAccount(orig.getIsDestinationAccount()
					.toString());

		if (orig.getIsSourceAccount() != null)
			newObject.setIsSourceAccount(orig.getIsSourceAccount().toString());

		if (orig.getMsgs() != null)
			newObject.setMsgs(GreenDAOUtility.deserializeToHashMap(orig
					.getMsgs().toString()));

		if (orig.getOffersIndicator() != null)
			newObject.setOffersIndicator(orig.getOffersIndicator().toString());

		if (orig.getProductCurrency() != null)
			newObject.setProductCurrency(orig.getProductCurrency().toString());

		if (orig.getProductDescription() != null)
			newObject.setProductDescription(orig.getProductDescription()
					.toString());
		...
		if (orig.getTxnExist() != null)
			newObject.setTxnExist(orig.getTxnExist().toString());
	 ...
	 */
	public static final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccount copyToDao(
			com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccount orig) {
		final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccount newObject = new com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccount();
		...
		if (orig.getBalances() != null)
			newObject
					.setBalances(GreenDAOUtility.serialize(orig.getBalances()));
		...
		if (orig.getMsgs() != null)
			newObject.setMsgs(GreenDAOUtility.serialize(orig.getMsgs()));
	...
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccount> getCloneObjects(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccount> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccount> clonedObjects = null;
		try {
			clonedObjects = shallowCloneList(objects);
		} finally {
			if (clonedObjects == null) {
				clonedObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccount>();
			}
		}
	...
	/**
	 * Perform a shallow clone of list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccount</tt>.
	 *
	 * @param objects list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccount</tt>.
	 * @return list of <tt>RetailBankingAccount</tt>.
	 */
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccount> shallowCloneList(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccount> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccount> newObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccount>();
		try {
			for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccount object : objects) {
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccount newObject = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccount();
				newObject = copyFromDao(object);

				newObject.setBalances((HashMap<String, Object>) Utilities
						.transformJsonToObject(GreenDAOUtility
								.base64decode(object.getBalances()),
								HashMap.class));

				newObject.setMsgs((HashMap<String, Object>) Utilities
						.transformJsonToObject(
								GreenDAOUtility.base64decode(object.getMsgs()),
								HashMap.class));
	...
	private static boolean processParamsIntoStringBuffer(StringBuilder sb,
		...
		for (Map.Entry<String, String> entry : params.entrySet()) {
			...
			try {
				...
				Field field = com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountDao.Properties.class
	...
	private Boolean isDaoSetup() {
		if (((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getRetailBankingAccountDao() == null) {
