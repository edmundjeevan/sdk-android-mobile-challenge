...
//
//  RetailBankingPayeeTypeHelper.java
//  
//
...
/**
 *
 * GreenDAO helper for <tt>RetailBankingPayeeType</tt>.
 *
 */
class RetailBankingPayeeTypeHelper implements IGreenDAOHelper {
	private static Log log = LogFactory
			.getLog(RetailBankingPayeeTypeHelper.class);
	...
	public com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject createObject(
		...
		com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeType _object = RetailBankingPayeeTypeHelper
				.copyToDao((com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType) object);
	...
	/**
	 * <p>
	 * Gets the <tt>RetailBankingPayeeType</tt> objects from the cache by object id on the provided object.
	 * </p>
	 * 
	...
	public List<? extends com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject> getObjectsByObjectId(
		...
		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getRetailBankingPayeeTypeDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeTypeDao.Properties.ObjectId
	...
	public Long insertObject(
		...
		if (Config.getInstance().getCacheStrategy() == Config.CacheStrategy.OVERWRITE) {
			return ((DaoSession) CacheManager.getInstance().getDAOSession()
					...
					.getRetailBankingPayeeTypeDao()
					.insertOrReplace(
							(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeType) object);
		}

		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getRetailBankingPayeeTypeDao()
				.insert((com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeType) object);
	}
	...
	public void updateObject(com.anypresence.sdk.IAPObject object) {
		...
		try {
			if ((objects != null) && !objects.isEmpty()) {
				com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeType _object = (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeType) objects
						.get(0);
	...
	public void updateEachObject(
		...
		for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeType tobject : (List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeType>) existingObjects) {
			try {
				...
				((DaoSession) CacheManager.getInstance().getDAOSession()
						.getRaw()).getRetailBankingPayeeTypeDao().update(
						tobject);
				CacheManager
						.getInstance()
	...
	public void deleteAllInCacheWithScopePredicate(String scope) {
		((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getRetailBankingPayeeTypeDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeTypeDao.Properties.Scope
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithAPCachedRequestPredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeType> cachedObjects = ((DaoSession) CacheManager
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithScopePredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequest> apCachedRequests = ((DaoSession) CacheManager
				...
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequestDao.Properties.Type
						.eq(com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType.class
			...
			if (apCachedRequests != null && !apCachedRequests.isEmpty()) {
				...
				if (scope != null) {
					...
					apObjectsApCachedRequests = ((DaoSession) CacheManager
							...
							.queryRawCreate(
									query,
									com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType.class
											.getSimpleName().toLowerCase(),
									scope).listLazy();
				} else {
				...
				try {
					...
					try {
						Query<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeType> query = null;
						if (!hasInvalidParam
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithIds(
			Set<Long> objectIds) {
		QueryBuilder<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeType> queryBuilder = ((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getRetailBankingPayeeTypeDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeTypeDao.Properties.Id
						.in(objectIds));
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> loadAllInCache() {
		...
		objects.addAll((List<T>) getCloneObjects(((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getRetailBankingPayeeTypeDao().queryBuilder().listLazy()));
		return objects;
	}
	 ...
	 */
	public static final com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType copyFromDao(
			com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeType orig) {
		final com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType newObject = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType();

		if (orig.getObjectId() != null)
			newObject.setObjectIdAsString(orig.getObjectId().toString());

		if (orig.getValue() != null)
			newObject.setValue(orig.getValue().toString());
	 ...
	 */
	public static final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeType copyToDao(
			com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType orig) {
		final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeType newObject = new com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeType();
	...
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType> getCloneObjects(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeType> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType> clonedObjects = null;
		try {
			clonedObjects = shallowCloneList(objects);
		} finally {
			if (clonedObjects == null) {
				clonedObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType>();
			}
		}
	...
	/**
	 * Perform a shallow clone of list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeType</tt>.
	 *
	 * @param objects list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeType</tt>.
	 * @return list of <tt>RetailBankingPayeeType</tt>.
	 */
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType> shallowCloneList(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeType> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType> newObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType>();
		try {
			for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeType object : objects) {
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType newObject = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayeeType();
	...
	private static boolean processParamsIntoStringBuffer(StringBuilder sb,
		...
		for (Map.Entry<String, String> entry : params.entrySet()) {
			...
			try {
				...
				Field field = com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeTypeDao.Properties.class
	...
	private Boolean isDaoSetup() {
		if (((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getRetailBankingPayeeTypeDao() == null) {
