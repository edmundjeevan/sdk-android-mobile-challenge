...
//
//  RetailBankingAccountBalanceHelper.java
//  
//
...
/**
 *
 * GreenDAO helper for <tt>RetailBankingAccountBalance</tt>.
 *
 */
class RetailBankingAccountBalanceHelper implements IGreenDAOHelper {
	private static Log log = LogFactory
			.getLog(RetailBankingAccountBalanceHelper.class);
	...
	public com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject createObject(
		...
		com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalance _object = RetailBankingAccountBalanceHelper
				.copyToDao((com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance) object);
	...
	/**
	 * <p>
	 * Gets the <tt>RetailBankingAccountBalance</tt> objects from the cache by object id on the provided object.
	 * </p>
	 * 
	...
	public List<? extends com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject> getObjectsByObjectId(
		...
		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getRetailBankingAccountBalanceDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalanceDao.Properties.ObjectId
	...
	public Long insertObject(
		...
		if (Config.getInstance().getCacheStrategy() == Config.CacheStrategy.OVERWRITE) {
			return ((DaoSession) CacheManager.getInstance().getDAOSession()
					...
					.getRetailBankingAccountBalanceDao()
					.insertOrReplace(
							(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalance) object);
		}

		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getRetailBankingAccountBalanceDao()
				.insert((com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalance) object);
	}
	...
	public void updateObject(com.anypresence.sdk.IAPObject object) {
		...
		try {
			if ((objects != null) && !objects.isEmpty()) {
				com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalance _object = (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalance) objects
						.get(0);
	...
	public void updateEachObject(
		...
		for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalance tobject : (List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalance>) existingObjects) {
			try {
				...
				((DaoSession) CacheManager.getInstance().getDAOSession()
						.getRaw()).getRetailBankingAccountBalanceDao().update(
						tobject);
				CacheManager
						.getInstance()
	...
	public void deleteAllInCacheWithScopePredicate(String scope) {
		((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getRetailBankingAccountBalanceDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalanceDao.Properties.Scope
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithAPCachedRequestPredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalance> cachedObjects = ((DaoSession) CacheManager
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithScopePredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequest> apCachedRequests = ((DaoSession) CacheManager
				...
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequestDao.Properties.Type
						.eq(com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance.class
			...
			if (apCachedRequests != null && !apCachedRequests.isEmpty()) {
				...
				if (scope != null) {
					...
					apObjectsApCachedRequests = ((DaoSession) CacheManager
							...
							.queryRawCreate(
									query,
									com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance.class
											.getSimpleName().toLowerCase(),
									scope).listLazy();
				} else {
				...
				try {
					...
					try {
						Query<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalance> query = null;
						if (!hasInvalidParam
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithIds(
			Set<Long> objectIds) {
		QueryBuilder<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalance> queryBuilder = ((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getRetailBankingAccountBalanceDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalanceDao.Properties.Id
						.in(objectIds));
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> loadAllInCache() {
		...
		objects.addAll((List<T>) getCloneObjects(((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getRetailBankingAccountBalanceDao().queryBuilder().listLazy()));
		return objects;
	}
	 ...
	 */
	public static final com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance copyFromDao(
			com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalance orig) {
		final com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance newObject = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance();
		...
		if (orig.getBalanceType() != null)
			newObject.setBalanceType(orig.getBalanceType().toString());

		if (orig.getValue() != null)
			newObject.setValue(new Integer(orig.getValue().toString()));
	 ...
	 */
	public static final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalance copyToDao(
			com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance orig) {
		final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalance newObject = new com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalance();
	...
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance> getCloneObjects(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalance> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance> clonedObjects = null;
		try {
			clonedObjects = shallowCloneList(objects);
		} finally {
			if (clonedObjects == null) {
				clonedObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance>();
			}
		}
	...
	/**
	 * Perform a shallow clone of list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalance</tt>.
	 *
	 * @param objects list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalance</tt>.
	 * @return list of <tt>RetailBankingAccountBalance</tt>.
	 */
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance> shallowCloneList(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalance> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance> newObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance>();
		try {
			for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalance object : objects) {
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance newObject = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingAccountBalance();
	...
	private static boolean processParamsIntoStringBuffer(StringBuilder sb,
		...
		for (Map.Entry<String, String> entry : params.entrySet()) {
			...
			try {
				...
				Field field = com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalanceDao.Properties.class
