...
//
//  CorporatePaymentsPaymentHelper.java
//  
//
...
/**
 *
 * GreenDAO helper for <tt>CorporatePaymentsPayment</tt>.
 *
 */
class CorporatePaymentsPaymentHelper implements IGreenDAOHelper {
	private static Log log = LogFactory
			.getLog(CorporatePaymentsPaymentHelper.class);
	...
	public com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject createObject(
		...
		com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPayment _object = CorporatePaymentsPaymentHelper
				.copyToDao((com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment) object);
	...
	/**
	 * <p>
	 * Gets the <tt>CorporatePaymentsPayment</tt> objects from the cache by object id on the provided object.
	 * </p>
	 * 
	...
	public List<? extends com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject> getObjectsByObjectId(
		...
		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getCorporatePaymentsPaymentDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPaymentDao.Properties.ObjectId
	...
	public Long insertObject(
		...
		if (Config.getInstance().getCacheStrategy() == Config.CacheStrategy.OVERWRITE) {
			return ((DaoSession) CacheManager.getInstance().getDAOSession()
					...
					.getCorporatePaymentsPaymentDao()
					.insertOrReplace(
							(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPayment) object);
		}

		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getCorporatePaymentsPaymentDao()
				.insert((com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPayment) object);
	}
	...
	public void updateObject(com.anypresence.sdk.IAPObject object) {
		...
		try {
			if ((objects != null) && !objects.isEmpty()) {
				com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPayment _object = (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPayment) objects
						.get(0);
	...
	public void updateEachObject(
		...
		for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPayment tobject : (List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPayment>) existingObjects) {
			try {
				...
				((DaoSession) CacheManager.getInstance().getDAOSession()
						.getRaw()).getCorporatePaymentsPaymentDao().update(
						tobject);
				CacheManager
						.getInstance()
	...
	public void deleteAllInCacheWithScopePredicate(String scope) {
		((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getCorporatePaymentsPaymentDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPaymentDao.Properties.Scope
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithAPCachedRequestPredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPayment> cachedObjects = ((DaoSession) CacheManager
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithScopePredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequest> apCachedRequests = ((DaoSession) CacheManager
				...
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequestDao.Properties.Type
						.eq(com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment.class
			...
			if (apCachedRequests != null && !apCachedRequests.isEmpty()) {
				...
				if (scope != null) {
					...
					apObjectsApCachedRequests = ((DaoSession) CacheManager
							...
							.queryRawCreate(
									query,
									com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment.class
											.getSimpleName().toLowerCase(),
									scope).listLazy();
				} else {
				...
				try {
					...
					try {
						Query<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPayment> query = null;
						if (!hasInvalidParam
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithIds(
			Set<Long> objectIds) {
		QueryBuilder<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPayment> queryBuilder = ((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getCorporatePaymentsPaymentDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPaymentDao.Properties.Id
						.in(objectIds));
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> loadAllInCache() {
		...
		objects.addAll((List<T>) getCloneObjects(((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getCorporatePaymentsPaymentDao().queryBuilder().listLazy()));
		return objects;
	}
	 ...
	 */
	public static final com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment copyFromDao(
			com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPayment orig) {
		final com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment newObject = new com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment();

		if (orig.getObjectId() != null)
			newObject.setObjectIdAsString(orig.getObjectId().toString());

		if (orig.getBeneficiaryId() != null)
			newObject.setBeneficiaryId(orig.getBeneficiaryId().toString());

		if (orig.getBranchName() != null)
			newObject.setBranchName(orig.getBranchName().toString());
		...
		if (orig.getCustomerReferenceNumber() != null)
			newObject.setCustomerReferenceNumber(orig
					.getCustomerReferenceNumber().toString());

		if (orig.getDebitAccountName() != null)
			newObject
					.setDebitAccountName(orig.getDebitAccountName().toString());

		if (orig.getDebitAccountNumber() != null)
			newObject.setDebitAccountNumber(orig.getDebitAccountNumber()
					.toString());
		...
		if (orig.getPaymentAmount() != null)
			newObject.setPaymentAmount(orig.getPaymentAmount().toString());

		if (orig.getPaymentCurrency() != null)
			newObject.setPaymentCurrency(orig.getPaymentCurrency().toString());
		...
		if (orig.getPaymentType() != null)
			newObject.setPaymentType(orig.getPaymentType().toString());

		if (orig.getStatus() != null)
			newObject.setStatus(orig.getStatus().toString());

		if (orig.getTransactionReferenceNumber() != null)
			newObject.setTransactionReferenceNumber(orig
					.getTransactionReferenceNumber().toString());
	 ...
	 */
	public static final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPayment copyToDao(
			com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment orig) {
		final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPayment newObject = new com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPayment();
	...
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment> getCloneObjects(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPayment> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment> clonedObjects = null;
		try {
			clonedObjects = shallowCloneList(objects);
		} finally {
			if (clonedObjects == null) {
				clonedObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment>();
			}
		}
	...
	/**
	 * Perform a shallow clone of list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPayment</tt>.
	 *
	 * @param objects list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPayment</tt>.
	 * @return list of <tt>CorporatePaymentsPayment</tt>.
	 */
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment> shallowCloneList(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPayment> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment> newObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment>();
		try {
			for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPayment object : objects) {
				com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment newObject = new com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsPayment();
	...
	private static boolean processParamsIntoStringBuffer(StringBuilder sb,
		...
		for (Map.Entry<String, String> entry : params.entrySet()) {
			...
			try {
				...
				Field field = com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsPaymentDao.Properties.class
