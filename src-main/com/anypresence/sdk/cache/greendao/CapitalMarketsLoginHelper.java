...
//
//  CapitalMarketsLoginHelper.java
//  
//
...
/**
 *
 * GreenDAO helper for <tt>CapitalMarketsLogin</tt>.
 *
 */
class CapitalMarketsLoginHelper implements IGreenDAOHelper {
	private static Log log = LogFactory.getLog(CapitalMarketsLoginHelper.class);
	...
	public com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject createObject(
		...
		com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLogin _object = CapitalMarketsLoginHelper
				.copyToDao((com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin) object);
	...
	/**
	 * <p>
	 * Gets the <tt>CapitalMarketsLogin</tt> objects from the cache by object id on the provided object.
	 * </p>
	 * 
	...
	public List<? extends com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject> getObjectsByObjectId(
		...
		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getCapitalMarketsLoginDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLoginDao.Properties.ObjectId
	...
	public Long insertObject(
		...
		if (Config.getInstance().getCacheStrategy() == Config.CacheStrategy.OVERWRITE) {
			return ((DaoSession) CacheManager.getInstance().getDAOSession()
					...
					.getCapitalMarketsLoginDao()
					.insertOrReplace(
							(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLogin) object);
		}

		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getCapitalMarketsLoginDao()
				.insert((com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLogin) object);
	}
	...
	public void updateObject(com.anypresence.sdk.IAPObject object) {
		...
		try {
			if ((objects != null) && !objects.isEmpty()) {
				com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLogin _object = (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLogin) objects
						.get(0);
	...
	public void updateEachObject(
		...
		for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLogin tobject : (List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLogin>) existingObjects) {
			try {
				...
				((DaoSession) CacheManager.getInstance().getDAOSession()
						.getRaw()).getCapitalMarketsLoginDao().update(tobject);
				CacheManager
						.getInstance()
	...
	public void deleteAllInCacheWithScopePredicate(String scope) {
		((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getCapitalMarketsLoginDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLoginDao.Properties.Scope
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithAPCachedRequestPredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLogin> cachedObjects = ((DaoSession) CacheManager
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithScopePredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequest> apCachedRequests = ((DaoSession) CacheManager
				...
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequestDao.Properties.Type
						.eq(com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin.class
		...
		try {
			if (apCachedRequests != null && !apCachedRequests.isEmpty()) {
				...
				try {
					...
					try {
						Query<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLogin> query = null;
						if (!hasInvalidParam
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithIds(
			Set<Long> objectIds) {
		QueryBuilder<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLogin> queryBuilder = ((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getCapitalMarketsLoginDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLoginDao.Properties.Id
						.in(objectIds));
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> loadAllInCache() {
		...
		objects.addAll((List<T>) getCloneObjects(((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getCapitalMarketsLoginDao().queryBuilder().listLazy()));
		return objects;
	}
	 ...
	 */
	public static final com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin copyFromDao(
			com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLogin orig) {
		final com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin newObject = new com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin();
	 ...
	 */
	public static final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLogin copyToDao(
			com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin orig) {
		final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLogin newObject = new com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLogin();
	...
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin> getCloneObjects(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLogin> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin> clonedObjects = null;
		try {
			clonedObjects = shallowCloneList(objects);
		} finally {
			if (clonedObjects == null) {
				clonedObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin>();
			}
		}
	...
	/**
	 * Perform a shallow clone of list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLogin</tt>.
	 *
	 * @param objects list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLogin</tt>.
	 * @return list of <tt>CapitalMarketsLogin</tt>.
	 */
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin> shallowCloneList(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLogin> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin> newObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin>();
		try {
			for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLogin object : objects) {
				com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin newObject = new com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsLogin();
	...
	private static boolean processParamsIntoStringBuffer(StringBuilder sb,
		...
		for (Map.Entry<String, String> entry : params.entrySet()) {
			...
			try {
				...
				Field field = com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsLoginDao.Properties.class
	...
	private Boolean isDaoSetup() {
		if (((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getCapitalMarketsLoginDao() == null) {
