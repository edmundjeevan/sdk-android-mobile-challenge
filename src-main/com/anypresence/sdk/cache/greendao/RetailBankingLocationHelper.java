...
//
//  RetailBankingLocationHelper.java
//  
//
...
/**
 *
 * GreenDAO helper for <tt>RetailBankingLocation</tt>.
 *
 */
class RetailBankingLocationHelper implements IGreenDAOHelper {
	private static Log log = LogFactory
			.getLog(RetailBankingLocationHelper.class);
	...
	public com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject createObject(
		...
		com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocation _object = RetailBankingLocationHelper
				.copyToDao((com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLocation) object);
	...
	/**
	 * <p>
	 * Gets the <tt>RetailBankingLocation</tt> objects from the cache by object id on the provided object.
	 * </p>
	 * 
	...
	public List<? extends com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject> getObjectsByObjectId(
		...
		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getRetailBankingLocationDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocationDao.Properties.ObjectId
	...
	public Long insertObject(
		...
		if (Config.getInstance().getCacheStrategy() == Config.CacheStrategy.OVERWRITE) {
			return ((DaoSession) CacheManager.getInstance().getDAOSession()
					...
					.getRetailBankingLocationDao()
					.insertOrReplace(
							(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocation) object);
		}

		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getRetailBankingLocationDao()
				.insert((com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocation) object);
	}
	...
	public void updateObject(com.anypresence.sdk.IAPObject object) {
		...
		try {
			if ((objects != null) && !objects.isEmpty()) {
				com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocation _object = (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocation) objects
						.get(0);
	...
	public void updateEachObject(
		...
		for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocation tobject : (List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocation>) existingObjects) {
			try {
				...
				((DaoSession) CacheManager.getInstance().getDAOSession()
						.getRaw()).getRetailBankingLocationDao()
						.update(tobject);
				CacheManager
						.getInstance()
	...
	public void deleteAllInCacheWithScopePredicate(String scope) {
		((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getRetailBankingLocationDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocationDao.Properties.Scope
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithAPCachedRequestPredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocation> cachedObjects = ((DaoSession) CacheManager
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithScopePredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequest> apCachedRequests = ((DaoSession) CacheManager
				...
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequestDao.Properties.Type
						.eq(com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLocation.class
		...
		try {
			if (apCachedRequests != null && !apCachedRequests.isEmpty()) {
				...
				try {
					...
					try {
						Query<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocation> query = null;
						if (!hasInvalidParam
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithIds(
			Set<Long> objectIds) {
		QueryBuilder<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocation> queryBuilder = ((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getRetailBankingLocationDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocationDao.Properties.Id
						.in(objectIds));
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> loadAllInCache() {
		...
		objects.addAll((List<T>) getCloneObjects(((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getRetailBankingLocationDao().queryBuilder().listLazy()));
		return objects;
	}
	 ...
	 */
	public static final com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLocation copyFromDao(
			com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocation orig) {
		final com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLocation newObject = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLocation();

		if (orig.getObjectId() != null)
			newObject.setObjectIdAsString(orig.getObjectId().toString());

		if (orig.getAddressLineOne() != null)
			newObject.setAddressLineOne(orig.getAddressLineOne().toString());

		if (orig.getAddressLineTwo() != null)
			newObject.setAddressLineTwo(orig.getAddressLineTwo().toString());
		...
		if (orig.getExternalLink() != null)
			newObject.setExternalLink(orig.getExternalLink().toString());

		if (orig.getLatitude() != null)
			newObject.setLatitude(orig.getLatitude().toString());

		if (orig.getLocationType() != null)
			newObject.setLocationType(orig.getLocationType().toString());

		if (orig.getLongitude() != null)
			newObject.setLongitude(orig.getLongitude().toString());
		...
		if (orig.getPostalCode() != null)
			newObject.setPostalCode(orig.getPostalCode().toString());
	 ...
	 */
	public static final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocation copyToDao(
			com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLocation orig) {
		final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocation newObject = new com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocation();
	...
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLocation> getCloneObjects(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocation> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLocation> clonedObjects = null;
		try {
			clonedObjects = shallowCloneList(objects);
		} finally {
			if (clonedObjects == null) {
				clonedObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLocation>();
			}
		}
	...
	/**
	 * Perform a shallow clone of list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocation</tt>.
	 *
	 * @param objects list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocation</tt>.
	 * @return list of <tt>RetailBankingLocation</tt>.
	 */
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLocation> shallowCloneList(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocation> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLocation> newObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLocation>();
		try {
			for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocation object : objects) {
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLocation newObject = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingLocation();
	...
	private static boolean processParamsIntoStringBuffer(StringBuilder sb,
		...
		for (Map.Entry<String, String> entry : params.entrySet()) {
			...
			try {
				...
				Field field = com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingLocationDao.Properties.class
	...
	private Boolean isDaoSetup() {
		if (((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getRetailBankingLocationDao() == null) {
