...
//
//  CapitalMarketsActivityHelper.java
//  
//
...
/**
 *
 * GreenDAO helper for <tt>CapitalMarketsActivity</tt>.
 *
 */
class CapitalMarketsActivityHelper implements IGreenDAOHelper {
	private static Log log = LogFactory
			.getLog(CapitalMarketsActivityHelper.class);
	...
	public com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject createObject(
		...
		com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivity _object = CapitalMarketsActivityHelper
				.copyToDao((com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity) object);
	...
	/**
	 * <p>
	 * Gets the <tt>CapitalMarketsActivity</tt> objects from the cache by object id on the provided object.
	 * </p>
	 * 
	...
	public List<? extends com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject> getObjectsByObjectId(
		...
		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getCapitalMarketsActivityDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivityDao.Properties.ObjectId
	...
	public Long insertObject(
		...
		if (Config.getInstance().getCacheStrategy() == Config.CacheStrategy.OVERWRITE) {
			return ((DaoSession) CacheManager.getInstance().getDAOSession()
					...
					.getCapitalMarketsActivityDao()
					.insertOrReplace(
							(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivity) object);
		}

		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getCapitalMarketsActivityDao()
				.insert((com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivity) object);
	}
	...
	public void updateObject(com.anypresence.sdk.IAPObject object) {
		...
		try {
			if ((objects != null) && !objects.isEmpty()) {
				com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivity _object = (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivity) objects
						.get(0);
	...
	public void updateEachObject(
		...
		for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivity tobject : (List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivity>) existingObjects) {
			try {
				...
				((DaoSession) CacheManager.getInstance().getDAOSession()
						.getRaw()).getCapitalMarketsActivityDao().update(
						tobject);
				CacheManager
						.getInstance()
	...
	public void deleteAllInCacheWithScopePredicate(String scope) {
		((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getCapitalMarketsActivityDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivityDao.Properties.Scope
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithAPCachedRequestPredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivity> cachedObjects = ((DaoSession) CacheManager
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithScopePredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequest> apCachedRequests = ((DaoSession) CacheManager
				...
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequestDao.Properties.Type
						.eq(com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity.class
		...
		try {
			if (apCachedRequests != null && !apCachedRequests.isEmpty()) {
				...
				try {
					...
					try {
						Query<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivity> query = null;
						if (!hasInvalidParam
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithIds(
			Set<Long> objectIds) {
		QueryBuilder<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivity> queryBuilder = ((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getCapitalMarketsActivityDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivityDao.Properties.Id
						.in(objectIds));
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> loadAllInCache() {
		...
		objects.addAll((List<T>) getCloneObjects(((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getCapitalMarketsActivityDao().queryBuilder().listLazy()));
		return objects;
	}
	 ...
	 */
	public static final com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity copyFromDao(
			com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivity orig) {
		final com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity newObject = new com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity();

		if (orig.getObjectId() != null)
			newObject.setObjectIdAsString(orig.getObjectId().toString());

		if (orig.getActivityType() != null)
			newObject.setActivityType(orig.getActivityType().toString());

		if (orig.getCitiAttendees() != null)
			newObject
					.setCitiAttendees(GreenDAOUtility
							.deserializeToArrayList(orig.getCitiAttendees()
									.toString()));

		if (orig.getClientContacts() != null)
			newObject
					.setClientContacts(GreenDAOUtility
							.deserializeToArrayList(orig.getClientContacts()
									.toString()));

		if (orig.getClientId() != null)
			newObject.setClientId(orig.getClientId().toString());

		if (orig.getClientName() != null)
			newObject.setClientName(orig.getClientName().toString());

		if (orig.getDate() != null)
			newObject.setDate(orig.getDate().toString());
	 ...
	 */
	public static final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivity copyToDao(
			com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity orig) {
		final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivity newObject = new com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivity();
		...
		if (orig.getCitiAttendees() != null)
			newObject.setCitiAttendees(GreenDAOUtility.serialize(orig
					.getCitiAttendees()));

		if (orig.getClientContacts() != null)
			newObject.setClientContacts(GreenDAOUtility.serialize(orig
					.getClientContacts()));
	...
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity> getCloneObjects(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivity> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity> clonedObjects = null;
		try {
			clonedObjects = shallowCloneList(objects);
		} finally {
			if (clonedObjects == null) {
				clonedObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity>();
			}
		}
	...
	/**
	 * Perform a shallow clone of list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivity</tt>.
	 *
	 * @param objects list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivity</tt>.
	 * @return list of <tt>CapitalMarketsActivity</tt>.
	 */
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity> shallowCloneList(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivity> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity> newObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity>();
		try {
			for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivity object : objects) {
				com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity newObject = new com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsActivity();
				newObject = copyFromDao(object);

				newObject.setCitiAttendees((ArrayList<Object>) Utilities
						.transformJsonToObject(GreenDAOUtility
								.base64decode(object.getCitiAttendees()),
								ArrayList.class));

				newObject.setClientContacts((ArrayList<Object>) Utilities
						.transformJsonToObject(GreenDAOUtility
								.base64decode(object.getClientContacts()),
								ArrayList.class));
	...
	private static boolean processParamsIntoStringBuffer(StringBuilder sb,
		...
		for (Map.Entry<String, String> entry : params.entrySet()) {
			...
			try {
				...
				Field field = com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivityDao.Properties.class
	...
	private Boolean isDaoSetup() {
		if (((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getCapitalMarketsActivityDao() == null) {
