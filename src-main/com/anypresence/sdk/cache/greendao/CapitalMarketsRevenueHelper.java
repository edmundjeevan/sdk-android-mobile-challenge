...
//
//  CapitalMarketsRevenueHelper.java
//  
//
...
/**
 *
 * GreenDAO helper for <tt>CapitalMarketsRevenue</tt>.
 *
 */
class CapitalMarketsRevenueHelper implements IGreenDAOHelper {
	private static Log log = LogFactory
			.getLog(CapitalMarketsRevenueHelper.class);
	...
	public com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject createObject(
		...
		com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenue _object = CapitalMarketsRevenueHelper
				.copyToDao((com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue) object);
	...
	/**
	 * <p>
	 * Gets the <tt>CapitalMarketsRevenue</tt> objects from the cache by object id on the provided object.
	 * </p>
	 * 
	...
	public List<? extends com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject> getObjectsByObjectId(
		...
		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getCapitalMarketsRevenueDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenueDao.Properties.ObjectId
	...
	public Long insertObject(
		...
		if (Config.getInstance().getCacheStrategy() == Config.CacheStrategy.OVERWRITE) {
			return ((DaoSession) CacheManager.getInstance().getDAOSession()
					...
					.getCapitalMarketsRevenueDao()
					.insertOrReplace(
							(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenue) object);
		}

		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getCapitalMarketsRevenueDao()
				.insert((com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenue) object);
	}
	...
	public void updateObject(com.anypresence.sdk.IAPObject object) {
		...
		try {
			if ((objects != null) && !objects.isEmpty()) {
				com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenue _object = (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenue) objects
						.get(0);
	...
	public void updateEachObject(
		...
		for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenue tobject : (List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenue>) existingObjects) {
			try {
				...
				((DaoSession) CacheManager.getInstance().getDAOSession()
						.getRaw()).getCapitalMarketsRevenueDao()
						.update(tobject);
				CacheManager
						.getInstance()
	...
	public void deleteAllInCacheWithScopePredicate(String scope) {
		((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getCapitalMarketsRevenueDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenueDao.Properties.Scope
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithAPCachedRequestPredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenue> cachedObjects = ((DaoSession) CacheManager
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithScopePredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequest> apCachedRequests = ((DaoSession) CacheManager
				...
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequestDao.Properties.Type
						.eq(com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue.class
		...
		try {
			if (apCachedRequests != null && !apCachedRequests.isEmpty()) {
				...
				try {
					...
					try {
						Query<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenue> query = null;
						if (!hasInvalidParam
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithIds(
			Set<Long> objectIds) {
		QueryBuilder<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenue> queryBuilder = ((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getCapitalMarketsRevenueDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenueDao.Properties.Id
						.in(objectIds));
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> loadAllInCache() {
		...
		objects.addAll((List<T>) getCloneObjects(((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getCapitalMarketsRevenueDao().queryBuilder().listLazy()));
		return objects;
	}
	 ...
	 */
	public static final com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue copyFromDao(
			com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenue orig) {
		final com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue newObject = new com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue();
		...
		if (orig.getClientTier() != null)
			newObject.setClientTier(orig.getClientTier().toString());

		if (orig.getGrossComm() != null)
			newObject.setGrossComm(new Float(orig.getGrossComm().toString()));

		if (orig.getMonth() != null)
			newObject.setMonth(orig.getMonth().toString());

		if (orig.getProductId() != null)
			newObject.setProductId(orig.getProductId().toString());

		if (orig.getProductName() != null)
			newObject.setProductName(orig.getProductName().toString());

		if (orig.getProfitLoss() != null)
			newObject.setProfitLoss(new Float(orig.getProfitLoss().toString()));
	 ...
	 */
	public static final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenue copyToDao(
			com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue orig) {
		final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenue newObject = new com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenue();
	...
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue> getCloneObjects(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenue> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue> clonedObjects = null;
		try {
			clonedObjects = shallowCloneList(objects);
		} finally {
			if (clonedObjects == null) {
				clonedObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue>();
			}
		}
	...
	/**
	 * Perform a shallow clone of list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenue</tt>.
	 *
	 * @param objects list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenue</tt>.
	 * @return list of <tt>CapitalMarketsRevenue</tt>.
	 */
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue> shallowCloneList(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenue> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue> newObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue>();
		try {
			for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenue object : objects) {
				com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue newObject = new com.anypresence.sdk.citi_mobile_challenge.models.CapitalMarketsRevenue();
	...
	private static boolean processParamsIntoStringBuffer(StringBuilder sb,
		...
		for (Map.Entry<String, String> entry : params.entrySet()) {
			...
			try {
				...
				Field field = com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsRevenueDao.Properties.class
	...
	private Boolean isDaoSetup() {
		if (((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getCapitalMarketsRevenueDao() == null) {
