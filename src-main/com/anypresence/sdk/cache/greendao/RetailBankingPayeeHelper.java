...
/**
 *
 * GreenDAO helper for <tt>RetailBankingPayee</tt>.
 *
 */
class RetailBankingPayeeHelper implements IGreenDAOHelper {
	private static Log log = LogFactory.getLog(RetailBankingPayeeHelper.class);
	...
	public com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject createObject(
		...
		com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayee _object = RetailBankingPayeeHelper
				.copyToDao((com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayee) object);
	...
	/**
	 * <p>
	 * Gets the <tt>RetailBankingPayee</tt> objects from the cache by object id on the provided object.
	 * </p>
	 * 
	...
	public List<? extends com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject> getObjectsByObjectId(
		...
		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getRetailBankingPayeeDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeDao.Properties.ObjectId
	...
	public Long insertObject(
		...
		if (Config.getInstance().getCacheStrategy() == Config.CacheStrategy.OVERWRITE) {
			return ((DaoSession) CacheManager.getInstance().getDAOSession()
					...
					.getRetailBankingPayeeDao()
					.insertOrReplace(
							(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayee) object);
		}

		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getRetailBankingPayeeDao()
				.insert((com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayee) object);
	}
	...
	public void updateObject(com.anypresence.sdk.IAPObject object) {
		...
		try {
			if ((objects != null) && !objects.isEmpty()) {
				com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayee _object = (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayee) objects
						.get(0);
	...
	public void updateEachObject(
		...
		for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayee tobject : (List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayee>) existingObjects) {
			try {
				...
				((DaoSession) CacheManager.getInstance().getDAOSession()
						.getRaw()).getRetailBankingPayeeDao().update(tobject);
				CacheManager
						.getInstance()
	...
	public void deleteAllInCacheWithScopePredicate(String scope) {
		((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getRetailBankingPayeeDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeDao.Properties.Scope
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithAPCachedRequestPredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayee> cachedObjects = ((DaoSession) CacheManager
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithScopePredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequest> apCachedRequests = ((DaoSession) CacheManager
				...
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequestDao.Properties.Type
						.eq(com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayee.class
		...
		try {
			if (apCachedRequests != null && !apCachedRequests.isEmpty()) {
				...
				try {
					...
					try {
						Query<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayee> query = null;
						if (!hasInvalidParam
							...
							query = ((DaoSession) CacheManager.getInstance()
									...
									.getRetailBankingPayeeDao().queryRawCreate(
											rawQuery,
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithIds(
			Set<Long> objectIds) {
		QueryBuilder<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayee> queryBuilder = ((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getRetailBankingPayeeDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeDao.Properties.Id
						.in(objectIds));
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> loadAllInCache() {
		...
		objects.addAll((List<T>) getCloneObjects(((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getRetailBankingPayeeDao().queryBuilder().listLazy()));
		return objects;
	}
	 ...
	 */
	public static final com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayee copyFromDao(
			com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayee orig) {
		final com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayee newObject = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayee();

		if (orig.getObjectId() != null)
			newObject.setObjectIdAsString(orig.getObjectId().toString());

		if (orig.getAddPayeeDetails() != null)
			newObject.setAddPayeeDetails(GreenDAOUtility
					.deserializeToArrayList(orig.getAddPayeeDetails()
							.toString()));

		if (orig.getBankNameExt() != null)
			newObject.setBankNameExt(orig.getBankNameExt().toString());

		if (orig.getDetailPrefix() != null)
			newObject.setDetailPrefix(orig.getDetailPrefix().toString());
		...
		if (orig.getPayeeAccount() != null)
			newObject.setPayeeAccount(orig.getPayeeAccount().toString());

		if (orig.getPayeeDescription() != null)
			newObject
					.setPayeeDescription(orig.getPayeeDescription().toString());
		...
		if (orig.getPayeeListIdType() != null)
			newObject.setPayeeListIdType(new Integer(orig.getPayeeListIdType()
					.toString()));

		if (orig.getPayeeType() != null)
			newObject.setPayeeType(new Integer(orig.getPayeeType().toString()));

		if (orig.getPaymentMethod() != null)
			newObject.setPaymentMethod(orig.getPaymentMethod().toString());
	 ...
	 */
	public static final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayee copyToDao(
			com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayee orig) {
		final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayee newObject = new com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayee();

		if (orig.getId() != null)
			newObject.setObjectId(orig.getId().toString());

		if (orig.getAddPayeeDetails() != null)
			newObject.setAddPayeeDetails(GreenDAOUtility.serialize(orig
					.getAddPayeeDetails()));
	...
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayee> getCloneObjects(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayee> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayee> clonedObjects = null;
		try {
			clonedObjects = shallowCloneList(objects);
		} finally {
			if (clonedObjects == null) {
				clonedObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayee>();
			}
		}
	...
	/**
	 * Perform a shallow clone of list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayee</tt>.
	 *
	 * @param objects list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayee</tt>.
	 * @return list of <tt>RetailBankingPayee</tt>.
	 */
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayee> shallowCloneList(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayee> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayee> newObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayee>();
		try {
			for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayee object : objects) {
				com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayee newObject = new com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingPayee();
				newObject = copyFromDao(object);

				newObject.setAddPayeeDetails((ArrayList<Object>) Utilities
						.transformJsonToObject(GreenDAOUtility
								.base64decode(object.getAddPayeeDetails()),
								ArrayList.class));
	...
	private static boolean processParamsIntoStringBuffer(StringBuilder sb,
		...
		for (Map.Entry<String, String> entry : params.entrySet()) {
			...
			try {
				...
				Field field = com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingPayeeDao.Properties.class
