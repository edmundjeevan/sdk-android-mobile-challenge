...
//
//  CorporatePaymentsCrossBorderFxBookingHelper.java
//  
//
...
/**
 *
 * GreenDAO helper for <tt>CorporatePaymentsCrossBorderFxBooking</tt>.
 *
 */
class CorporatePaymentsCrossBorderFxBookingHelper implements IGreenDAOHelper {
	private static Log log = LogFactory
			.getLog(CorporatePaymentsCrossBorderFxBookingHelper.class);
	...
	public com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject createObject(
		...
		com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBooking _object = CorporatePaymentsCrossBorderFxBookingHelper
				.copyToDao((com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking) object);
	...
	/**
	 * <p>
	 * Gets the <tt>CorporatePaymentsCrossBorderFxBooking</tt> objects from the cache by object id on the provided object.
	 * </p>
	 * 
	...
	public List<? extends com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject> getObjectsByObjectId(
		...
		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getCorporatePaymentsCrossBorderFxBookingDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBookingDao.Properties.ObjectId
	...
	public Long insertObject(
		...
		if (Config.getInstance().getCacheStrategy() == Config.CacheStrategy.OVERWRITE) {
			return ((DaoSession) CacheManager.getInstance().getDAOSession()
					...
					.getCorporatePaymentsCrossBorderFxBookingDao()
					.insertOrReplace(
							(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBooking) object);
		}

		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getCorporatePaymentsCrossBorderFxBookingDao()
				.insert((com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBooking) object);
	}
	...
	public void updateObject(com.anypresence.sdk.IAPObject object) {
		...
		try {
			if ((objects != null) && !objects.isEmpty()) {
				com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBooking _object = (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBooking) objects
						.get(0);
	...
	public void updateEachObject(
		...
		for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBooking tobject : (List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBooking>) existingObjects) {
			try {
				...
				((DaoSession) CacheManager.getInstance().getDAOSession()
						.getRaw())
						.getCorporatePaymentsCrossBorderFxBookingDao().update(
								tobject);
				CacheManager
						.getInstance()
	...
	public void deleteAllInCacheWithScopePredicate(String scope) {
		((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getCorporatePaymentsCrossBorderFxBookingDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBookingDao.Properties.Scope
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithAPCachedRequestPredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBooking> cachedObjects = ((DaoSession) CacheManager
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithScopePredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequest> apCachedRequests = ((DaoSession) CacheManager
				...
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequestDao.Properties.Type
						.eq(com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking.class
		...
		try {
			if (apCachedRequests != null && !apCachedRequests.isEmpty()) {
				...
				try {
					...
					try {
						Query<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBooking> query = null;
						if (!hasInvalidParam
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithIds(
			Set<Long> objectIds) {
		QueryBuilder<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBooking> queryBuilder = ((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getCorporatePaymentsCrossBorderFxBookingDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBookingDao.Properties.Id
						.in(objectIds));
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> loadAllInCache() {
		...
		objects.addAll((List<T>) getCloneObjects(((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getCorporatePaymentsCrossBorderFxBookingDao().queryBuilder()
				.listLazy()));
		return objects;
	}
	 ...
	 */
	public static final com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking copyFromDao(
			com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBooking orig) {
		final com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking newObject = new com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking();

		if (orig.getAcceptedOn() != null)
			newObject.setAcceptedOnAsString(orig.getAcceptedOn().toString());

		if (orig.getAcceptedBy() != null)
			newObject.setAcceptedBy(orig.getAcceptedBy().toString());
	 ...
	 */
	public static final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBooking copyToDao(
			com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking orig) {
		final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBooking newObject = new com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBooking();

		if (orig.getAcceptedOn() != null)
			newObject.setObjectId(orig.getAcceptedOn().toString());
	...
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking> getCloneObjects(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBooking> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking> clonedObjects = null;
		try {
			clonedObjects = shallowCloneList(objects);
		} finally {
			if (clonedObjects == null) {
				clonedObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking>();
			}
		}
	...
	/**
	 * Perform a shallow clone of list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBooking</tt>.
	 *
	 * @param objects list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBooking</tt>.
	 * @return list of <tt>CorporatePaymentsCrossBorderFxBooking</tt>.
	 */
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking> shallowCloneList(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBooking> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking> newObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking>();
		try {
			for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBooking object : objects) {
				com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking newObject = new com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsCrossBorderFxBooking();
	...
	private static boolean processParamsIntoStringBuffer(StringBuilder sb,
		...
		for (Map.Entry<String, String> entry : params.entrySet()) {
			...
			try {
				...
				Field field = com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsCrossBorderFxBookingDao.Properties.class
	...
	private Boolean isDaoSetup() {
		if (((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getCorporatePaymentsCrossBorderFxBookingDao() == null) {
