...
//
//  CorporatePaymentsAccountHelper.java
//  
//
...
/**
 *
 * GreenDAO helper for <tt>CorporatePaymentsAccount</tt>.
 *
 */
class CorporatePaymentsAccountHelper implements IGreenDAOHelper {
	private static Log log = LogFactory
			.getLog(CorporatePaymentsAccountHelper.class);
	...
	public com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject createObject(
		...
		com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccount _object = CorporatePaymentsAccountHelper
				.copyToDao((com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount) object);
	...
	/**
	 * <p>
	 * Gets the <tt>CorporatePaymentsAccount</tt> objects from the cache by object id on the provided object.
	 * </p>
	 * 
	...
	public List<? extends com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APObject> getObjectsByObjectId(
		...
		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getCorporatePaymentsAccountDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccountDao.Properties.ObjectId
	...
	public Long insertObject(
		...
		if (Config.getInstance().getCacheStrategy() == Config.CacheStrategy.OVERWRITE) {
			return ((DaoSession) CacheManager.getInstance().getDAOSession()
					...
					.getCorporatePaymentsAccountDao()
					.insertOrReplace(
							(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccount) object);
		}

		return ((DaoSession) CacheManager.getInstance().getDAOSession()
				.getRaw())
				.getCorporatePaymentsAccountDao()
				.insert((com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccount) object);
	}
	...
	public void updateObject(com.anypresence.sdk.IAPObject object) {
		...
		try {
			if ((objects != null) && !objects.isEmpty()) {
				com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccount _object = (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccount) objects
						.get(0);
	...
	public void updateEachObject(
		...
		for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccount tobject : (List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccount>) existingObjects) {
			try {
				...
				((DaoSession) CacheManager.getInstance().getDAOSession()
						.getRaw()).getCorporatePaymentsAccountDao().update(
						tobject);
				CacheManager
						.getInstance()
	...
	public void deleteAllInCacheWithScopePredicate(String scope) {
		((DaoSession) CacheManager.getInstance().getDAOSession().getRaw())
				.getCorporatePaymentsAccountDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccountDao.Properties.Scope
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithAPCachedRequestPredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccount> cachedObjects = ((DaoSession) CacheManager
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithScopePredicate(
		...
		List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequest> apCachedRequests = ((DaoSession) CacheManager
				...
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequestDao.Properties.Type
						.eq(com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount.class
		...
		try {
			if (apCachedRequests != null && !apCachedRequests.isEmpty()) {
				...
				try {
					...
					try {
						Query<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccount> query = null;
						if (!hasInvalidParam
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> fetchInCacheWithIds(
			Set<Long> objectIds) {
		QueryBuilder<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccount> queryBuilder = ((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getCorporatePaymentsAccountDao()
				.queryBuilder()
				.where(com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccountDao.Properties.Id
						.in(objectIds));
	...
	public <T extends com.anypresence.sdk.IAPObject> List<T> loadAllInCache() {
		...
		objects.addAll((List<T>) getCloneObjects(((DaoSession) CacheManager
				.getInstance().getDAOSession().getRaw())
				.getCorporatePaymentsAccountDao().queryBuilder().listLazy()));
		return objects;
	}
	 ...
	 */
	public static final com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount copyFromDao(
			com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccount orig) {
		final com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount newObject = new com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount();

		if (orig.getObjectId() != null)
			newObject.setObjectIdAsString(orig.getObjectId().toString());

		if (orig.getAccountName() != null)
			newObject.setAccountName(orig.getAccountName().toString());

		if (orig.getBaseCurrencyBalances() != null)
			newObject.setBaseCurrencyBalances(GreenDAOUtility
					.deserializeToHashMap(orig.getBaseCurrencyBalances()
							.toString()));
		...
		if (orig.getCountryIsoCode() != null)
			newObject.setCountryIsoCode(orig.getCountryIsoCode().toString());

		if (orig.getLocalCurrencyIsoCode() != null)
			newObject.setLocalCurrencyIsoCode(orig.getLocalCurrencyIsoCode()
					.toString());
	 ...
	 */
	public static final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccount copyToDao(
			com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount orig) {
		final com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccount newObject = new com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccount();
		...
		if (orig.getBaseCurrencyBalances() != null)
			newObject.setBaseCurrencyBalances(GreenDAOUtility.serialize(orig
					.getBaseCurrencyBalances()));
	...
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount> getCloneObjects(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccount> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount> clonedObjects = null;
		try {
			clonedObjects = shallowCloneList(objects);
		} finally {
			if (clonedObjects == null) {
				clonedObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount>();
			}
		}
	...
	/**
	 * Perform a shallow clone of list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccount</tt>.
	 *
	 * @param objects list of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccount</tt>.
	 * @return list of <tt>CorporatePaymentsAccount</tt>.
	 */
	private static List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount> shallowCloneList(
			List<com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccount> objects) {
		List<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount> newObjects = new ArrayList<com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount>();
		try {
			for (com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccount object : objects) {
				com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount newObject = new com.anypresence.sdk.citi_mobile_challenge.models.CorporatePaymentsAccount();
				newObject = copyFromDao(object);

				newObject
						.setBaseCurrencyBalances((HashMap<String, Object>) Utilities
	...
	private static boolean processParamsIntoStringBuffer(StringBuilder sb,
		...
		for (Map.Entry<String, String> entry : params.entrySet()) {
			...
			try {
				...
				Field field = com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CorporatePaymentsAccountDao.Properties.class
