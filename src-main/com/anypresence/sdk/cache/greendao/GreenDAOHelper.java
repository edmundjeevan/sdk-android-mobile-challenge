...
final class GreenDAOHelper {
	public static IGreenDAOHelper getInstance(Class<?> clazz) {
		...
		else if (clazz == com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsCatalog.class) {

			return new RetailBankingRewardsCatalogHelper();
		}

		else if (clazz == com.anypresence.sdk.citi_mobile_challenge.models.RetailBankingRewardsRedemption.class) {

			return new RetailBankingRewardsRedemptionHelper();
		}
