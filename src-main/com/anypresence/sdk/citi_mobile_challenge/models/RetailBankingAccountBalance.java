...
//
//  RetailBankingAccountBalance.java
//  
//
 ...
 */
public final class RetailBankingAccountBalance
		extends
			com.anypresence.sdk.APObject {
	private static final long serialVersionUID = 1L;

	private static final Log log = LogFactory
			.getLog(RetailBankingAccountBalance.class);

	private static final String TAG = "RetailBankingAccountBalance";

	/**
	 *  Scope names for RetailBankingAccountBalance.
	 */
	 ...
	 */
	public static final RetailBankingAccountBalance copy(
			RetailBankingAccountBalance orig) {
		final RetailBankingAccountBalance newObject = new RetailBankingAccountBalance();
		...
		if (orig.getBalanceType() != null)
			newObject.setBalanceType(new String(orig.getBalanceType()));

		if (orig.getValue() != null)
			newObject.setValue(new Integer(orig.getValue()));
	...
	/**
	 * Fetches a <tt>RetailBankingAccountBalance</tt> with the provided <tt>objectId</tt>.
	 *
	 * @param objectId the id of the object
	 * @return an instance of <tt>RetailBankingAccountBalance</tt>
	 * @throws RemoteRequestException If there are other issues with the request.
	 */
	public static RetailBankingAccountBalance fetch(String objectId)
			throws RemoteRequestException {
		RemoteRequest.RemoteRequestBuilder remoteRequestBuilder = RemoteRailsConfig
				.getRouterAdapterByClassOrUseDefaultAdapter(
						RetailBankingAccountBalance.class)
				.createRemoteRequestBuilder(RequestMethod.GET,
						RetailBankingAccountBalance.class);

		RetailBankingAccountBalance object = new RetailBankingAccountBalance();
	...
	/**
	 * Fetches a <tt>RetailBankingAccountBalance</tt> with the provided <tt>objectId</tt> in the background.
	 *
	 * <p>
	 ...
	 * <pre>
	 * {@code
	 * RetailBankingAccountBalance.fetchInBackground("123", new APCallback<RetailBankingAccountBalance>() {
	 *     
	 *     public void finished(RetailBankingAccountBalance object, Throwable ex) {
	 *         if (ex == null) {
	 ...
	 * @return the cached <tt>RetailBankingAccountBalance</tt> if it exists, otherwise, null.
	
	 */
	public static RetailBankingAccountBalance

	fetchInBackground(String objectId,
			IAPFutureCallback<RetailBankingAccountBalance> futureCallback) {

		return com.anypresence.sdk.APObject.fetchInBackground(objectId,
				RetailBankingAccountBalance.class, futureCallback);

	}

	/**
	 * Queries for <tt>RetailBankingAccountBalance</tt> with the provided <tt>scope</tt>.
	 *
	 ...
	 * @throws RemoteRequestException If there are other issues with the request.
	 */
	public static List<RetailBankingAccountBalance> query(String scope)
			throws RemoteRequestException {
		return query(scope, null, null, null);
	}

	/**
	 * Queries for <tt>RetailBankingAccountBalance</tt> with the provided <tt>scope</tt> and other params.
	 *
	 * Note: the scopes were defined from the Designer.
	 *
	 * @param scope the scope to perform the query.
	 ...
	 * @throws RemoteRequestException If there are other issues with the request.
	 */
	public static List<RetailBankingAccountBalance> queryInBackground(
			final String scope, Map<String, String> params,
			IAPFutureCallback<List<RetailBankingAccountBalance>> futureCallback) {
	...
	/**
	 * Queries for <tt>RetailBankingAccountBalance</tt> with the provided <tt>scope</tt> in the background.
	 *
	 * Note: the scopes were defined from the Designer.
	 *
	 * <p>
	 ...
	 * <pre>
	 * {@code
	 * RetailBankingAccountBalance.queryInBackground("all", new APCallback<List<RetailBankingAccountBalance>>() {
	 *     
	 *     public void finished(List<RetailBankingAccountBalance> objects, Throwable ex) {
	 *         if (ex == null) {
	 ...
	 * @param scope the scope to perform the query.
	 * @param futureCallback the callback that handles the result of the request.
	 * @return list of cached <tt>RetailBankingAccountBalance</tt> objects.
	 */
	public static List<RetailBankingAccountBalance> queryInBackground(
			String scope,
			IAPFutureCallback<List<RetailBankingAccountBalance>> futureCallback) {
	 ...
	 * <pre>
	 * {@code
	 * RetailBankingAccountBalance.queryInBackground("all", 0, 25, new APCallback<List<RetailBankingAccountBalance>>() {
	 *     
	 *     public void finished(List<RetailBankingAccountBalance> objects, Throwable ex) {
	 *         if (ex == null) {
	 *             Log.i(TAG, "Objects fetched!");
	 ...
	 * RetailBankingAccountBalance.queryInBackground("all", params, 0, 25, new APCallback<List<RetailBankingAccountBalance>>() {
	 *     
	 *     public void finished(List<RetailBankingAccountBalance> objects, Throwable ex) {
	 *         if (ex == null) {
	 *             Log.i(TAG, "Objects fetched!");
	 ...
	 * {@code
	 * Map<String,String> params = new HashMap<String,String>();
	 * RetailBankingAccountBalance.aggregateQueryInBackground("count", params, new APCallback<String>() {
	 *     
	...
	/**
	 * Deletes all data in cache for <tt>RetailBankingAccountBalance</tt>.
	 */
	...
	/**
	 * Loads all <tt>RetailBankingAccountBalance</tt> objects in local cache.
	 *
	 * @return list of <tt>RetailBankingAccountBalance</tt>
	 */
	public static List<RetailBankingAccountBalance> loadAllInCache() {
		return com.anypresence.sdk.APSDKSetup.getCacheManager().loadAllInCache(
				RetailBankingAccountBalance.class);
	}

	/**
	 * Loads <tt>RetailBankingAccountBalance</tt> objects in local cache.
	 *
	 * @param offset the offset
	 * @param limit the limit
	 * @return list of <tt>RetailBankingAccountBalance</tt>
	 */
	public static List<RetailBankingAccountBalance> loadInCache(Integer offset,
			Integer limit) {
		return null;
	}
	...
	public void updateInCache() {
		com.anypresence.sdk.APSDKSetup.getCacheManager().updateInCache(
				RetailBankingAccountBalance.class, this);
	}
	...
	public void saveInCache(String scope) {
		com.anypresence.sdk.APSDKSetup.getCacheManager().saveInCache(
				RetailBankingAccountBalance.class, this, scope);
	}
	...
	public void saveInCacheWithRequest(IAPCachedRequest request) {
		com.anypresence.sdk.APSDKSetup.getCacheManager()
				.saveInCacheWithRequest(RetailBankingAccountBalance.class,
						this, request);
	}

	/**
	 * Deletes all <tt>RetailBankingAccountBalance</tt> objects in cache that has
	...
	/**
	 * Fetches <tt>RetailBankingAccountBalance</tt> from cache with provided remote object id.
	 * 
	 * @param objectId the remote object id.
	 * @return a list of <tt>RetailBankingAccountBalance</tt>;
	 */
	public static List<RetailBankingAccountBalance> fetchInCacheWithObjectIdPredicate(
			String objectId) {
		return com.anypresence.sdk.APSDKSetup.getCacheManager()
				.fetchInCacheWithObjectIdPredicate(
						RetailBankingAccountBalance.class, objectId);
	}

	/**
	 * Fetches <tt>RetailBankingAccountBalance</tt> from cache by searching for requests matching 
	 ...
	 * Map<String,String> params = new HashMap<String,String>();
	 * params.put("name", "test");
	 * RetailBankingAccountBalance.queryInBackground("all", params, new APCallback<List<RetailBankingAccountBalance>>() {
	 *     
	 *     public void finished(List<RetailBankingAccountBalance> objects, Throwable ex) {
	 *         if (ex == null) {
	 *             Log.i(TAG, "Objects fetched!");
	 ...
	 * RetailBankingAccountBalance.fetchInCacheWithParameterPredicate("all", params);
	 * }
	 *
	 * </pre>
	 * 
	 ...
	 * @return a list of <tt>RetailBankingAccountBalance</tt>;
	 */
	public static List<RetailBankingAccountBalance> fetchInCacheWithParameterPredicate(
			String scope, Map<String, String> params) {
		return com.anypresence.sdk.APSDKSetup.getCacheManager()
				.fetchInCacheWithParameterPredicate(
						RetailBankingAccountBalance.class, scope, params);
	}

	/**
	 * Fetches <tt>RetailBankingAccountBalance</tt> from cache with provided scope.
	 * 
	 * @param scope the scope.
	 * @return a list of <tt>RetailBankingAccountBalance</tt>;
	 */
	public static List<RetailBankingAccountBalance> fetchInCacheWithScopePredicate(
			String scope, Integer offset, Integer limit) {
	...
	/**
	 * Fetches <tt>RetailBankingAccountBalance</tt> from cache with provided request.
	 * 
	 * @param request instance of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequest</tt>.
	 * @return a list of <tt>RetailBankingAccountBalance</tt>;
	 */
	public static List<RetailBankingAccountBalance> fetchInCacheWithAPCachedRequestPredicate(
			IAPCachedRequest request) {
		return com.anypresence.sdk.APSDKSetup.getCacheManager()
				.fetchInCacheWithAPCachedRequestPredicate(
						RetailBankingAccountBalance.class, request);
	}

	/**
	 * Fetches <tt>RetailBankingAccountBalance</tt> from cache with latest request.
	 * 
	 * @param scope the scope to perform the query.
	 * @param params a map of parameters.
	 * @param offset offset for the query, or <tt>null</tt> for no offset.
	 ...
	 * @return a list of <tt>RetailBankingAccountBalance</tt>;
	 */
	public static List<RetailBankingAccountBalance> fetchInCacheWithLatestAPCachedRequestPredicate(
			String scope, Map<String, String> params, Integer offset,
			Integer limit) {
		return com.anypresence.sdk.APSDKSetup.getCacheManager()
	...
	/**
	 * Fetches <tt>RetailBankingAccountBalance</tt> from cache with predicates.
	 *
	 * @see com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountBalanceDao.Properties
	 *
	 * @param predicates hash of predicates
	 * @return a list of <tt>RetailBankingAccountBalance</tt>
	 */
	public static List<RetailBankingAccountBalance> fetchInCacheWithPredicates(
			Map<String, String> predicates) {
		return com.anypresence.sdk.APSDKSetup.getCacheManager()
				.fetchInCacheWithPredicates(RetailBankingAccountBalance.class,
						predicates);
	}

	/**
	 * Deletes <tt>RetailBankingAccountBalance</tt> from cache matching <tt>objectId</tt>.
	 * 
	 * @param objectId the remote object id.
	 */
	...
	/**
	 * Deletes <tt>RetailBankingAccountBalance</tt> from cache matching <tt>scope</tt>.
	 * 
	 * @param scope the scope.
	 */
	public static void deleteAllInCacheWithScopePredicate(String scope) {
		com.anypresence.sdk.APSDKSetup.getCacheManager()
				.deleteAllInCacheWithScopePredicate(
						RetailBankingAccountBalance.class, scope);
	}
	...
	public boolean equals(Object obj) {
		...
		if ((obj == null) || (obj.getClass() != this.getClass()))
			return false;
		RetailBankingAccountBalance other = (RetailBankingAccountBalance) obj;
		return new EqualsBuilder().

		append(accountId, other.accountId).

		append(balanceType, other.balanceType).
	...
	// Backend on Device
	public static String MAPPING = "RetailBankingAccountBalance";
	...
	public String serialize() {
		...
		if (builder != null && routerAdapter != null) {
			...
			builder.addFieldMapping(((HttpAdapter) routerAdapter)
					.getConfigurationsAsConfiguration("POST")
					.getResponseRemoteFieldName("balance_type"), "balance_type");
	...
	public RemoteObject deserialize(String queryScope, Parser parser) {
		...
		if (configuration != null) {
			...
			try {
				...
				object.balanceType = parser.parse(configuration
						.getResponseRemoteFieldName("balance_type"),
						String.class);
			...
			object = (RetailBankingAccountBalance) Utilities
