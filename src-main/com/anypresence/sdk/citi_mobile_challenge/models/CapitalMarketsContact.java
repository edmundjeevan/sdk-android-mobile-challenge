...
public final class CapitalMarketsContact extends com.anypresence.sdk.APObject {
	...
	static {
		...
		QueryField queryFieldClientName323937482 = new QueryField();
		queryFieldClientName323937482.setIsAssignable(true);
		queryFieldClientName323937482.setFieldName("client_name");
		queryFieldClientName323937482.setParamName("client_name");
		try {
			queryFieldClientName323937482.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopecontacts.getQueryFields().put(
				queryFieldClientName323937482.getParamName(),
				queryFieldClientName323937482);

		QueryField queryFieldYear323937488 = new QueryField();
		queryFieldYear323937488.setIsAssignable(true);
		queryFieldYear323937488.setFieldName("year");
		queryFieldYear323937488.setParamName("year");
		try {
			queryFieldYear323937488.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopecontacts.getQueryFields()
				.put(queryFieldYear323937488.getParamName(),
						queryFieldYear323937488);
