...
public final class CapitalMarketsContact extends com.anypresence.sdk.APObject {
	...
	static {
		...
		QueryField queryFieldClientName154342983 = new QueryField();
		queryFieldClientName154342983.setIsAssignable(true);
		queryFieldClientName154342983.setFieldName("client_name");
		queryFieldClientName154342983.setParamName("client_name");
		try {
			queryFieldClientName154342983.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopecontacts.getQueryFields().put(
				queryFieldClientName154342983.getParamName(),
				queryFieldClientName154342983);

		QueryField queryFieldYear154342989 = new QueryField();
		queryFieldYear154342989.setIsAssignable(true);
		queryFieldYear154342989.setFieldName("year");
		queryFieldYear154342989.setParamName("year");
		try {
			queryFieldYear154342989.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopecontacts.getQueryFields()
				.put(queryFieldYear154342989.getParamName(),
						queryFieldYear154342989);
