...
public final class RetailBankingRewardsCatalog
	...
	static {
		...
		QueryField queryFieldItemCategory515692881 = new QueryField();
		queryFieldItemCategory515692881.setIsAssignable(true);
		queryFieldItemCategory515692881.setFieldName("item_category");
		queryFieldItemCategory515692881.setParamName("item_category");
		try {
			queryFieldItemCategory515692881.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScoperewards_catalog.getQueryFields().put(
				queryFieldItemCategory515692881.getParamName(),
				queryFieldItemCategory515692881);
