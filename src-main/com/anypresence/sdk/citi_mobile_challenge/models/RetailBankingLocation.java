...
public final class RetailBankingLocation extends com.anypresence.sdk.APObject {
	...
	static {
		...
		QueryField queryFieldLatitude154396786 = new QueryField();
		queryFieldLatitude154396786.setIsAssignable(true);
		queryFieldLatitude154396786.setFieldName("latitude");
		queryFieldLatitude154396786.setParamName("latitude");
		try {
			queryFieldLatitude154396786.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopelocations.getQueryFields().put(
				queryFieldLatitude154396786.getParamName(),
				queryFieldLatitude154396786);

		QueryField queryFieldLongitude154396791 = new QueryField();
		queryFieldLongitude154396791.setIsAssignable(true);
		queryFieldLongitude154396791.setFieldName("longitude");
		queryFieldLongitude154396791.setParamName("longitude");
		try {
			queryFieldLongitude154396791.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopelocations.getQueryFields().put(
				queryFieldLongitude154396791.getParamName(),
				queryFieldLongitude154396791);

		QueryField queryFieldId154396795 = new QueryField();
		queryFieldId154396795.setIsAssignable(true);
		queryFieldId154396795.setFieldName("id");
		queryFieldId154396795.setParamName("radius");
		try {
			queryFieldId154396795.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopelocations.getQueryFields().put(
				queryFieldId154396795.getParamName(), queryFieldId154396795);

		QueryField queryFieldId154396799 = new QueryField();
		queryFieldId154396799.setIsAssignable(true);
		queryFieldId154396799.setFieldName("id");
		queryFieldId154396799.setParamName("radius_uom");
		try {
			queryFieldId154396799.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopelocations.getQueryFields().put(
				queryFieldId154396799.getParamName(), queryFieldId154396799);

		QueryField queryFieldLocationType154396804 = new QueryField();
		queryFieldLocationType154396804.setIsAssignable(true);
		queryFieldLocationType154396804.setFieldName("location_type");
		queryFieldLocationType154396804.setParamName("location_type");
		try {
			queryFieldLocationType154396804.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopelocations.getQueryFields().put(
				queryFieldLocationType154396804.getParamName(),
				queryFieldLocationType154396804);

		QueryField queryFieldAddressLineOne154396808 = new QueryField();
		queryFieldAddressLineOne154396808.setIsAssignable(true);
		queryFieldAddressLineOne154396808.setFieldName("address_line_one");
		queryFieldAddressLineOne154396808.setParamName("address");
		try {
			queryFieldAddressLineOne154396808.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopelocations.getQueryFields().put(
				queryFieldAddressLineOne154396808.getParamName(),
				queryFieldAddressLineOne154396808);

		QueryField queryFieldCity154396813 = new QueryField();
		queryFieldCity154396813.setIsAssignable(true);
		queryFieldCity154396813.setFieldName("city");
		queryFieldCity154396813.setParamName("city");
		try {
			queryFieldCity154396813.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopelocations.getQueryFields()
				.put(queryFieldCity154396813.getParamName(),
						queryFieldCity154396813);

		QueryField queryFieldState154396816 = new QueryField();
		queryFieldState154396816.setIsAssignable(true);
		queryFieldState154396816.setFieldName("state");
		queryFieldState154396816.setParamName("state");
		try {
			queryFieldState154396816.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopelocations.getQueryFields().put(
				queryFieldState154396816.getParamName(),
				queryFieldState154396816);

		QueryField queryFieldPostalCode154396821 = new QueryField();
		queryFieldPostalCode154396821.setIsAssignable(true);
		queryFieldPostalCode154396821.setFieldName("postal_code");
		queryFieldPostalCode154396821.setParamName("postal_code");
		try {
			queryFieldPostalCode154396821.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopelocations.getQueryFields().put(
				queryFieldPostalCode154396821.getParamName(),
				queryFieldPostalCode154396821);
