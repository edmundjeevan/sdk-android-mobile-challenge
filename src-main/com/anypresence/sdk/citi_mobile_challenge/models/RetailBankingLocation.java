...
public final class RetailBankingLocation extends com.anypresence.sdk.APObject {
	...
	static {
		...
		QueryField queryFieldLatitude515681970 = new QueryField();
		queryFieldLatitude515681970.setIsAssignable(true);
		queryFieldLatitude515681970.setFieldName("latitude");
		queryFieldLatitude515681970.setParamName("latitude");
		try {
			queryFieldLatitude515681970.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopelocations.getQueryFields().put(
				queryFieldLatitude515681970.getParamName(),
				queryFieldLatitude515681970);

		QueryField queryFieldLongitude515681975 = new QueryField();
		queryFieldLongitude515681975.setIsAssignable(true);
		queryFieldLongitude515681975.setFieldName("longitude");
		queryFieldLongitude515681975.setParamName("longitude");
		try {
			queryFieldLongitude515681975.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopelocations.getQueryFields().put(
				queryFieldLongitude515681975.getParamName(),
				queryFieldLongitude515681975);

		QueryField queryFieldId515681979 = new QueryField();
		queryFieldId515681979.setIsAssignable(true);
		queryFieldId515681979.setFieldName("id");
		queryFieldId515681979.setParamName("radius");
		try {
			queryFieldId515681979.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopelocations.getQueryFields().put(
				queryFieldId515681979.getParamName(), queryFieldId515681979);

		QueryField queryFieldId515681983 = new QueryField();
		queryFieldId515681983.setIsAssignable(true);
		queryFieldId515681983.setFieldName("id");
		queryFieldId515681983.setParamName("radius_uom");
		try {
			queryFieldId515681983.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopelocations.getQueryFields().put(
				queryFieldId515681983.getParamName(), queryFieldId515681983);

		QueryField queryFieldLocationType515681989 = new QueryField();
		queryFieldLocationType515681989.setIsAssignable(true);
		queryFieldLocationType515681989.setFieldName("location_type");
		queryFieldLocationType515681989.setParamName("location_type");
		try {
			queryFieldLocationType515681989.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopelocations.getQueryFields().put(
				queryFieldLocationType515681989.getParamName(),
				queryFieldLocationType515681989);

		QueryField queryFieldAddressLineOne515681993 = new QueryField();
		queryFieldAddressLineOne515681993.setIsAssignable(true);
		queryFieldAddressLineOne515681993.setFieldName("address_line_one");
		queryFieldAddressLineOne515681993.setParamName("address");
		try {
			queryFieldAddressLineOne515681993.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopelocations.getQueryFields().put(
				queryFieldAddressLineOne515681993.getParamName(),
				queryFieldAddressLineOne515681993);

		QueryField queryFieldCity515681997 = new QueryField();
		queryFieldCity515681997.setIsAssignable(true);
		queryFieldCity515681997.setFieldName("city");
		queryFieldCity515681997.setParamName("city");
		try {
			queryFieldCity515681997.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopelocations.getQueryFields()
				.put(queryFieldCity515681997.getParamName(),
						queryFieldCity515681997);

		QueryField queryFieldState515682001 = new QueryField();
		queryFieldState515682001.setIsAssignable(true);
		queryFieldState515682001.setFieldName("state");
		queryFieldState515682001.setParamName("state");
		try {
			queryFieldState515682001.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopelocations.getQueryFields().put(
				queryFieldState515682001.getParamName(),
				queryFieldState515682001);

		QueryField queryFieldPostalCode515682006 = new QueryField();
		queryFieldPostalCode515682006.setIsAssignable(true);
		queryFieldPostalCode515682006.setFieldName("postal_code");
		queryFieldPostalCode515682006.setParamName("postal_code");
		try {
			queryFieldPostalCode515682006.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopelocations.getQueryFields().put(
				queryFieldPostalCode515682006.getParamName(),
				queryFieldPostalCode515682006);
