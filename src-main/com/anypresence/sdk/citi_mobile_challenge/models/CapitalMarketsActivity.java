 ...
 */
public final class CapitalMarketsActivity extends com.anypresence.sdk.APObject {
	private static final long serialVersionUID = 1L;

	private static final Log log = LogFactory
			.getLog(CapitalMarketsActivity.class);

	private static final String TAG = "CapitalMarketsActivity";

	/**
	 *  Scope names for CapitalMarketsActivity.
	 */
	...
	@SerializedName("citi_attendees")
	@Expose
	private ArrayList<Object> citiAttendees;

	public ArrayList<Object> getCitiAttendees() {
		return citiAttendees;
	}

	public void setCitiAttendees(ArrayList<Object> citiAttendees) {
		this.citiAttendees = citiAttendees;
	}

	@SerializedName("client_contacts")
	@Expose
	private ArrayList<Object> clientContacts;

	public ArrayList<Object> getClientContacts() {
		return clientContacts;
	}

	public void setClientContacts(ArrayList<Object> clientContacts) {
	 ...
	 */
	public static final CapitalMarketsActivity copy(CapitalMarketsActivity orig) {
		final CapitalMarketsActivity newObject = new CapitalMarketsActivity();

		if (orig.getId() != null)
			newObject.setId(new ObjectId(orig.getId()));

		if (orig.getActivityType() != null)
			newObject.setActivityType(new String(orig.getActivityType()));

		if (orig.getCitiAttendees() != null) {
			ArrayList<Object> _citiAttendees = new ArrayList<Object>();
			_citiAttendees.addAll(orig.getCitiAttendees());
			newObject.setCitiAttendees(_citiAttendees);
		}

		if (orig.getClientContacts() != null) {
			ArrayList<Object> _clientContacts = new ArrayList<Object>();
			_clientContacts.addAll(orig.getClientContacts());
			newObject.setClientContacts(_clientContacts);
		}
		...
		if (orig.getDate() != null)
			newObject.setDate(new String(orig.getDate()));
	...
	static {
		...
		QueryScope queryScopeactivities = new QueryScope();
		queryScopeactivities.setName("activities");

		QueryField queryFieldYear515625177 = new QueryField();
		queryFieldYear515625177.setIsAssignable(true);
		queryFieldYear515625177.setFieldName("year");
		queryFieldYear515625177.setParamName("year");
		try {
			queryFieldYear515625177.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopeactivities.getQueryFields()
				.put(queryFieldYear515625177.getParamName(),
						queryFieldYear515625177);

		queryScopes.put(queryScopeactivities.getName(), queryScopeactivities);

	}

	/**
	 * Fetches a <tt>CapitalMarketsActivity</tt> with the provided <tt>objectId</tt>.
	 *
	 * @param objectId the id of the object
	 * @return an instance of <tt>CapitalMarketsActivity</tt>
	 * @throws RemoteRequestException If there are other issues with the request.
	 */
	public static CapitalMarketsActivity fetch(String objectId)
			throws RemoteRequestException {
		RemoteRequest.RemoteRequestBuilder remoteRequestBuilder = RemoteRailsConfig
				.getRouterAdapterByClassOrUseDefaultAdapter(
						CapitalMarketsActivity.class)
				.createRemoteRequestBuilder(RequestMethod.GET,
						CapitalMarketsActivity.class);

		CapitalMarketsActivity object = new CapitalMarketsActivity();
	...
	/**
	 * Fetches a <tt>CapitalMarketsActivity</tt> with the provided <tt>objectId</tt> in the background.
	 *
	 * <p>
	 ...
	 * <pre>
	 * {@code
	 * CapitalMarketsActivity.fetchInBackground("123", new APCallback<CapitalMarketsActivity>() {
	 *     
	 *     public void finished(CapitalMarketsActivity object, Throwable ex) {
	 *         if (ex == null) {
	 ...
	 * @return the cached <tt>CapitalMarketsActivity</tt> if it exists, otherwise, null.
	
	 */
	public static CapitalMarketsActivity

	fetchInBackground(String objectId,
			IAPFutureCallback<CapitalMarketsActivity> futureCallback) {

		return com.anypresence.sdk.APObject.fetchInBackground(objectId,
				CapitalMarketsActivity.class, futureCallback);

	}

	/**
	 * Queries for <tt>CapitalMarketsActivity</tt> with the provided <tt>scope</tt>.
	 *
	 ...
	 * @throws RemoteRequestException If there are other issues with the request.
	 */
	public static List<CapitalMarketsActivity> query(String scope)
			throws RemoteRequestException {
		return query(scope, null, null, null);
	}

	/**
	 * Queries for <tt>CapitalMarketsActivity</tt> with the provided <tt>scope</tt> and other params.
	 *
	 * Note: the scopes were defined from the Designer.
	 *
	 * @param scope the scope to perform the query.
	 ...
	 * @throws RemoteRequestException If there are other issues with the request.
	 */
	public static List<CapitalMarketsActivity> queryInBackground(
			final String scope, Map<String, String> params,
			IAPFutureCallback<List<CapitalMarketsActivity>> futureCallback) {
	...
	/**
	 * Queries for <tt>CapitalMarketsActivity</tt> with the provided <tt>scope</tt> in the background.
	 *
	 * Note: the scopes were defined from the Designer.
	 *
	 * <p>
	 ...
	 * <pre>
	 * {@code
	 * CapitalMarketsActivity.queryInBackground("all", new APCallback<List<CapitalMarketsActivity>>() {
	 *     
	 *     public void finished(List<CapitalMarketsActivity> objects, Throwable ex) {
	 *         if (ex == null) {
	 ...
	 * @param scope the scope to perform the query.
	 * @param futureCallback the callback that handles the result of the request.
	 * @return list of cached <tt>CapitalMarketsActivity</tt> objects.
	 */
	public static List<CapitalMarketsActivity> queryInBackground(String scope,
			IAPFutureCallback<List<CapitalMarketsActivity>> futureCallback) {
	 ...
	 * <pre>
	 * {@code
	 * CapitalMarketsActivity.queryInBackground("all", 0, 25, new APCallback<List<CapitalMarketsActivity>>() {
	 *     
	 *     public void finished(List<CapitalMarketsActivity> objects, Throwable ex) {
	 *         if (ex == null) {
	 *             Log.i(TAG, "Objects fetched!");
	 ...
	 * CapitalMarketsActivity.queryInBackground("all", params, 0, 25, new APCallback<List<CapitalMarketsActivity>>() {
	 *     
	 *     public void finished(List<CapitalMarketsActivity> objects, Throwable ex) {
	 *         if (ex == null) {
	 *             Log.i(TAG, "Objects fetched!");
	 ...
	 * {@code
	 * Map<String,String> params = new HashMap<String,String>();
	 * CapitalMarketsActivity.aggregateQueryInBackground("count", params, new APCallback<String>() {
	 *     
	...
	/**
	 * Deletes all data in cache for <tt>CapitalMarketsActivity</tt>.
	 */
	...
	/**
	 * Loads all <tt>CapitalMarketsActivity</tt> objects in local cache.
	 *
	 * @return list of <tt>CapitalMarketsActivity</tt>
	 */
	public static List<CapitalMarketsActivity> loadAllInCache() {
		return com.anypresence.sdk.APSDKSetup.getCacheManager().loadAllInCache(
				CapitalMarketsActivity.class);
	}

	/**
	 * Loads <tt>CapitalMarketsActivity</tt> objects in local cache.
	 *
	 * @param offset the offset
	 * @param limit the limit
	 * @return list of <tt>CapitalMarketsActivity</tt>
	 */
	public static List<CapitalMarketsActivity> loadInCache(Integer offset,
			Integer limit) {
		return null;
	}
	...
	public void updateInCache() {
		com.anypresence.sdk.APSDKSetup.getCacheManager().updateInCache(
				CapitalMarketsActivity.class, this);
	}
	...
	public void saveInCache(String scope) {
		com.anypresence.sdk.APSDKSetup.getCacheManager().saveInCache(
				CapitalMarketsActivity.class, this, scope);
	}
	...
	public void saveInCacheWithRequest(IAPCachedRequest request) {
		com.anypresence.sdk.APSDKSetup.getCacheManager()
				.saveInCacheWithRequest(CapitalMarketsActivity.class, this,
						request);
	}

	/**
	 * Deletes all <tt>CapitalMarketsActivity</tt> objects in cache that has
	...
	/**
	 * Fetches <tt>CapitalMarketsActivity</tt> from cache with provided remote object id.
	 * 
	 * @param objectId the remote object id.
	 * @return a list of <tt>CapitalMarketsActivity</tt>;
	 */
	public static List<CapitalMarketsActivity> fetchInCacheWithObjectIdPredicate(
			String objectId) {
		return com.anypresence.sdk.APSDKSetup.getCacheManager()
				.fetchInCacheWithObjectIdPredicate(
						CapitalMarketsActivity.class, objectId);
	}

	/**
	 * Fetches <tt>CapitalMarketsActivity</tt> from cache by searching for requests matching 
	 ...
	 * Map<String,String> params = new HashMap<String,String>();
	 * params.put("name", "test");
	 * CapitalMarketsActivity.queryInBackground("all", params, new APCallback<List<CapitalMarketsActivity>>() {
	 *     
	 *     public void finished(List<CapitalMarketsActivity> objects, Throwable ex) {
	 *         if (ex == null) {
	 *             Log.i(TAG, "Objects fetched!");
	 ...
	 * CapitalMarketsActivity.fetchInCacheWithParameterPredicate("all", params);
	 * }
	 *
	 * </pre>
	 * 
	 ...
	 * @return a list of <tt>CapitalMarketsActivity</tt>;
	 */
	public static List<CapitalMarketsActivity> fetchInCacheWithParameterPredicate(
			String scope, Map<String, String> params) {
		return com.anypresence.sdk.APSDKSetup.getCacheManager()
				.fetchInCacheWithParameterPredicate(
						CapitalMarketsActivity.class, scope, params);
	}

	/**
	 * Fetches <tt>CapitalMarketsActivity</tt> from cache with provided scope.
	 * 
	 * @param scope the scope.
	 * @return a list of <tt>CapitalMarketsActivity</tt>;
	 */
	public static List<CapitalMarketsActivity> fetchInCacheWithScopePredicate(
	...
	public static List<CapitalMarketsActivity> fetchInCacheWithScopePredicate(
			...
			Integer limit) {
		return com.anypresence.sdk.APSDKSetup.getCacheManager()
				.fetchInCacheWithScopePredicate(CapitalMarketsActivity.class,
						scope, params, offset, limit);
	}

	/**
	 * Fetches <tt>CapitalMarketsActivity</tt> from cache with provided request.
	 * 
	 * @param request instance of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequest</tt>.
	 * @return a list of <tt>CapitalMarketsActivity</tt>;
	 */
	public static List<CapitalMarketsActivity> fetchInCacheWithAPCachedRequestPredicate(
			IAPCachedRequest request) {
		return com.anypresence.sdk.APSDKSetup.getCacheManager()
				.fetchInCacheWithAPCachedRequestPredicate(
						CapitalMarketsActivity.class, request);
	}

	/**
	 * Fetches <tt>CapitalMarketsActivity</tt> from cache with latest request.
	 * 
	 * @param scope the scope to perform the query.
	 * @param params a map of parameters.
	 * @param offset offset for the query, or <tt>null</tt> for no offset.
	 ...
	 * @return a list of <tt>CapitalMarketsActivity</tt>;
	 */
	public static List<CapitalMarketsActivity> fetchInCacheWithLatestAPCachedRequestPredicate(
			String scope, Map<String, String> params, Integer offset,
			Integer limit) {
		return com.anypresence.sdk.APSDKSetup.getCacheManager()
				.fetchInCacheWithLatestAPCachedRequestPredicate(
						CapitalMarketsActivity.class, scope, params, offset,
						limit);
	}

	/**
	 * Fetches <tt>CapitalMarketsActivity</tt> from cache with predicates.
	 *
	 * @see com.anypresence.anypresence_inc.citi_mobile_challenge.dao.CapitalMarketsActivityDao.Properties
	 *
	 * @param predicates hash of predicates
	 * @return a list of <tt>CapitalMarketsActivity</tt>
	 */
	public static List<CapitalMarketsActivity> fetchInCacheWithPredicates(
			Map<String, String> predicates) {
		return com.anypresence.sdk.APSDKSetup.getCacheManager()
				.fetchInCacheWithPredicates(CapitalMarketsActivity.class,
						predicates);
	}

	/**
	 * Deletes <tt>CapitalMarketsActivity</tt> from cache matching <tt>objectId</tt>.
	 * 
	 * @param objectId the remote object id.
	 */
	...
	/**
	 * Deletes <tt>CapitalMarketsActivity</tt> from cache matching <tt>scope</tt>.
	 * 
	 * @param scope the scope.
	 */
	public static void deleteAllInCacheWithScopePredicate(String scope) {
		com.anypresence.sdk.APSDKSetup.getCacheManager()
				.deleteAllInCacheWithScopePredicate(
						CapitalMarketsActivity.class, scope);
	}
	...
	public boolean equals(Object obj) {
		...
		if ((obj == null) || (obj.getClass() != this.getClass()))
			return false;
		CapitalMarketsActivity other = (CapitalMarketsActivity) obj;
		return new EqualsBuilder().

		append(activityType, other.activityType).

		append(citiAttendees, other.citiAttendees).

		append(clientContacts, other.clientContacts).
	...
	// Backend on Device
	public static String MAPPING = "CapitalMarketsActivity";
	...
	public String serialize() {
		...
		if (builder != null && routerAdapter != null) {
			...
			builder.addFieldMapping(((HttpAdapter) routerAdapter)
					.getConfigurationsAsConfiguration("POST")
					.getResponseRemoteFieldName("activity_type"),
					"activity_type");

			builder.addFieldMapping(((HttpAdapter) routerAdapter)
					.getConfigurationsAsConfiguration("POST")
					.getResponseRemoteFieldName("citi_attendees"),
					"citi_attendees");

			builder.addFieldMapping(((HttpAdapter) routerAdapter)
					.getConfigurationsAsConfiguration("POST")
					.getResponseRemoteFieldName("client_contacts"),
					"client_contacts");
			...
			builder.addFieldMapping(((HttpAdapter) routerAdapter)
					.getConfigurationsAsConfiguration("POST")
					.getResponseRemoteFieldName("date"), "date");
	...
	public RemoteObject deserialize(String queryScope, Parser parser) {
		...
		if (configuration != null) {
			...
			try {
				...
				object.activityType = parser.parse(configuration
						.getResponseRemoteFieldName("activity_type"),
						String.class);
			...
			try {
				...
				object.citiAttendees = parser.parse(configuration
						.getResponseRemoteFieldName("citi_attendees"),
						ArrayList.class);
			...
			try {
				...
				object.clientContacts = parser.parse(configuration
						.getResponseRemoteFieldName("client_contacts"),
						ArrayList.class);
			...
			try {
				...
				object.date = parser.parse(
						configuration.getResponseRemoteFieldName("date"),
						String.class);
			...
			object = (CapitalMarketsActivity) Utilities.transformJsonToObject(
					json, this.getClass());
		}
