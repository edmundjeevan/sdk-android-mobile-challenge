...
public final class CapitalMarketsActivity extends com.anypresence.sdk.APObject {
	...
	static {
		...
		QueryField queryFieldYear323932536 = new QueryField();
		queryFieldYear323932536.setIsAssignable(true);
		queryFieldYear323932536.setFieldName("year");
		queryFieldYear323932536.setParamName("year");
		try {
			queryFieldYear323932536.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopeactivities.getQueryFields()
				.put(queryFieldYear323932536.getParamName(),
						queryFieldYear323932536);
