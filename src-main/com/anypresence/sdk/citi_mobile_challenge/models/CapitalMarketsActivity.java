...
public final class CapitalMarketsActivity extends com.anypresence.sdk.APObject {
	...
	static {
		...
		QueryField queryFieldYear154338390 = new QueryField();
		queryFieldYear154338390.setIsAssignable(true);
		queryFieldYear154338390.setFieldName("year");
		queryFieldYear154338390.setParamName("year");
		try {
			queryFieldYear154338390.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopeactivities.getQueryFields()
				.put(queryFieldYear154338390.getParamName(),
						queryFieldYear154338390);
