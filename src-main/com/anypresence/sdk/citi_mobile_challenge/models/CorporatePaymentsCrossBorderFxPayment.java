...
public final class CorporatePaymentsCrossBorderFxPayment
	...
	static {
		...
		QueryField queryFieldCitiRef154370162 = new QueryField();
		queryFieldCitiRef154370162.setIsAssignable(true);
		queryFieldCitiRef154370162.setFieldName("citi_ref");
		queryFieldCitiRef154370162.setParamName("citi_ref");
		try {
			queryFieldCitiRef154370162.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopefx_payments.getQueryFields().put(
				queryFieldCitiRef154370162.getParamName(),
				queryFieldCitiRef154370162);

		QueryField queryFieldCustomerTxnRef154370167 = new QueryField();
		queryFieldCustomerTxnRef154370167.setIsAssignable(true);
		queryFieldCustomerTxnRef154370167.setFieldName("customer_txn_ref");
		queryFieldCustomerTxnRef154370167.setParamName("customer_txn_ref");
		try {
			queryFieldCustomerTxnRef154370167.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopefx_payments.getQueryFields().put(
				queryFieldCustomerTxnRef154370167.getParamName(),
				queryFieldCustomerTxnRef154370167);

		QueryField queryFieldToCurrency154370172 = new QueryField();
		queryFieldToCurrency154370172.setIsAssignable(true);
		queryFieldToCurrency154370172.setFieldName("to_currency");
		queryFieldToCurrency154370172.setParamName("to_currency");
		try {
			queryFieldToCurrency154370172.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopefx_payments.getQueryFields().put(
				queryFieldToCurrency154370172.getParamName(),
				queryFieldToCurrency154370172);

		QueryField queryFieldBeneficiaryName154370177 = new QueryField();
		queryFieldBeneficiaryName154370177.setIsAssignable(true);
		queryFieldBeneficiaryName154370177.setFieldName("beneficiary_name");
		queryFieldBeneficiaryName154370177.setParamName("beneficiary_name");
		try {
			queryFieldBeneficiaryName154370177.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopefx_payments.getQueryFields().put(
				queryFieldBeneficiaryName154370177.getParamName(),
				queryFieldBeneficiaryName154370177);

		QueryField queryFieldValueDate154370181 = new QueryField();
		queryFieldValueDate154370181.setIsAssignable(true);
		queryFieldValueDate154370181.setFieldName("value_date");
		queryFieldValueDate154370181.setParamName("value_date");
		try {
			queryFieldValueDate154370181.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopefx_payments.getQueryFields().put(
				queryFieldValueDate154370181.getParamName(),
				queryFieldValueDate154370181);
