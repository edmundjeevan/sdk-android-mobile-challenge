...
public final class CorporatePaymentsCrossBorderFxPayment
	...
	static {
		...
		QueryField queryFieldCitiRef323964677 = new QueryField();
		queryFieldCitiRef323964677.setIsAssignable(true);
		queryFieldCitiRef323964677.setFieldName("citi_ref");
		queryFieldCitiRef323964677.setParamName("citi_ref");
		try {
			queryFieldCitiRef323964677.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopefx_payments.getQueryFields().put(
				queryFieldCitiRef323964677.getParamName(),
				queryFieldCitiRef323964677);

		QueryField queryFieldCustomerTxnRef323964683 = new QueryField();
		queryFieldCustomerTxnRef323964683.setIsAssignable(true);
		queryFieldCustomerTxnRef323964683.setFieldName("customer_txn_ref");
		queryFieldCustomerTxnRef323964683.setParamName("customer_txn_ref");
		try {
			queryFieldCustomerTxnRef323964683.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopefx_payments.getQueryFields().put(
				queryFieldCustomerTxnRef323964683.getParamName(),
				queryFieldCustomerTxnRef323964683);

		QueryField queryFieldToCurrency323964688 = new QueryField();
		queryFieldToCurrency323964688.setIsAssignable(true);
		queryFieldToCurrency323964688.setFieldName("to_currency");
		queryFieldToCurrency323964688.setParamName("to_currency");
		try {
			queryFieldToCurrency323964688.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopefx_payments.getQueryFields().put(
				queryFieldToCurrency323964688.getParamName(),
				queryFieldToCurrency323964688);

		QueryField queryFieldBeneficiaryName323964692 = new QueryField();
		queryFieldBeneficiaryName323964692.setIsAssignable(true);
		queryFieldBeneficiaryName323964692.setFieldName("beneficiary_name");
		queryFieldBeneficiaryName323964692.setParamName("beneficiary_name");
		try {
			queryFieldBeneficiaryName323964692.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopefx_payments.getQueryFields().put(
				queryFieldBeneficiaryName323964692.getParamName(),
				queryFieldBeneficiaryName323964692);

		QueryField queryFieldValueDate323964696 = new QueryField();
		queryFieldValueDate323964696.setIsAssignable(true);
		queryFieldValueDate323964696.setFieldName("value_date");
		queryFieldValueDate323964696.setParamName("value_date");
		try {
			queryFieldValueDate323964696.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopefx_payments.getQueryFields().put(
				queryFieldValueDate323964696.getParamName(),
				queryFieldValueDate323964696);
