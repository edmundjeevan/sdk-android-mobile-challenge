 ...
 */
public final class RetailBankingAccountTransaction
		extends
			com.anypresence.sdk.APObject {
	private static final long serialVersionUID = 1L;

	private static final Log log = LogFactory
			.getLog(RetailBankingAccountTransaction.class);

	private static final String TAG = "RetailBankingAccountTransaction";

	/**
	 *  Scope names for RetailBankingAccountTransaction.
	 */
	 ...
	 */
	public static final RetailBankingAccountTransaction copy(
			RetailBankingAccountTransaction orig) {
		final RetailBankingAccountTransaction newObject = new RetailBankingAccountTransaction();

		if (orig.getId() != null)
			newObject.setId(new ObjectId(orig.getId()));

		if (orig.getAccountId() != null)
			newObject.setAccountId(new String(orig.getAccountId()));

		if (orig.getActivity() != null)
			newObject.setActivity(new String(orig.getActivity()));

		if (orig.getCheckImageEligible() != null)
			newObject.setCheckImageEligible(new String(orig
					.getCheckImageEligible()));

		if (orig.getDatePosted() != null)
			newObject.setDatePosted(new String(orig.getDatePosted()));

		if (orig.getFormattedAmount() != null)
			newObject.setFormattedAmount(new String(orig.getFormattedAmount()));

		if (orig.getPendingDate() != null)
			newObject.setPendingDate(new String(orig.getPendingDate()));

		if (orig.getTransactionAmount() != null)
			newObject.setTransactionAmount(new Float(orig
					.getTransactionAmount()));

		if (orig.getTransactionDescription() != null)
			newObject.setTransactionDescription(new String(orig
					.getTransactionDescription()));

		if (orig.getTransactionIdentifier() != null)
			newObject.setTransactionIdentifier(new String(orig
					.getTransactionIdentifier()));

		if (orig.getTransactionIndex() != null)
			newObject
					.setTransactionIndex(new String(orig.getTransactionIndex()));

		if (orig.getTransactionType() != null)
			newObject.setTransactionType(new String(orig.getTransactionType()));
	...
	/**
	 * Fetches a <tt>RetailBankingAccountTransaction</tt> with the provided <tt>objectId</tt>.
	 *
	 * @param objectId the id of the object
	 * @return an instance of <tt>RetailBankingAccountTransaction</tt>
	 * @throws RemoteRequestException If there are other issues with the request.
	 */
	public static RetailBankingAccountTransaction fetch(String objectId)
			throws RemoteRequestException {
		RemoteRequest.RemoteRequestBuilder remoteRequestBuilder = RemoteRailsConfig
				.getRouterAdapterByClassOrUseDefaultAdapter(
						RetailBankingAccountTransaction.class)
				.createRemoteRequestBuilder(RequestMethod.GET,
						RetailBankingAccountTransaction.class);

		RetailBankingAccountTransaction object = new RetailBankingAccountTransaction();
	...
	/**
	 * Fetches a <tt>RetailBankingAccountTransaction</tt> with the provided <tt>objectId</tt> in the background.
	 *
	 * <p>
	 ...
	 * <pre>
	 * {@code
	 * RetailBankingAccountTransaction.fetchInBackground("123", new APCallback<RetailBankingAccountTransaction>() {
	 *     
	 *     public void finished(RetailBankingAccountTransaction object, Throwable ex) {
	 *         if (ex == null) {
	 ...
	 * @return the cached <tt>RetailBankingAccountTransaction</tt> if it exists, otherwise, null.
	
	 */
	public static RetailBankingAccountTransaction

	fetchInBackground(String objectId,
			IAPFutureCallback<RetailBankingAccountTransaction> futureCallback) {

		return com.anypresence.sdk.APObject.fetchInBackground(objectId,
				RetailBankingAccountTransaction.class, futureCallback);

	}

	/**
	 * Queries for <tt>RetailBankingAccountTransaction</tt> with the provided <tt>scope</tt>.
	 *
	 ...
	 * @throws RemoteRequestException If there are other issues with the request.
	 */
	public static List<RetailBankingAccountTransaction> query(String scope)
			throws RemoteRequestException {
		return query(scope, null, null, null);
	}

	/**
	 * Queries for <tt>RetailBankingAccountTransaction</tt> with the provided <tt>scope</tt> and other params.
	 *
	 * Note: the scopes were defined from the Designer.
	 *
	 * @param scope the scope to perform the query.
	 ...
	 * @throws RemoteRequestException If there are other issues with the request.
	 */
	public static List<RetailBankingAccountTransaction> queryInBackground(
			final String scope,
			Map<String, String> params,
			IAPFutureCallback<List<RetailBankingAccountTransaction>> futureCallback) {
	...
	/**
	 * Queries for <tt>RetailBankingAccountTransaction</tt> with the provided <tt>scope</tt> in the background.
	 *
	 * Note: the scopes were defined from the Designer.
	 *
	 * <p>
	 ...
	 * <pre>
	 * {@code
	 * RetailBankingAccountTransaction.queryInBackground("all", new APCallback<List<RetailBankingAccountTransaction>>() {
	 *     
	 *     public void finished(List<RetailBankingAccountTransaction> objects, Throwable ex) {
	 *         if (ex == null) {
	 ...
	 * @param scope the scope to perform the query.
	 * @param futureCallback the callback that handles the result of the request.
	 * @return list of cached <tt>RetailBankingAccountTransaction</tt> objects.
	 */
	public static List<RetailBankingAccountTransaction> queryInBackground(
			String scope,
			IAPFutureCallback<List<RetailBankingAccountTransaction>> futureCallback) {
	 ...
	 * <pre>
	 * {@code
	 * RetailBankingAccountTransaction.queryInBackground("all", 0, 25, new APCallback<List<RetailBankingAccountTransaction>>() {
	 *     
	 *     public void finished(List<RetailBankingAccountTransaction> objects, Throwable ex) {
	 *         if (ex == null) {
	 *             Log.i(TAG, "Objects fetched!");
	 ...
	 * RetailBankingAccountTransaction.queryInBackground("all", params, 0, 25, new APCallback<List<RetailBankingAccountTransaction>>() {
	 *     
	 *     public void finished(List<RetailBankingAccountTransaction> objects, Throwable ex) {
	 *         if (ex == null) {
	 *             Log.i(TAG, "Objects fetched!");
	 ...
	 * {@code
	 * Map<String,String> params = new HashMap<String,String>();
	 * RetailBankingAccountTransaction.aggregateQueryInBackground("count", params, new APCallback<String>() {
	 *     
	...
	/**
	 * Deletes all data in cache for <tt>RetailBankingAccountTransaction</tt>.
	 */
	...
	/**
	 * Loads all <tt>RetailBankingAccountTransaction</tt> objects in local cache.
	 *
	 * @return list of <tt>RetailBankingAccountTransaction</tt>
	 */
	public static List<RetailBankingAccountTransaction> loadAllInCache() {
		return com.anypresence.sdk.APSDKSetup.getCacheManager().loadAllInCache(
				RetailBankingAccountTransaction.class);
	}

	/**
	 * Loads <tt>RetailBankingAccountTransaction</tt> objects in local cache.
	 *
	 * @param offset the offset
	 * @param limit the limit
	 * @return list of <tt>RetailBankingAccountTransaction</tt>
	 */
	public static List<RetailBankingAccountTransaction> loadInCache(
	...
	public void updateInCache() {
		com.anypresence.sdk.APSDKSetup.getCacheManager().updateInCache(
				RetailBankingAccountTransaction.class, this);
	}
	...
	public void saveInCache(String scope) {
		com.anypresence.sdk.APSDKSetup.getCacheManager().saveInCache(
				RetailBankingAccountTransaction.class, this, scope);
	}
	...
	public void saveInCacheWithRequest(IAPCachedRequest request) {
		com.anypresence.sdk.APSDKSetup.getCacheManager()
				.saveInCacheWithRequest(RetailBankingAccountTransaction.class,
						this, request);
	}

	/**
	 * Deletes all <tt>RetailBankingAccountTransaction</tt> objects in cache that has
	...
	/**
	 * Fetches <tt>RetailBankingAccountTransaction</tt> from cache with provided remote object id.
	 * 
	 * @param objectId the remote object id.
	 * @return a list of <tt>RetailBankingAccountTransaction</tt>;
	 */
	public static List<RetailBankingAccountTransaction> fetchInCacheWithObjectIdPredicate(
			String objectId) {
		return com.anypresence.sdk.APSDKSetup.getCacheManager()
				.fetchInCacheWithObjectIdPredicate(
						RetailBankingAccountTransaction.class, objectId);
	}

	/**
	 * Fetches <tt>RetailBankingAccountTransaction</tt> from cache by searching for requests matching 
	 ...
	 * Map<String,String> params = new HashMap<String,String>();
	 * params.put("name", "test");
	 * RetailBankingAccountTransaction.queryInBackground("all", params, new APCallback<List<RetailBankingAccountTransaction>>() {
	 *     
	 *     public void finished(List<RetailBankingAccountTransaction> objects, Throwable ex) {
	 *         if (ex == null) {
	 *             Log.i(TAG, "Objects fetched!");
	 ...
	 * RetailBankingAccountTransaction.fetchInCacheWithParameterPredicate("all", params);
	 * }
	 *
	 * </pre>
	 * 
	 ...
	 * @return a list of <tt>RetailBankingAccountTransaction</tt>;
	 */
	public static List<RetailBankingAccountTransaction> fetchInCacheWithParameterPredicate(
			String scope, Map<String, String> params) {
		return com.anypresence.sdk.APSDKSetup.getCacheManager()
				.fetchInCacheWithParameterPredicate(
						RetailBankingAccountTransaction.class, scope, params);
	}

	/**
	 * Fetches <tt>RetailBankingAccountTransaction</tt> from cache with provided scope.
	 * 
	 * @param scope the scope.
	 * @return a list of <tt>RetailBankingAccountTransaction</tt>;
	 */
	public static List<RetailBankingAccountTransaction> fetchInCacheWithScopePredicate(
	...
	/**
	 * Fetches <tt>RetailBankingAccountTransaction</tt> from cache with provided request.
	 * 
	 * @param request instance of <tt>com.anypresence.anypresence_inc.citi_mobile_challenge.dao.APCachedRequest</tt>.
	 * @return a list of <tt>RetailBankingAccountTransaction</tt>;
	 */
	public static List<RetailBankingAccountTransaction> fetchInCacheWithAPCachedRequestPredicate(
			IAPCachedRequest request) {
		return com.anypresence.sdk.APSDKSetup.getCacheManager()
				.fetchInCacheWithAPCachedRequestPredicate(
						RetailBankingAccountTransaction.class, request);
	}

	/**
	 * Fetches <tt>RetailBankingAccountTransaction</tt> from cache with latest request.
	 * 
	 * @param scope the scope to perform the query.
	 * @param params a map of parameters.
	 * @param offset offset for the query, or <tt>null</tt> for no offset.
	 ...
	 * @return a list of <tt>RetailBankingAccountTransaction</tt>;
	 */
	public static List<RetailBankingAccountTransaction> fetchInCacheWithLatestAPCachedRequestPredicate(
			String scope, Map<String, String> params, Integer offset,
			Integer limit) {
		return com.anypresence.sdk.APSDKSetup.getCacheManager()
	...
	/**
	 * Fetches <tt>RetailBankingAccountTransaction</tt> from cache with predicates.
	 *
	 * @see com.anypresence.anypresence_inc.citi_mobile_challenge.dao.RetailBankingAccountTransactionDao.Properties
	 *
	 * @param predicates hash of predicates
	 * @return a list of <tt>RetailBankingAccountTransaction</tt>
	 */
	public static List<RetailBankingAccountTransaction> fetchInCacheWithPredicates(
			Map<String, String> predicates) {
		return com.anypresence.sdk.APSDKSetup.getCacheManager()
				.fetchInCacheWithPredicates(
						RetailBankingAccountTransaction.class, predicates);
	}

	/**
	 * Deletes <tt>RetailBankingAccountTransaction</tt> from cache matching <tt>objectId</tt>.
	 * 
	 * @param objectId the remote object id.
	 */
	...
	/**
	 * Deletes <tt>RetailBankingAccountTransaction</tt> from cache matching <tt>scope</tt>.
	 * 
	 * @param scope the scope.
	 */
	public static void deleteAllInCacheWithScopePredicate(String scope) {
		com.anypresence.sdk.APSDKSetup.getCacheManager()
				.deleteAllInCacheWithScopePredicate(
						RetailBankingAccountTransaction.class, scope);
	}
	...
	public boolean equals(Object obj) {
		...
		if ((obj == null) || (obj.getClass() != this.getClass()))
			return false;
		RetailBankingAccountTransaction other = (RetailBankingAccountTransaction) obj;
		...
		append(checkImageEligible, other.checkImageEligible).

		append(datePosted, other.datePosted).

		append(formattedAmount, other.formattedAmount).

		append(pendingDate, other.pendingDate).

		append(transactionAmount, other.transactionAmount).

		append(transactionDescription, other.transactionDescription).

		append(transactionIdentifier, other.transactionIdentifier).

		append(transactionIndex, other.transactionIndex).
	...
	// Backend on Device
	public static String MAPPING = "RetailBankingAccountTransaction";
	...
	public String serialize() {
		...
		if (builder != null && routerAdapter != null) {
			...
			builder.addFieldMapping(((HttpAdapter) routerAdapter)
					.getConfigurationsAsConfiguration("POST")
					.getResponseRemoteFieldName("account_id"), "account_id");

			builder.addFieldMapping(((HttpAdapter) routerAdapter)
					.getConfigurationsAsConfiguration("POST")
					.getResponseRemoteFieldName("activity"), "activity");

			builder.addFieldMapping(((HttpAdapter) routerAdapter)
					.getConfigurationsAsConfiguration("POST")
					.getResponseRemoteFieldName("check_image_eligible"),
					"check_image_eligible");

			builder.addFieldMapping(((HttpAdapter) routerAdapter)
					.getConfigurationsAsConfiguration("POST")
					.getResponseRemoteFieldName("date_posted"), "date_posted");

			builder.addFieldMapping(((HttpAdapter) routerAdapter)
					.getConfigurationsAsConfiguration("POST")
					.getResponseRemoteFieldName("formatted_amount"),
					"formatted_amount");

			builder.addFieldMapping(((HttpAdapter) routerAdapter)
					.getConfigurationsAsConfiguration("POST")
					.getResponseRemoteFieldName("pending_date"), "pending_date");

			builder.addFieldMapping(((HttpAdapter) routerAdapter)
					.getConfigurationsAsConfiguration("POST")
					.getResponseRemoteFieldName("transaction_amount"),
					"transaction_amount");

			builder.addFieldMapping(((HttpAdapter) routerAdapter)
					.getConfigurationsAsConfiguration("POST")
					.getResponseRemoteFieldName("transaction_description"),
					"transaction_description");

			builder.addFieldMapping(((HttpAdapter) routerAdapter)
					.getConfigurationsAsConfiguration("POST")
					.getResponseRemoteFieldName("transaction_identifier"),
					"transaction_identifier");

			builder.addFieldMapping(((HttpAdapter) routerAdapter)
					.getConfigurationsAsConfiguration("POST")
					.getResponseRemoteFieldName("transaction_index"),
					"transaction_index");

			builder.addFieldMapping(((HttpAdapter) routerAdapter)
					.getConfigurationsAsConfiguration("POST")
					.getResponseRemoteFieldName("transaction_type"),
					"transaction_type");
	...
	public RemoteObject deserialize(String queryScope, Parser parser) {
		...
		if (configuration != null) {
			...
			try {
				...
				object.accountId = parser.parse(
						configuration.getResponseRemoteFieldName("account_id"),
						String.class);
			...
			try {
				...
				object.activity = parser.parse(
						configuration.getResponseRemoteFieldName("activity"),
						String.class);
			...
			try {
				...
				object.checkImageEligible = parser.parse(configuration
						.getResponseRemoteFieldName("check_image_eligible"),
						String.class);
			...
			try {
				...
				object.datePosted = parser
						.parse(configuration
								.getResponseRemoteFieldName("date_posted"),
								String.class);
			...
			try {
				...
				object.formattedAmount = parser.parse(configuration
						.getResponseRemoteFieldName("formatted_amount"),
						String.class);
			...
			try {
				...
				object.pendingDate = parser.parse(configuration
						.getResponseRemoteFieldName("pending_date"),
						String.class);
			...
			try {
				...
				object.transactionAmount = parser.parse(configuration
						.getResponseRemoteFieldName("transaction_amount"),
						Float.class);
			...
			try {
				...
				object.transactionDescription = parser.parse(configuration
						.getResponseRemoteFieldName("transaction_description"),
						String.class);
			...
			try {
				...
				object.transactionIdentifier = parser.parse(configuration
						.getResponseRemoteFieldName("transaction_identifier"),
						String.class);
			...
			try {
				...
				object.transactionIndex = parser.parse(configuration
						.getResponseRemoteFieldName("transaction_index"),
						String.class);
			...
			try {
				...
				object.transactionType = parser.parse(configuration
						.getResponseRemoteFieldName("transaction_type"),
						String.class);
			...
			object = (RetailBankingAccountTransaction) Utilities
