...
public final class CapitalMarketsRevenue extends com.anypresence.sdk.APObject {
	...
	static {
		...
		QueryField queryFieldRegion154358701 = new QueryField();
		queryFieldRegion154358701.setIsAssignable(true);
		queryFieldRegion154358701.setFieldName("region");
		queryFieldRegion154358701.setParamName("region");
		try {
			queryFieldRegion154358701.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScoperevenues.getQueryFields().put(
				queryFieldRegion154358701.getParamName(),
				queryFieldRegion154358701);

		QueryField queryFieldYear154358706 = new QueryField();
		queryFieldYear154358706.setIsAssignable(true);
		queryFieldYear154358706.setFieldName("year");
		queryFieldYear154358706.setParamName("year");
		try {
			queryFieldYear154358706.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScoperevenues.getQueryFields()
				.put(queryFieldYear154358706.getParamName(),
						queryFieldYear154358706);
