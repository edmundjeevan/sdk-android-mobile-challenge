...
public final class CapitalMarketsRevenue extends com.anypresence.sdk.APObject {
	...
	static {
		...
		QueryField queryFieldRegion515644819 = new QueryField();
		queryFieldRegion515644819.setIsAssignable(true);
		queryFieldRegion515644819.setFieldName("region");
		queryFieldRegion515644819.setParamName("region");
		try {
			queryFieldRegion515644819.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScoperevenues.getQueryFields().put(
				queryFieldRegion515644819.getParamName(),
				queryFieldRegion515644819);

		QueryField queryFieldYear515644824 = new QueryField();
		queryFieldYear515644824.setIsAssignable(true);
		queryFieldYear515644824.setFieldName("year");
		queryFieldYear515644824.setParamName("year");
		try {
			queryFieldYear515644824.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScoperevenues.getQueryFields()
				.put(queryFieldYear515644824.getParamName(),
						queryFieldYear515644824);
