...
public final class CapitalMarketsContentService
	...
	static {
		...
		QueryField queryFieldContentServicesType515635752 = new QueryField();
		queryFieldContentServicesType515635752.setIsAssignable(true);
		queryFieldContentServicesType515635752
				.setFieldName("content_services_type");
		queryFieldContentServicesType515635752.setParamName("type");
		try {
			queryFieldContentServicesType515635752.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopecontent_services.getQueryFields().put(
				queryFieldContentServicesType515635752.getParamName(),
				queryFieldContentServicesType515635752);
