...
public final class CapitalMarketsContentService
	...
	static {
		...
		QueryField queryFieldContentServicesType323943406 = new QueryField();
		queryFieldContentServicesType323943406.setIsAssignable(true);
		queryFieldContentServicesType323943406
				.setFieldName("content_services_type");
		queryFieldContentServicesType323943406.setParamName("type");
		try {
			queryFieldContentServicesType323943406.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopecontent_services.getQueryFields().put(
				queryFieldContentServicesType323943406.getParamName(),
				queryFieldContentServicesType323943406);
