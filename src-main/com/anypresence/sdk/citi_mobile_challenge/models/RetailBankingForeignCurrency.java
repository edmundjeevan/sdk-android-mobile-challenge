...
public final class RetailBankingForeignCurrency
	...
	static {
		...
		QueryField queryFieldFromCurrency515679283 = new QueryField();
		queryFieldFromCurrency515679283.setIsAssignable(true);
		queryFieldFromCurrency515679283.setFieldName("from_currency");
		queryFieldFromCurrency515679283.setParamName("from_currency");
		try {
			queryFieldFromCurrency515679283.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopeforeign_currency.getQueryFields().put(
				queryFieldFromCurrency515679283.getParamName(),
				queryFieldFromCurrency515679283);

		QueryField queryFieldToCurrency515679288 = new QueryField();
		queryFieldToCurrency515679288.setIsAssignable(true);
		queryFieldToCurrency515679288.setFieldName("to_currency");
		queryFieldToCurrency515679288.setParamName("to_currency");
		try {
			queryFieldToCurrency515679288.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopeforeign_currency.getQueryFields().put(
				queryFieldToCurrency515679288.getParamName(),
				queryFieldToCurrency515679288);
