...
public final class RetailBankingForeignCurrency
	...
	static {
		...
		QueryField queryFieldFromCurrency154394032 = new QueryField();
		queryFieldFromCurrency154394032.setIsAssignable(true);
		queryFieldFromCurrency154394032.setFieldName("from_currency");
		queryFieldFromCurrency154394032.setParamName("from_currency");
		try {
			queryFieldFromCurrency154394032.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopeforeign_currency.getQueryFields().put(
				queryFieldFromCurrency154394032.getParamName(),
				queryFieldFromCurrency154394032);

		QueryField queryFieldToCurrency154394038 = new QueryField();
		queryFieldToCurrency154394038.setIsAssignable(true);
		queryFieldToCurrency154394038.setFieldName("to_currency");
		queryFieldToCurrency154394038.setParamName("to_currency");
		try {
			queryFieldToCurrency154394038.setValue("");
		} catch (UnassignableQueryFieldException e) {
			// Need to handle this.
		}
		queryScopeforeign_currency.getQueryFields().put(
				queryFieldToCurrency154394038.getParamName(),
				queryFieldToCurrency154394038);
